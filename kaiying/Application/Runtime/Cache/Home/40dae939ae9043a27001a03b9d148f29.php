    ...
    <div class="row " style="max-height: 50px;">
        ...
        <div class="col-lg-12" >
            <div class="col-lg-4 col-md-4 text-right animated fadeInleft" >
                <a href="<?php echo U('Index/index');?>"><img src ="/Public/Img/gblogo.png"></a>
            </div>
            <div class="col-lg-4 col-md-4">
            </div>
            <div class="col-lg-4 col-md-4 hidden-xs" style=" margin:10px;width: 160px;">
                <p style="font-size: 18px;color:#999999;line-height: 30px"><i class="fa-phone-square"></i> 服务热线：<br><span style="font-size: 25px;color:#e92b2b;line-height: 30px">123456789</span></p>
            </div>
        </div>
    </div>
</div>
<div class="container-fluid hidden-lg hidden-md"  style="padding-left:0px;border-bottom: 3px solid #f29500;background-color: white;">
<!--移动端-->
<div class="col-xs-12" style="background-color: white;max-height:72px;" >
    <div class="row">
    <div class="col-xs-12">
        <a href="<?php echo U('Index/index');?>" class="logo animated fadeInLeft"><img src ="/Public/Img/gblogomob.jpg"></a>
        <a href="javascript:void(0);" id="mobile-nav-taggle" class="showMenu menudong animated fadeInright text-center"><img src="/Public/Img/glodmenulogo.png" style="max-width:23px;"></a>
    </div>
    </div>
</div>
</div>
...
<div id="mobile-menu" class="mobile-nav visible-xs visible-sm hide-nav">
    <div class="col-xs-7" style="background-color:#373737;height: 100%">
        <ul class="navbar-nav navbar-left " style="font-family:'微软雅黑';padding-left: 20px;">
            ...
            <li style="margin-right: 20px;">
                <a href="<?php echo U('Index/aboutCompany');?>">公司简介</a>
            </li>
            <li style="margin-right: 20px;">
                <a href="<?php echo U('Index/');?>">行业应用</a>
            </li>
            <li style="margin-right: 20px;">
                <a href="<?php echo U('Index/');?>">产品选用</a>
            </li>
            <li style="margin-right: 20px;">
                <a href="<?php echo U('Index/');?>">型录资料</a>
            </li>
            <li style="margin-right: 20px;">
                <a href="<?php echo U('Index/');?>">联系我们</a>
            </li>
        </ul>
    </div>
...
<nav class="pcn navbar navbar-default hidden-xs hidden-sm menuLi navbar-collapse" role="navigation" style="border-bottom:1px solid white;margin: -2px 0 -1px 0;background-color:white;font-size:18px;">
    <div class="container-fluid">
        ...
        <div class="col-lg-9">
            <ul class="nav navbar-nav navbar-left" style="font-family:'微软雅黑';">
                ...
                <li style="margin-right: 20px;"><a href="<?php echo U('Index/');?>">公司简介</a></li>
                <li style="margin-right: 20px;"><a href="<?php echo U('Index/');?>">行业应用</a></li>
                <li style="margin-right: 20px;"><a href="<?php echo U('Index/');?>">产品选用</a></li>
                <li style="margin-right: 20px;"><a href="<?php echo U('Index/');?>">型录资料</a></li>
                <li style="margin-right: 20px;"><a href="<?php echo U('Index/');?>">联系我们</a></li>
            </ul>
        </div>
        <div class="col-lg-3"></div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            ...
                            class="fa fa-angle-right"></i>&nbsp;公司概况</a></span>
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    <div class="row">
                        <div class="col-lg-8">
                            <span style="padding:5px;border-bottom: 2px solid #162A9C">
                                <a href="<?php echo U('Index/aboutCompany');?>"
                                   style="color:#162A9C;font-size: 12px;font-weight:bold;">公司概况</a>
                            </span>
                            <span style="padding:5px;">
                                <a href="<?php echo U('Index/ceoLan');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">董事长致辞</a>
                            </span>
                            <!--<span style="padding:5px;">-->
                                <!--<a href="<?php echo U('/');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">组织架构</a>-->
                            <!--</span>-->
                        </div>
                    ...
                    <div class="row hidden-xs hidden-sm" style="margin-top: 10px;">
                        <div class="col-lg-12 col-md-12 col-xs-12 text-left hidden-xs">
                                <img src="/Public/Img/aboutcompany.png"/>
                        </div>
                    </div>
                    <script type="text/javascript"
                            src="http://api.map.baidu.com/api?v=2.0&ak=DCLoUUO857uq8Nj33MClWLR4SpFabuTC"></script>
                    <div class="row scep"
                         style="font:14px/1.8 'Microsoft Yahei',Tahoma,Geneva,Arial,Helvetica,sans-serif;color:#7D869F;margin-top:30px;">
                        <!--地址内容-->
                        <p><img src="<?php echo ($info['CoverImg']); ?>" class="pull-left" style="width:400px;margin-right:20px;"/><img src="/Public/Img/comlogo.jpg"/></p>
