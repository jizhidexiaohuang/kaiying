...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-desktop"></i> 服务对象
            </li>
        </ol>
    </section>
    <section class="content">
        <form action="<?php echo U('Index/serverEdit');?>" role="form" method="post" enctype="multipart/form-data">
            <input type="hidden" name="SID" value="<?php echo ($SInfo['ID']); ?>"/>
            <div class="form-group">
                <label>标题</label>
                <input type="text" class="form-control" id="Title" name="Title" value="<?php echo ($SInfo['Title']); ?>" placeholder="请输入标题">
            </div>
            <div class="form-group">
                <label>图片(图片像素 285*165)</label>
                <input id="file" name="CoverImg" type="file" data-show-caption="true">
                <p class="help-block">支持jpg、jpeg、png格式，大小不超过2.0M</p>
            </div>
            <div class="form-group">
                当前插图:<img src="<?php echo ($SInfo['Img']); ?>" style="max-width: 100px;"/>
            </div>
            <div class="form-group">
                <label>段落1:</label>
                <textarea  name="Content" type="text/plain" style="width:100%;height:200px;">
                    <?php echo ($SInfo['Content']); ?>
                </textarea>
            </div>
            <div class="form-group">
                <label>段落2:</label>
                <textarea  name="Content2" type="text/plain" style="width:100%;height:200px;">
                    <?php echo ($SInfo['Content2']); ?>
                </textarea>
            </div>
