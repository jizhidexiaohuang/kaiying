...
<div class="row">
    ...
    <div class="col-lg-10" style="padding: 0;background: url(/Public/Img/bdbg2.png)no-repeat;background-size:100% 100%;">
            <div class="row animated fadeInleft">
                <img class="col-lg-12  hidden-xs hidden-sm" src="/Public/Img/detail_top.jpg" height="130px;" width="100%;"/>
                <img class="col-md-12 hidden-md hidden-lg" src="/Public/Img/detail_top_xs.jpg" style="max-height: 200px;" width="100%;"/>
            </div>
        <div class="row" style="font-family: '微软雅黑';">
            ...
            <div class="row">
                <div class="col-lg-3"></div>
                <div class="col-lg-6 text-right" style="max-height: 20px;">
                    <a href="<?php echo U('Index/index');?>" style="color:#767E95;font-size: 12px;font-weight:bold;max-height:20px;line-height: 20px;"><i class="fa fa-fw fa-home" style="line-height: 100%;"></i>首页</a>
                    <a href="javascript:void(0);" style="color:#767E95;font-size: 12px;font-weight:bold;max-height:20px;line-height: 20px;"><i class="fa fa-angle-right"></i>&nbsp;新闻中心</a>
                    <a href="<?php echo U('Index/MediaReport');?>" class="active" style="color:#162A9C;font-size: 12px;font-weight:bold;margin-right:10px;max-height:20px;line-height: 20px;"><i class="fa fa-angle-right"></i>&nbsp;媒体报道</a>
                </div>
                <div class="col-lg-3"></div>
            </div>
            <div class="row" style="margin-top: 10px;" >
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    ...
                    <a href="#" style="color:#162A9C;font-size: 12px;font-weight:bold;">媒体报道</a>
                             ...
                             <span style="padding:5px;">
                        <a href="<?php echo U('Index/video');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">视频中心</a>
                    </span>
                        </div>
                    ...
                    <div class="row hidden-xs hidden-sm" style="margin-top: 10px;">
                        <img class="" src="/Public/Img/cmedia.png"/>
                    </div>
                    <div class="row" style="margin-top: 30px;"><!--新闻内容-->
                        <div class="col-lg-4 col-md-12 hidden-xs hidden-sm" style="padding:0 10px;margin-top:10px;">
                                <img src="<?php echo ($LeftNews["CoverImg"]); ?>" width="100%" style="max-height: 200px;max-width: 300px;"/>
                                <p style="font-size:16px;color:#FF8A00;"><?php echo (date('Y-m-d',$LeftNews["UpdateTime"])); ?></p>
                                <p><a href="<?php echo U('Index/MediaDetail',array('ID'=>$LeftNews['ID']));?>" style="font-weight:bold;font-size:14px;color:#7D869F;cursor: pointer;" class="leftHover"><?php echo ($LeftNews["Title"]); ?></a></p>
                                <p style="font-size:12px;color:#7D869F;"><?php echo (mb_substr($LeftNews["remark"],0,50,'utf-8')); ?>...</p>
                                <p><a href="<?php echo U('Index/MediaDetail',array('ID'=>$LeftNews['ID']));?>" style="font-size:13px;color:#162A9C;">阅读详情<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a></p>
                        </div>
                        <div class="col-lg-8 col-md-12 col-xs-12 col-sm-12">
                            <?php if(is_array($NewsInfo)): foreach($NewsInfo as $key=>$vo): ?><div class="row" style="background-color: #F4F6F9;padding:10px;margin-top:10px;">
                                    <div class="col-lg-1 col-md-2 hidden-xs hidden-sm">
                                        <div class="row hidden-xs hidden-sm">
                                            <div class="col-lg-1"></div>
                                            <div class="col-lg-10 text-center">
                                                <p style="border-bottom: 1px solid #7D869F;font-size: 26px;color:#7D869F;"><?php echo (date('d',$vo["UpdateTime"])); ?></p>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                        <div class="row hidden-xs hidden-sm">
                                            <div class="col-lg-1"></div>
                                            <div class="col-lg-10 text-center">
                                                <p style="line-height:20px;font-size: 20px;color:#7D869F;"><?php echo (date('m',$vo["UpdateTime"])); ?>月</p>
                                            </div>
                                            <div class="col-lg-1"></div>
                                        </div>
                                    </div>
                                    <div class="row col-xs-12 hidden-lg hidden-md">
                                        <div class="row hidden-lg hidden-md">
                                            <div class="col-xs-12 col-sm-12 text-left">
                                                <p style="line-height:20px;font-size: 20px;color:#7D869F;"><?php echo (date('d/m',$vo["UpdateTime"])); ?>月</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-10 col-md-9 col-xs-12" style="padding:10px 10px 0 10px;">
                                        <p><a href="<?php echo U('Index/MediaDetail',array('ID'=>$vo['ID']));?>"  class="fhover" style="font-size:14px;color:#7D869F;font-weight: bold;"  ><?php echo ($vo["Title"]); ?></a></p>
                                        <p style="font-size:12px;color:#999999;margin-bottom: 10px;"><?php echo (mb_substr($vo["remark"],0,80,'utf-8')); ?>...</p>
                                        <a href="<?php echo U('Index/MediaDetail',array('ID'=>$vo['ID']));?>" style="color: #162A9C;font-size: 13px;">阅读详情<i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></a>
                                    </div>
            ...
            <script type="text/javascript">
                $('.fhover,.leftHover').hover(function(){
