        ...
        <div class="row" style="font-family: '微软雅黑';">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            ...
                            class="fa fa-angle-right"></i>&nbsp;管理团队</a></span>
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    <div class="row">
                        <div class="col-lg-8">
                            <?php if(is_array($headTitle)): foreach($headTitle as $key=>$vo): if($level == $vo['level']): ?><span style="padding:5px;border-bottom: 2px solid #162A9C">
                                             <a href="<?php echo U('Index/management',array('level'=>$vo['level']));?>" style="color:#162A9C;font-size: 12px;font-weight:bold;"><?php echo ($vo["position"]); ?></a>
                                        </span>
                                     <?php else: ?>
                                        <span style="padding:5px;">
                                             <a href="<?php echo U('Index/management',array('level'=>$vo['level']));?>" style="color:#767E95;font-size: 12px;font-weight:bold;"><?php echo ($vo["position"]); ?></a>
                                        </span><?php endif; endforeach; endif; ?>
                            <!--<span style="padding:5px;">-->
                                <!--<a href="<?php echo U('/');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">副总裁</a>-->
                            <!--</span>-->
                            <!--<span style="padding:5px;">-->
                                <!--<a href="<?php echo U('/');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">常务副总裁</a>-->
                            <!--</span>-->
                            <!--<span style="padding:5px;">-->
                                <!--<a href="<?php echo U('/');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">助理总裁</a>-->
                            <!--</span>-->
                        </div>
                    ...
                    <div class="row hidden-xs hidden-sm" style="margin-top: 10px;">
                        <div class="col-lg-12 col-md-12 col-xs-12 text-left ">
                                <img src="/Public/Img/manageteam.png"/>
                        </div>
                    </div>
                    <div class="row hidden-xs hidden-sm" style="font-family: '微软雅黑';font-size:14px;color:#7D869F;margin-top:30px;line-height: 16px;">
                        <?php if(is_array($manageInfo)): foreach($manageInfo as $key=>$vo): ?><div class="col-lg-12" style="padding:10px;" >
                                <img src="<?php echo ($vo["imgUrl"]); ?>" class="pull-left" style="width:100%;max-width: 250px;margin-right: 20px;"/>
                                <p class="text-left" style="font-size: 24px;font-weight: bold;color:rgb(0, 32, 96)"><?php echo ($vo["names"]); ?></p>
                                <span><?php echo ($vo["content"]); ?></span>
                            </div><?php endforeach; endif; ?>
                    </div>
                    <div class="row hidden-lg hidden-md" style="font-family: '微软雅黑';font-size:14px;color:#7D869F;margin-top:30px;line-height: 16px;">
                        <?php if(is_array($manageInfo)): foreach($manageInfo as $key=>$vo): ?><div class="col-xs-12 text-center" style="padding:10px;" >
                                <img src="<?php echo ($vo["imgUrlMob"]); ?>" class="profile-user-img img-circle" style="width:50%;margin-bottom:10px;"/>
                            </div>
                            <div class="col-xs-12">
                            <p class="text-center" style="font-size: 24px;font-weight: bold;color:rgb(0, 32, 96)"><?php echo ($vo["names"]); ?></p>
                            <span><?php echo ($vo["content"]); ?></span>
                            </div><?php endforeach; endif; ?>
                    </div>
