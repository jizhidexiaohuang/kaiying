...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="">
                <a href="<?php echo U('News/MediaReportList');?>"><i class="fa fa-desktop"></i> 公司要闻</a>
            </li>
            <li class="">
    ...
    <section class="content">
        <form action="" role="form" method="post" enctype="multipart/form-data">
            <input type="hidden" name="mediaID" value="<?php echo ($editID); ?>"/>
            <div class="form-group">
                <label for="Title">媒体报道标题</label>
                <input type="text" class="form-control" value="<?php echo ($NewsInfo['Title']); ?>" id="Title" name="Title" placeholder="请输入新闻标题">
            </div>
            <div class="form-group">
                <label for="Title">媒体报道摘要（只在列表页显示）</label>
                <input type="text" class="form-control" id="remark" value="<?php echo ($NewsInfo['remark']); ?>" name="remark" placeholder="请输入新闻摘要">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="Promulgator" name="Promulgator" value="<?php echo ($NewsInfo['Promulgator']); ?>" placeholder="请输入发布者">
            </div>
            <div class="form-group">
                <label for="Promulgator">初始浏览量</label>
                <input type="text" class="form-control" id="ShowTimes" name="ShowTimes" value="<?php echo ($NewsInfo['ShowTimes']); ?>" placeholder="请设置初始浏览量">
            </div>
            <div class="form-group">
            <div class="checkbox">
                <label><input type="checkbox" name="Status" value="2" <?php if($NewsInfo["Status"] == 2): ?>checked<?php endif; ?>>设置为左侧置顶</label>
            </div>
            </div>
            <div class="form-group">
