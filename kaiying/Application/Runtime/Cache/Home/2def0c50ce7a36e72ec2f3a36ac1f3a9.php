    ...
    <div class="col-lg-10"
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            ...
                            class="fa fa-angle-right"></i>&nbsp;核心优势</a></span>
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                        ...
                        <div class="col-lg-8">
                            <span style="padding:5px;">
                                 <a href="<?php echo U('Index/businessone');?>"
                                    style="color:#767E95;font-size: 12px;font-weight:bold;">业务领域</a>
                            </span>
                            <span style="padding:5px;">
                            ...
                            <span style="padding:5px;border-bottom: 2px solid #162A9C">
                                <a href="<?php echo U('Index/CoreAdvantage');?>"
                                   style="color:#162A9C;font-size: 12px;font-weight:bold;">核心优势</a>
                            </span>
                        </div>
                    ...
                    <div class="row hidden-xs hidden-sm" style="margin-top: 10px;">
                        <div class="col-lg-12 col-md-12 text-left hidden-xs">
                            <img src="/Public/Img/coreAdvantage.png"/>
                        </div>
                    </div>
                            <div class="row" style="margin-top:30px;font-size: 14px;font-family: '微软雅黑';color:#999999">
                                <?php if(is_array($CArr)): foreach($CArr as $key=>$vo): ?><div class="col-lg-6 heig col-xs-12" style="margin-top: 10px;">
                                        <div class="row text-center">
                                            <img src="<?php echo ($vo['Img']); ?>" width="196px" class="img-circle"/>
                                        </div>
                                        <div class="row" style="margin-top: 20px;padding:10px;">
                                            <div class="col-lg-12">
                                                <h4 class="text-center"><?php echo ($vo['Title']); ?></h4>
                                                <p class="pp">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo['Content']); ?></p>
                                            </div>
                                        </div>
        ...
        <script type="text/javascript">
            ...
            if(IsPC()){
                ...
                $(".heig").css("height",maxheight);
            }

            $(function(){
                $(".pp").each(function(){
                    var maxwidth=110;//设置最多显示的字数
                    var text=$(this).text();
                    if($(this).text().length>maxwidth){
                        $(this).text($(this).text().substring(0,maxwidth));
                        $(this).html($(this).html()+"..."+"<div class='row text-right'><a href='###' style='color:dodgerblue'>全部>></a></div>");//如果字数超过最大字数，超出部分用...代替，并且在后面加上点击展开的链接；
                    };
                    $(this).find("a").click(function(){
                        $(this).parent().parent().html(text+"<div class='row text-right'><a href='####' class='abc' style='color:dodgerblue'>收起>></a></div>");//点击“点击展开”，展开全文
                    });
                    $(this).on('click','.abc',function(){
                        $(this).parent().parent().html($(this).parent().parent().text().substring(0,maxwidth)+"..."+"<div class='row text-right'><a href='###' class='showa' style='color:dodgerblue'>全部>></a></div>");
                    })
                    $(this).on('click','.showa',function(){
                        $(this).parent().parent().html(text+"<div class='row text-right'><a href='####' class='abc' style='color:dodgerblue'>收起>></a></div>");
                    })
                })
