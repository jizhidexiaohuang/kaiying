        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <a style="max-height:30px;line-height: 30px;" class="active"><a href="<?php echo U('Index/BusinessCooperation');?>"
                                                                                    style="color:#162A9C;font-size: 12px;font-weight:bold;"><i
                            class="fa fa-angle-right"></i>&nbsp;商务合作</a></a>
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    ...
                    <a href="<?php echo U('Index/aboutUs');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">联系我们</a>
                </span>
                            <span style="padding:5px;border-bottom: 2px solid #162A9C">
                    <a href="<?php echo U('Index/aboutUs');?>" style="color:#162A9C;font-size: 12px;font-weight:bold;">商务合作</a>
                </span>
                        </div>
                    ...
                    <div class="row hidden-xs hidden-sm" style="margin-top: 10px;">
                        <div class="col-lg-6 col-md-6 hidden-xs text-left">
                            <img src="/Public/Img/bs.png"/>
                        </div>
                    </div>
                    <script type="text/javascript"
                            src="http://api.map.baidu.com/api?v=2.0&ak=DCLoUUO857uq8Nj33MClWLR4SpFabuTC"></script>
                    <div class="row" style="margin-top: 30px;background-color: #ededed;"><!--地址内容-->
                        <div class="row">
                            <p style="font-size: 16px;color:#999999;padding: 20px;">&nbsp;&nbsp;&nbsp;&nbsp;大海凯盈，中国房地产开发运营商，业务包含政府代建、城市更新服务、资本代建、房地产开发投融资、委托开发管理、小股操盘、咨询顾问等领域。如有商务合作，请直接拨打联系电话或在下方留言，大海凯盈，竭诚为您服务。</p>
                        </div>
                        <form role="form" action="<?php echo U('Index/lmessage');?>" method="post">
                            <div class="row" >
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12" style="padding:20px 10px;">
                                    <label>单位：<strong style="color: #F00;">*</strong></label><input type="text" class="form-control" name="workplace"
                                                                               style="width: 100%" placeholder="请输入所在单位"/>
                                </div>
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12" style="padding:20px 10px;">
                                    <label>职位：</label><input type="text" name="job" class="form-control"
                                                                               style="width: 100%"/>
                                </div>
                            </div>
                            <div class="row" >
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12" style="padding:20px 10px;">
                                    <label>姓名：<strong style="color: #F00;">*</strong></label><input type="text" class="form-control" name="name"
                                                                               style="width: 100%" placeholder="请输入姓名"/>
                                </div>
                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12" style="padding:20px 10px;">
                                    <label>联系方式：<strong style="color: #F00;">*</strong></label><input type="text" class="form-control" name="tel"
                                                                               style="width: 100%" placeholder="请输入联系方式"/>
                                </div>
                            </div>
                            <div class="row" >
                                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" style="padding:20px 10px;">
                                    <label>合作需求：<strong style="color: #F00;">*</strong></label>
                                    <textarea class="form-control" name="content" rows="3" style="width: 100%;" placeholder="请输入留言内容"></textarea>
                                </div>
                            </div>
            ...
            <script type="text/javascript">
                ...
                local.search("东莞市南城区鸿福路汇成大厦16层");

                var map = new BMap.Map("l-map2");            // 创建Map实例
                map.centerAndZoom(new BMap.Point(116.404, 39.915), 11);
                var local = new BMap.LocalSearch(map, {
                    renderOptions: {map: map, panel: "r-result"}
                });
                local.search("深圳市福田区侨香路3085号岭南大厦1101室");
            </script>
