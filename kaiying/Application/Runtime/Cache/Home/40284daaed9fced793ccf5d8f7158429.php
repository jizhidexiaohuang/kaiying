            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            ...
                            class="fa fa-angle-right"></i>&nbsp;服务对象</a></span>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <span style="padding:5px;border-bottom: 2px solid #162A9C">
                                 <a href="" style="color:#162A9C;font-size: 12px;font-weight:bold;">服务对象</a>
                            </span>
                            <span style="padding:5px;">
                        ...
                        <div class="col-lg-12 hidden-xs hidden-sm"  style="padding:5px;font-size: 14px;font-family: '微软雅黑';color:#999999">
                                <div class="col-lg-4">
                                    <div class="col-lg-12 text-center" style="padding:10px;">
                                        <h4>房地产公司</h4>
                                        <p><span style="font-weight: bold;">特点：</span>有土地、有资金，追求规模化发展，希望获得更专业的房地产管理和服务</p>
                                        <p><span style="font-weight: bold;">我们的服务：</span>通过全程管理和技术输出， 为项目快速实现价值最大化，帮助企业规模化发展</p>
                                    </div>
                                    <div class="col-lg-12 text-center" style="padding:10px;">
                                        <h4>资金方</h4>
                                        <p><span style="font-weight: bold;">特点：</span>有资金希望追求卓越、安全的投资回报，但缺乏优质项目或缺乏专业运作团队</p>
                                        <p><span style="font-weight: bold;">我们的服务：</span>协助实现资金与优质项目对接，提供系统开发运营服务和基金管理服务，确保资金方获得稳定的、安全的投资回报</p>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <img src="/Public/Img/soo.png" width="100%"/>
                                </div>
                                <div class="col-lg-4">
                                    <div class="col-lg-12 text-center" style="padding:10px;">
                                        <h4>土地方</h4>
                                        <p><span style="font-weight: bold;">特点：</span>拥有土地资源的集体股份公司、国企、私企等，希望土地效益最大化 </p>
                                        <p><span style="font-weight: bold;">我们的服务：</span>通过协助完善土地开发手续及对接资金，精品开发，将土地价值及效益最大化</p>
                                    </div>
                                    <div class="col-lg-12 text-center" style="padding:10px;">
                                    <h4>资产方</h4>
                                        <p><span style="font-weight: bold;">特点：</span>拥有房地产资产，但缺乏运营管理团队，难以实现理想的资产收益 </p>
                                        <p><span style="font-weight: bold;">我们的服务：</span>通过提供专业的商业策划咨询服务，或资产管理服务，实现资产的理想收益及保值增值</p>
                                    </div>
                                </div>
                        </div>
                    </div>
                        <div class="row hidden-lg hidden-md" style="margin-top: 30px;color:#af3635">
