...
<div class="row">
    ...
    <div class="col-lg-10"
        ...
        <div class="row">
            ...
            <div class="row" style="margin-top: 10px;font-family: '微软雅黑';">
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    ...
                    <div class="row" style="margin-top: 30px;"><!--地址内容-->
                        <div class="row">
                            <a href="<?php echo U('Index/aboutUs');?>" class="btn btn-default">东莞公司</a>
                            <a href="javascript:void(0);" class="btn btn-info">深圳公司</a>
                        </div>
                        <div class="row" style="padding-top:20px;">
                            <div class="col-lg-12" style="padding: 20px;">
                                <p style="font-weight: bold;color:#666666;font-size: 18px;">广东大海凯盈房产建设管理有限公司</p>
                                <p style="font-size: 12.5px;color:#999999;">电话：0755-83193866</p>
                                <p style="font-size: 12.5px;color:#999999;">邮箱：wz939@qq.com</p>
                                <p style="font-size: 12.5px;color:#999999;">地址：深圳市福田区侨香路3085号岭南大厦1101室</p>
                            </div>
                        </div>
            ...
            <script type="text/javascript">
                // 百度地图API功能
                var sContent =
                    "<p style='color:#999999;line-height:12px;font-size:5px;'>地址：深圳市福田区侨香路3085号岭南大厦1101室</p>" +
                    "<p style='color:#999999;font-size:5px;line-height:7px;padding:0;'>电话：0755-83193866</p>" +
                    "<p style='color:#999999;line-height:7px;font-size:5px;padding:0;'>邮箱：wz939@qq.com</p>"
                ;
                var map = new BMap.Map("allmap");
                var point = new BMap.Point(114.005342,22.547402);
