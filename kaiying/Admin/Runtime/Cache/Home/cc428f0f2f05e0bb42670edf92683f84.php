...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="<?php echo U('Project/Projectedit');?>" role="form" method="post" enctype="multipart/form-data">
            <input type="hidden" name="PID" value="<?php echo ($Pinfo['ID']); ?>"/>
            <div class="form-group">
                <label for="Title">项目标题</label>
                <input type="text" class="form-control" id="Title" name="Title" value="<?php echo ($Pinfo['Title']); ?>" placeholder="请输入标题">
            </div>
            <div class="form-group">
                <label for="remark">项目小标题</label>
                <input type="text" class="form-control" id="remark" name="remark" value="<?php echo ($Pinfo['remark']); ?>" placeholder="请输入小标题">
            </div>
            <div class="form-group">
                <label for="Address">售楼处地址</label>
                <input type="text" class="form-control" id="Address" name="Address" value="<?php echo ($Pinfo['Address']); ?>" placeholder="请输入售楼处地址">
            </div>
            <div class="form-group">
                <label for="Tel">联系电话</label>
                <input type="text" class="form-control" id="Tel" name="Tel" value="<?php echo ($Pinfo['Tel']); ?>" placeholder="请输入联系电话">
            </div>
            <?php if($T == '大海凯盈-'): ?><div class="form-group">
                    <div class="checkbox">
                        <label><input type="checkbox" name="Top" value="1" <?php if($Pinfo["Top"] == 1): ?>checked<?php endif; ?>>设为顶部置顶</label>
                    </div>
                </div><?php endif; ?>
            <div class="form-group">
                <label for="ord">排序（从大到小）</label>
                <input type="text" class="form-control" id="ord" name="ord" value="<?php echo ($Pinfo['ord']); ?>" placeholder="请输入排序">
            </div>
            <label for="Type">项目状态</label>
            <div class="radio">
                <label>
                    <input type="radio" name="Statu" value="在售" <?php if($Pinfo["Statu"] == '在售'): ?>checked<?php endif; ?>> 在售
                </label>
                <label style="margin-left:20px;">
                    <input type="radio" name="Statu" value="已售" <?php if($Pinfo["Statu"] == '售完'): ?>checked<?php endif; ?>>售完
                </label>
                <label style="margin-left:20px;">
                    <input type="radio" name="Statu" value="待售" <?php if($Pinfo["Statu"] == '待售'): ?>checked<?php endif; ?>>待售
                </label>
            </div>
            <label for="Type">项目所属</label>
            <div class="radio">
                <label>
                    <input type="radio" name="Type" value="大海凯盈" <?php if($Pinfo["Type"] == '大海凯盈'): ?>checked<?php endif; ?>> 大海凯盈
                </label>
                <label style="margin-left:20px;">
                    <input type="radio" name="Type" value="凯盈集团" <?php if($Pinfo["Type"] == '凯盈集团'): ?>checked<?php endif; ?>>凯盈集团
                </label>
                <label style="margin-left:20px;">
                    <input type="radio" name="Type" value="大海智地" <?php if($Pinfo["Type"] == '大海智地'): ?>checked<?php endif; ?>>大海智地
                </label>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>介绍</label>
                <textarea class="form-control" name="content" rows="3"><?php echo ($Pinfo["content"]); ?></textarea>
            </div>
...
//            actionDelete:'',
        ...
        initialPreviewConfig: [{
            ...
            width: '120px',// 图片高度
            url: '<?php echo U('Project/delete');?>',// 预展示图片的删除调取路径
            key: 100,// 可修改 场景2中会用的
