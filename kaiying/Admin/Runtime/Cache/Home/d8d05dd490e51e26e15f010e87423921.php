...
<head>
    ...
    <script src="/Public/2.2.4/jquery.js"></script>
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-desktop"></i> <?php echo ($str); ?>管理团队
            </li>
        </ol>
    </section>
    <section class="content">
        <form action="<?php echo U('Index/manageAdd');?>" role="form" method="post" enctype="multipart/form-data">
            ...
            <!--<div class="row margin-bottom">-->
                ...
                <!--<div class="col-lg-8 col-md-6 col-xs-12">-->
                    <!--当前插图:<img src="<?php echo ($User['imgUrl']); ?>" style="max-width: 100px;"/>-->
                <!--</div>-->
            <!--</div>-->
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="names" name="names" value="<?php echo ($User['names']); ?>" placeholder="请输入名称">
            </div>
            <div class="form-group">
                <label for="position">职位</label>
                <input type="text" class="form-control" id="position" name="position" value="<?php echo ($User['position']); ?>" placeholder="请输入职位">
            </div>
            <div class="form-group">
                <label for="level">排序（从小到大排序，相同职位请设置同一个值）</label>
                <input type="text" class="form-control" id="level" name="level" value="<?php echo ($User['level']); ?>" placeholder="请输入排序">
            </div>
            <div class="form-group">
