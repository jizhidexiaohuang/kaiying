...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="">
                <a href=""><i class="fa fa-gears"></i> 首页管理</a>
            </li>
            <li class="">
                <a href="<?php echo U('News/NewsList');?>"><i class="fa fa-desktop"></i> 轮播图管理</a>
            </li>
            <li class="">
                <a href="javascript:void(0);"><i class="fa fa-edit"></i>轮播图编辑</a>
            </li>
        </ol>
    </section>
    <section class="content">
        <form action="" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo ($ImgInfo['ImgName']); ?>" id="Title" name="Title" placeholder="请输入轮播图名称">
            </div>
            <div class="form-group">
                <label for="UrlA">链接地址</label>
                <input type="text" class="form-control" value="<?php echo ($ImgInfo['Url']); ?>" id="UrlA" name="UrlA" placeholder="请输入链接地址">
            </div>
            <div class="form-group">
                <label>排序</label>
                <input type="text" class="form-control" value="<?php echo ($ImgInfo['Sort']); ?>" id="sort" name="sort" placeholder="请输入排序序号">
            </div>
            <div class="form-group">
                <label for="Type">终端</label>
                <select class="form-control" name="Type">
                    <option value="lg" <?php if($ImgInfo["Type"] == 'lg'): ?>selected<?php endif; ?>>PC端</option>
                    <option value="xs" <?php if($ImgInfo["Type"] == 'xs'): ?>selected<?php endif; ?>>移动端</option>
                </select>
            </div>
            <div class="form-group">
                    <label>图片(图片像素 pc大屏：1900*500 移动端：750*680)</label>
                    <input id="file" name="CoverImg" type="file" data-show-caption="true">
                    <p class="help-block">支持jpg、jpeg、png格式，大小不超过2.0M</p>
            </div>
            <div class="row" style="padding:20px;">
               当前使用图片：<img src="<?php echo ($ImgInfo["ImgUrl"]); ?>" width="200px;"/>
            </div>
