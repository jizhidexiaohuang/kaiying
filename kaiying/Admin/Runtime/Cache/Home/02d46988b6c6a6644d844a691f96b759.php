     ...
     <section class="content">
         <div class="row">
             <div class="col-lg-1 col-md-2 col-xs-4 margin-bottom" style="margin: 0 15px 10px 0;">
                 <a href="<?php echo U('News/NewsEdit');?>" class="btn btn-info"><i class="fa fa-list"></i> 发布新闻</a>
             </div>
             <div class="col-lg-6 col-md-6 col-xs-12 margin-bottom">
                 <a href="<?php echo U('News/NewsList',array('statu'=>-1));?>" class="btn btn-default"><i class="fa fa-trash"></i> 回收站</a>
                 <a href="<?php echo U('News/NewsList',array('statu'=>0));?>" class="btn btn-warning"><i class="fa fa-check"></i> 未上线</a>
                 <a href="<?php echo U('News/NewsList',array('statu'=>1));?>" class="btn btn-success"><i class="fa fa-list"></i> 上线中</a>
                 <a href="<?php echo U('News/NewsList',array('statu'=>2));?>" class="btn btn-danger"><i class="fa fa-thumbs-up"></i> 推荐</a>
             </div>
             <div class="col-lg-4 col-md-3 col-xs-12 margin-bottom">
                 <form action="<?php echo U('News/NewsList');?>" method="get" name="SearchForm" id="SearchForm">
                     <div class="input-group">
                         ...
                         <!--<input type="hidden" class="form-control" name="statu" id="statu" value="<?php echo ($statu); ?>" />-->
                         <span class="input-group-btn">
         ...
         <div class="row">
             <?php if(is_array($newsinfo)): foreach($newsinfo as $key=>$vo): ?><div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                     <div class="box box-info">
                         ...
                         <div class="box-body">
                             <div class="col-lg-9 col-xs-9 col-md-8 thumbnail" style="margin: 0px;padding: 0px;">
                             ...
                             <div class="col-lg-3 col-xs-3 col-md-4 btn-group-vertical pull-right " style="margin:0px;">
                                 <a href="<?php echo U('News/NewsChangeStatu',array('statu'=>-1,'NewID'=>$vo['ID']));?>"
                                 ...
                                 <a href="<?php echo U('News/NewsChangeStatu',array('statu'=>0,'NewID'=>$vo['ID']));?>"
                                 ...
                                 <a href="<?php echo U('News/NewsChangeStatu',array('statu'=>2,'NewID'=>$vo['ID']));?>"
                         ...
                         <div class="box-footer clearfix">
                             <a class="btn btn-success"
                                href="<?php echo U('News/NewsEdit',array('ID'=>$vo['ID']));?>"><i
