...
<head>
    ...
    <!--<script src="/Public/bootstrap/js/fileinput.js" type="text/javascript"></script>-->
    <!--<script src="/Public/bootstrap/js/fileinput_locale_zh.js" type="text/javascript"></script>-->
...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-users"></i> 公司介绍</li>
            <li class="active"><i class="fa fa-user"></i> 管理团队列表</li>
        </ol>
    </section>
    <section class="content">
        <div class="row">
            <div class="col-lg-12 margin-bottom">
                <div class="col-lg-6">
                    <a href="<?php echo U('Index/manageAdd');?>"><input type="button" class="btn btn-info" value="添加"></a>
                </div>
            ...
            <?php if(is_array($Ulist)): $i = 0; $__LIST__ = $Ulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-3">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" style="height:100px;" src="<?php echo ($vo["imgUrl"]); ?>" onerror="this.src='/Public/Img/null.jpg'">
                        <h3 class="profile-username text-center">　<?php echo ($vo["position"]); ?>　</h3>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item"><b>排序</b> <a class="pull-right"><?php echo ($vo["level"]); ?></a></li>
                            <li class="list-group-item"><b>上次更新时间</b> <a class="pull-right"><?php echo (date("Y-m-d",$vo["UpdateTime"])); ?></a></li>
                            <li class="list-group-item"><b>状态</b><a class="pull-right"><?php if($vo['Status'] == 1): ?>显示<?php else: ?>隐藏<?php endif; ?></a></li>
                        </ul>
                        <a class="btn btn-primary btn-block" href="<?php echo U('Index/manageAdd',array('ID'=>$vo['ID'],'type'=>1));?>"><i class="fa fa-pencil-square-o"></i> 修改</a>
                        <?php if($vo["Status"] == 1): ?><a class="btn btn-danger btn-block" href="<?php echo U('Index/manageChange',array('ID'=>$vo['ID'],'status'=>0));?>"><i class="fa fa-lock"></i> 隐藏</a>
                            <?php else: ?>
                            <a class="btn btn-success btn-block" href="<?php echo U('Index/manageChange',array('ID'=>$vo['ID'],'status'=>1));?>"><i class="fa fa-unlock"></i> 显示</a><?php endif; ?>
