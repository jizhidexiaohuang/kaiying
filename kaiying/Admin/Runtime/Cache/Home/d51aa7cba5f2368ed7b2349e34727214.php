...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="">
                <i class="fa fa-gears"></i> 新闻中心
            </li>
            <li class="active">
                <i class="fa fa-desktop"></i> 视频编辑
            </li>
        </ol>
    </section>
    <section class="content">
        <form action="<?php echo U('Video/videoedit');?>" role="form" method="post" enctype="multipart/form-data">
            <input type="hidden" name="VID" value="<?php echo ($Vinfo['ID']); ?>"/>
            <div class="form-group">
                <label for="Title">视频标题</label>
                <input type="text" class="form-control" id="Title" name="Title" value="<?php echo ($Vinfo['Title']); ?>" placeholder="请输入标题">
            </div>
            <div class="form-group">
                <label>封面图（1440*900）</label>
            ...
            <div class="form-group">
                ...
                <p class="help-block">支持mp4格式，大小不超过50M</p>
            </div>
...
<script type="text/javascript">
    $("#file").fileinput({
        ...
        maxFileSize: 50*1024,
        allowedFileExtensions: ['mp4','avi'], //限制上传文件后缀
        layoutTemplates:{
            actionDelete:'',
            actionUpload:''
        }
