...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="">
                <a href="<?php echo U('News/NewsList');?>"><i class="fa fa-desktop"></i> 公司要闻</a>
            </li>
            <li class="">
                <a href="javascript:void(0);"><i class="fa fa-edit"></i>发布文章</a>
            </li>
        </ol>
    </section>
