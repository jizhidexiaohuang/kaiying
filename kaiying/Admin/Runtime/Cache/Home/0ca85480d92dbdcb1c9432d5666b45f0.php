...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="">
                <i class="fa fa-gears"></i> 联系我们
            </li>
            <li class="active">
                <i class="fa fa-desktop"></i> 商务合作留言
            </li>
        </ol>
    </section>
    <section class="content">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-xs-12 margin-bottom" style="margin: 0 15px 10px 0;">
                <a href="<?php echo U('Index/message',array('Status'=>0));?>" class="btn btn-warning"><i class="fa fa-list"></i>
                    未处理</a>
                <a href="<?php echo U('Index/message',array('Status'=>1));?>" class="btn btn-success"><i class="fa fa-list"></i>
                    已处理</a>
            </div>
        </div>
        <table class="table table-striped">
            <caption>商务留言列表</caption>
            <thead>
            <tr>
                <th>名字</th>
                <th>单位</th>
                ...
                <th>联系方式</th>
                <th>合作需求</th>
                <?php if($_GET['Status']== 0): ?><th>操作</th>
                    <?php else: ?>
                    <th>状态</th><?php endif; ?>
            </tr>
            </thead>
            <tbody>
            <?php if(is_array($messageInfo)): foreach($messageInfo as $key=>$vo): ?><tr>
                    <td><?php echo ($vo["name"]); ?></td>
                    <td><?php echo ($vo["workplace"]); ?></td>
                    <td><?php echo ($vo["job"]); ?></td>
                    <td><?php echo ($vo["tel"]); ?></td>
                    <td><?php echo ($vo["content"]); ?></td>
                    <?php if($vo["Status"] == 0): ?><td><a href="<?php echo U('Index/messageStatusChange',array('messageID'=>$vo['ID']));?>"
                               class="btn btn-info" onclick="if(confirm('该留言已处理完毕?')==false)return false;">已处理</a></td>
                        <?php else: ?>
                        <td>处理完毕</td><?php endif; ?>
