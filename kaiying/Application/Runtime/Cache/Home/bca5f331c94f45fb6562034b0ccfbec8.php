            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            ...
                            class="fa fa-angle-right"></i>&nbsp;凯盈集团</a></span>
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <span style="padding:5px;">
                                <a href="<?php echo U('Index/showProjectzd');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">大海智地</a>
                            </span>
                            <span style="padding:5px;border-bottom: 2px solid #162A9C">
                                <a href="<?php echo U('Index/showProjectky');?>" style="color:#162A9C;font-size: 12px;font-weight:bold;">凯盈集团</a>
                            </span>
                        </div>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-lg-12 col-md-12 col-xs-12 text-left hidden-xs">
                            <span style="font-size:15px;color:#265bb1;font-weight: bold;font-family: PingFangSC-Semibold, sans-serif;">凯盈集团团队代表性操盘项目</span>
                        </div>
                    </div>
