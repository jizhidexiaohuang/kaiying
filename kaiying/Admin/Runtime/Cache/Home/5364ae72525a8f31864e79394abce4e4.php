...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <i class="fa fa-desktop"></i> <?php echo ($str); ?>核心优势
            </li>
        </ol>
    </section>
    <section class="content">
        <form action="<?php echo U('Index/CoreEdit');?>" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
            当前插图:<img src="<?php echo ($CInfo['Img']); ?>" style="max-width: 100px;"/>
            </div>
            <div class="form-group">
                <label>标题</label>
                <input type="text" class="form-control" id="Title" name="Title" value="<?php echo ($CInfo['Title']); ?>" placeholder="请输入标题">
            </div>
            <div class="form-group">
                <label>详细介绍:</label>
