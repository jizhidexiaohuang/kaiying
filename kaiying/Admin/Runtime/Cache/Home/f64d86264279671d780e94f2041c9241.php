...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-users"></i> 产品服务</li>
            <li class="active"><i class="fa fa-user"></i> 核心优势</li>
        </ol>
    </section>
    <section class="content">
        <div class="row">
            <div class="col-lg-12 margin-bottom">
                <div class="col-lg-6">
                    <a href="<?php echo U('Index/CoreEdit');?>"><input type="button" class="btn btn-info" value="添加"></a>
                </div>
            </div>
            <?php if(is_array($CArr)): $i = 0; $__LIST__ = $CArr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-3">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="profile-user-img img-responsive img-circle" style="height:100px;" src="<?php echo ($vo["Img"]); ?>">
                        <h3 class="profile-username text-center">　<?php echo ($vo["Title"]); ?>　</h3>
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item"><b>上次更新时间</b> <a class="pull-right"><?php echo (date("Y-m-d",$vo["UpdateTime"])); ?></a></li>
                        </ul>
                        <a class="btn btn-primary btn-block" href="<?php echo U('Index/CoreEdit',array('CID'=>$vo['ID']));?>"><i class="fa fa-pencil-square-o"></i> 修改</a>
                        <a class="btn btn-warning btn-block" href="<?php echo U('Index/delCore',array('CID'=>$vo['ID']));?>" onclick="if(confirm('确定删除?')==false)return false;"><i class="fa fa-trash"></i> 删除</a>
                    </div>
                </div>
