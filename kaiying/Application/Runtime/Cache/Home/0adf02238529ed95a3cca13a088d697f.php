                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    ...
                    <div class="row" style="margin-top: 50px;">
                        <div class="col-lg-12 col-xs-12 text-right" style="margin-top: 20px;">
                            ...
                            <a href="<?php echo U('Index/businessfiv');?>"><button class="btn btn-info" style="color:white;font-size: 12px;font-weight:bold;">资本代建</button></a>
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="col-lg-12  hidden-xs text-left"><h2 style="color:#767E95;">资本代建</h2></div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <p style="color:#999999;font-size: 14px;line-height: 14px;">大海凯盈在资本代建领域依托于良好的土地挖掘能力和专业的房地产开发经验;</p>
                            <p style="color:#999999;font-size: 14px;line-height: 14px;">为有房地产投资需求的金融机构提供从项目研判、土地获取、报建规划到开发管理在内的房地产开发全流程服务， 最终为金融机构实现安全、高效的投资收益。</p>
                        </div>
                    </div>
                    <div class="row" style="margin-top: 40px;">
                        <div class="col-xs-12" style="padding-top:0px;height:45px;">
                            <div class="col-xs-3 text-right animated fadeInDown" style="">
                                <img src="/Public/Img/images5/1.jpg" class="" style="height:45px;"/>
                            </div>
                            <div class="col-xs-1 text-center animated fadeInDown">
                                <img src="/Public/Img/images5/2.png" class="" style="height:45px;"/>
                            </div>
                            <div class="col-xs-7 text-center animated fadeInDown">
                                <img src="/Public/Img/images5/3.png" class="" style="height:45px;"/>
                            </div>
                        ...
                        <div class="col-xs-12" style="height:100px;">
                            ...
                            <div class="col-xs-7 animated fadeInRight2 text-center" style="height:100px;">
                                <img src="/Public/Img/images5/5.jpg" class=""/>
                            </div>
                            <div class="col-xs-1" style="height:100px;">
                            </div>
                        </div>
