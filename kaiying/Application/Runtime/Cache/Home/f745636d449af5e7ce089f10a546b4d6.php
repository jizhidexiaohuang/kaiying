            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <a style="max-height:30px;line-height: 30px;" class="active"><a href=""
                            ...
                            class="fa fa-angle-right"></i>&nbsp;新闻详情</a></a>
                </div>
                <div class="col-lg-3"></div>
            </div>
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    ...
                    <div class="row" style="border-top:2px #f4f4f4 solid;margin-top: 20px;padding-top: 20px;">
                        <div class="col-lg-6 text-center">
                            <?php if($LastID > 0): ?><a href="<?php echo U('Index/NewsDetail',array('ID'=>$LastID['ID']));?>" style="font-size:14px;color: #162A9C;">上一篇:<?php echo ($LastID['Title']); ?></a><?php endif; ?>
                        </div>
                        <div class="col-lg-6 text-center">
                            <?php if($NextID > 0): ?><a href="<?php echo U('Index/NewsDetail',array('ID'=>$NextID['ID']));?>" style="font-size:14px;color: #162A9C;">下一篇:<?php echo ($NextID['Title']); ?></a><?php endif; ?>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2"></div>
