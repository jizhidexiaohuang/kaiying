            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            ...
                            class="fa fa-angle-right"></i>&nbsp;大海智地</a></span>
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <span style="padding:5px;border-bottom: 2px solid #162A9C">
                                <a href="<?php echo U('Index/showProjectzd');?>" style="color:#162A9C;font-size: 12px;font-weight:bold;">大海智地</a>
                            </span>
                            <span style="padding:5px;">
                                <a href="<?php echo U('Index/showProjectky');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">凯盈集团</a>
                            </span>
                        </div>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-lg-12 col-md-12 col-xs-12 text-left hidden-xs">
                            <span style="font-size:15px;color:#265bb1;font-weight: bold;font-family: PingFangSC-Semibold, sans-serif;">大海智地团队中海地产任职期间代表性操盘项目</span>
                        </div>
                    </div>
                    <div class="row" style="margin-top:20px;">
                        <?php if(is_array($Pinfo)): foreach($Pinfo as $key=>$vo): ?><div class="col-lg-3" style="margin-top:10px;padding:5px 3px 0 3px;">
                                <a href="<?php echo U('Index/showProjectDetail',array('ID'=>$vo['ID']));?>" class="hidden-xs hidden-sm"><img src="<?php echo ($vo["Img"]); ?>" width="100%" height="140px"/></a>
                                <a href="<?php echo U('Index/showProjectDetail',array('ID'=>$vo['ID']));?>" class="hidden-lg hidden-md"><img src="<?php echo ($vo["Img"]); ?>" width="100%"/></a>
                                <div class="row" style="background-color: #F1EEE7">
                                    <a href="<?php echo U('Index/showProjectDetail',array('ID'=>$vo['ID']));?>"><p class="text-center" style="margin-top: 10px;font-size: 14px;font-weight: bold;color: #7D869F;background-color: #F1EEE7"><?php echo ($vo["Title"]); ?></p></a>
                                    <a href="<?php echo U('Index/showProjectDetail',array('ID'=>$vo['ID']));?>"><p class="text-center" style="margin-top: 10px;margin-bottom:20px;font-size: 12px;color: #b98451;background-color: #F1EEE7"><?php echo ($vo["remark"]); ?></p></a>
                                </div>
