...
<div class="row">
    ...
    <div class="col-lg-10"
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            href="<?php echo U('Index/showProject');?>"
                            style="color:#767E95;font-size: 12px;font-weight:bold;"><i
                            class="fa fa-angle-right"></i>&nbsp;项目展示</a></span>
                    <!--<span style="max-height:30px;line-height: 30px;" class="active"><a-->
                            <!--href="<?php echo U('Index/aboutCompany');?>"-->
                            <!--style="color:#767E95;font-size: 12px;font-weight:bold;"><i-->
                            <!--class="fa fa-angle-right"></i>项目详情</a></span>-->
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            href="<?php echo U('Index/showProject');?>"
                            style="color:#162A9C;font-size: 12px;font-weight:bold;"><i
                            class="fa fa-angle-right"></i>&nbsp;<?php echo ($Pinfo["Title"]); ?></a></span>
                </div>
                <div class="col-lg-3"></div>
            </div>
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                        ...
                        <div class="col-lg-8">
                            <!--<span style="padding:5px;">-->
                                <!--<a href="<?php echo U('Index/showProject');?>"-->
                                   <!--style="color:#767E95;font-size: 12px;font-weight:bold;">大海凯盈</a>-->
                            <!--</span>-->
                            <!--<span style="padding:5px;">-->
                            ...
                            <!--<span style="padding:5px;border-bottom: 2px solid #162A9C">-->
                                <!--<a href="<?php echo U('Index/showProjectky');?>"-->
                                   <!--style="color:#162A9C;font-size: 12px;font-weight:bold;">凯盈集团</a>-->
                            <!--</span>-->
                        </div>
                    ...
                    <div class="row text-center">
                        <h3 style="color:#b17d4b;font-weight: bold;font-family: 楷体"><?php echo ($Pinfo["Title"]); ?></h3>
                    </div>
                    <div class="row" style="margin-top:20px;">
                        <img src="/Public/Img/rb.png" width="100%"/>
                    </div>
                    <?php if(($Pinfo['Address'] != null) or ($Pinfo['Tel'] != null)): ?><div class="row" style="margin-top:20px;">
                            <p class="text-center" style="color:#999999;font-size:14px;font-family: 微软雅黑">
                                <?php if($Pinfo['Address'] != null): ?><span>售楼部地址：<?php echo ($Pinfo["Address"]); ?></span><?php endif; ?>
                                <?php if($Pinfo['Tel'] != null): ?><span>&nbsp;&nbsp;&nbsp;&nbsp;联系电话：<?php echo ($Pinfo["Tel"]); ?></span><?php endif; ?>
                            </p>
                    <p style="color:#7D869F;font-size:14px;font-family: 微软雅黑">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($Pinfo["content"]); ?></p>
                    </div><?php endif; ?>

                    <script src="/Public/scroll/jquery.lightSlider.js"></script>
                    <script src="/Public/scroll/prettify.js"></script>
                    <link rel="stylesheet" href="/Public/scroll/lightSlider.css"/>
                    <link rel="stylesheet" href="/Public/scroll/prettify.css"/>
                    <div class="row">
                        <div class="col-xs-12 text-center hidden-md hidden-lg" style="padding: 20px;">
                            <img src="<?php echo ($ImgArr[0]); ?>" width="100%" />
                        </div>
                        <div class="col-lg-12 text-center hidden-xs hidden-sm" style="padding: 20px;height:400px;">
                            <img src="<?php echo ($ImgArr[0]); ?>" class="ccc" style="height:400px;" />
                        </div>
                    </div>
                    <div class="row  hidden-sm hidden-xs" style="margin-top:20px;">
                        <div class="col-xs-1"></div>
                        <div class="col-xs-10 hasActive">
                            <section class="install">
                                <div class="demo" style="margin-top:5px;">
                                    <div class="col-xs-1 text-left">
                                        <a href="javascript:void(0)" id="goToPrevSlide">
                                            <img class="hidden-sm hidden-xs" src="/Public/Img/prev.jpg" width="50%" height="107px"/>
                                        </a>
                                    </div>
                                    <div class="col-xs-10">
                                        <ul id="publicMethods" class="gallery list-unstyled clearfix">
                                            <?php if(is_array($ImgArr)): foreach($ImgArr as $key=>$vo): ?><li style="padding:0 5px;width:200px" class="opaImg text-center">
                                                    <a href="javascript:void(0);" class="aaa" data-s="<?php echo ($vo); ?>" >
                                                        <img src="<?php echo ($vo); ?>"  height="107px"/>
                                                    </a>
                                                </li><?php endforeach; endif; ?>
                                        </ul>
                                    </div>
                                    <div class="col-xs-1 text-right hidden-xs hidden-sm">
                                        <a href="javascript:void(0)" id="goToNextSlide">
                                            <img class="hidden-sm hidden-xs" src="/Public/Img/next.jpg" width="50%" height="107px"/>
                                        </a>
                                    </div>
                                </div>
                                <div class="call">
                    ...
                    <div class="row" style="border-top:2px #f4f4f4 solid;margin-top:10px;"></div>
                </div>
            </div>
            <div class="col-lg-2"></div>
        </div>
        <script type="text/javascript">
            ...
            $(".opaImg").mouseenter(function (e) {
                $(this).find(".opacity").fadeOut(200);
            });
            $(".opaImg").mouseleave(function (e) {
                $(this).find(".opacity").fadeIn(200);
            });
