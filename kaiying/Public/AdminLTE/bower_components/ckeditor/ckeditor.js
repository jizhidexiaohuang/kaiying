...
(function () {
    ...
    window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, f = {
            ...
            getUrl: function (a) {
                ...
                this.timestamp && "/" != a.charAt(a.length - 1) && !/[&?]t=/.test(a) &&
        ...
        return {
            define: function (b, e) {
                ...
                if (0 > g.getListenerIndex(e)) {
                    ...
                    h.fn = e;
                    h.priority = d;
                    for (var q = g.length - 1; 0 <= q; q--)if (g[q].priority <= d)return g.splice(q + 1, 0, h), {removeListener: m};
                    g.unshift(h)
                }
                return {removeListener: m}
            }, once: function () {
                var a =
                    Array.prototype.slice.call(arguments), b = a[1];
                a[1] = function (a) {
                    a.removeListener();
                ...
                return function (d, h, m) {
                    ...
                    if (g) {
                        var q = g.listeners;
                        if (q.length)for (var q = q.slice(0), v, y = 0; y < q.length; y++) {
                            if (g.errorProof)try {
                                v = q[y].call(this,
                                    m, h, b, k)
                            } catch (w) {
                            } else v = q[y].call(this, m, h, b, k);
                            !1 === v ? l = 1 : "undefined" != typeof v && (h = v);
                            if (a || l)break
                        }
                    }
    ...
    (CKEDITOR.editor = function () {
        ...
        var a =
                navigator.userAgent.toLowerCase(), f = a.match(/edge[ \/](\d+.?\d*)/), b = -1 < a.indexOf("trident/"),
            b = !(!f && !b), b = {
                ie: b,
                edge: !!f,
        ...
        if (window.console && window.console.log) {
            ...
            console[f]("[CKEDITOR] For more information about this error go to http://docs.ckeditor.com/#!/guide/dev_errors-section-" +
                b)
        }
    }, null, null, 999), CKEDITOR.dom = {}, function () {
        var a = [], f = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            b = /&/g, c = />/g, e = /</g, l = /"/g, k = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
        ...
        CKEDITOR.tools = {
            arrayCompare: function (a, g) {
                ...
                for (var d =
                    0; d < a.length; d++)if (a[d] != g[d])return !1;
                return !0
            },
            ...
            transformPlainTextToHtml: function (a, g) {
                var d = g == CKEDITOR.ENTER_BR, b = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    b = b.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = g == CKEDITOR.ENTER_P ? "p" : "div";
                if (!d) {
                    var c = /\n{2}/g;
            ...
            style: {
                parse: {
                    ...
                    _findColor: function (a) {
                        var g = [], d = CKEDITOR.tools.array, g =
                            g.concat(a.match(this._rgbaRegExp) || []), g = g.concat(a.match(this._hslaRegExp) || []);
            ...
            array: {
                filter: function (a, g, d) {
                    ...
                    for (var b = [], h = 0; h < a.length; h++)b.push(g.call(d,
                        a[h], h, a));
                    return b
        ...
        var a = CKEDITOR.tools.extend, f = function (a, g) {
            ...
            b = {}, c = {}, e = {
                ...
                table: 1,
                ul: 1
            }, l = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, d = {"#": 1},
        ...
        function (a) {
            ...
            a.removeCustomData = function (a) {
                var c = this.$["data-cke-expando"], c = c && f[c], e, l;
        ...
        appendTo: function (a, f) {
            ...
            function c(b) {
                if (b.type == CKEDITOR.NODE_ELEMENT || b.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                    ...
                    if (a)for (e = 0; e <
                    b.getChildCount(); e++)c(b.getChild(e))
                }
            }
            ...
            if (this.type == CKEDITOR.NODE_ELEMENT && a.type == CKEDITOR.NODE_ELEMENT) {
                if (f.contains) {
                    if (f.contains(b))return CKEDITOR.POSITION_CONTAINS +
            ...
            for (var a; this.getFirst && (a = this.getFirst());) {
                if (a.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (f) f.length <
                    b && (a.split(b - f.length), this.$.removeChild(this.$.firstChild)); else {
                        a.remove();
                        continue
                    }
                }
        ...
        getActive: function () {
            ...
            for (var b = this.$.documentElement, c = 0; b && c < a.length; c++) {
                var e = a[c];
                if (f)for (var l = -1, k = 0; k < b.childNodes.length; k++) {
                    var d = b.childNodes[k];
                    if (!0 !== f || 3 != d.nodeType || !d.previousSibling || 3 != d.previousSibling.nodeType)if (l++, l == e) {
                        b = d;
                        break
                    }
        ...
        var e = f.getCustomData("list_marker_id") || f.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"),
            l = f.getCustomData("list_marker_names") ||
        ...
        var c = f.getCustomData("list_marker_names"), e = f.getCustomData("list_marker_id"), l;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            type: CKEDITOR.NODE_ELEMENT, addClass: e ? function (a) {
                ...
                b && a(b, d) && ((b = b.replace(new RegExp("(?:^|\\s+)" + d + "(?\x3d\\s|$)"), "").replace(/^\s+/, "")) ? this.setAttribute("class",
            ...
            getTabIndex: function () {
                ...
                function a(b, d, g) {
                    if (d && d.type == CKEDITOR.NODE_ELEMENT) {
                        for (var c = []; d.data("cke-bookmark") || d.isEmptyInlineRemoveable();)if (c.push(d),
                                d = g ? d.getNext() : d.getPrevious(), !d || d.type != CKEDITOR.NODE_ELEMENT)return;
                        if (b.isIdentical(d)) {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var l = this.$.getBoundingClientRect(), k = g.$.documentElement,
                        w = k.clientTop || e.$.clientTop || 0, u = k.clientLeft || e.$.clientLeft || 0, r = !0;
                    CKEDITOR.env.ie && (r = g.getDocumentElement().contains(this), g = g.getBody().contains(this), r = f && g || !f && r);
                    r && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = e.$.scrollLeft || k.scrollLeft, c = e.$.scrollTop || k.scrollTop) : (c = f ? e.$ : k, b = c.scrollLeft, c = c.scrollTop), b = l.left + b - u, c = l.top + c - w)
                } else for (w = this, u = null; w && "body" != w.getName() &&
                "html" != w.getName();) {
                    b += w.$.offsetLeft - w.$.scrollLeft;
                    c += w.$.offsetTop - w.$.scrollTop;
                    w.equals(this) || (b += w.$.clientLeft || 0, c += w.$.clientTop || 0);
                    for (; u && !u.equals(w);)b -= u.$.scrollLeft, c -= u.$.scrollTop, u = u.getParent();
                    u = w;
                    w = (l = w.$.offsetParent) ? new CKEDITOR.dom.element(l) : null
                }
                a && (l = this.getWindow(), w = a.getWindow(), !l.equals(w) && l.$.frameElement && (a = (new CKEDITOR.dom.element(l.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
                ...
                f = a.getWindow();
                e = w(this, f);
                var t = w(a, f), A = this.$.offsetHeight;
                g = this.$.offsetWidth;
                var p = a.$.clientHeight, x = a.$.clientWidth;
                f = e.x - u(this, "left") - t.x || 0;
                l = e.y - u(this, "top") - t.y || 0;
                g = e.x + g + u(this, "right") - (t.x + x) || 0;
                e = e.y + A + u(this, "bottom") - (t.y + p) || 0;
            ...
            getFrameDocument: function () {
                ...
                for (var g = 0; g < c.length; g++) {
                    var e = c[g], f = e.nodeName.toLowerCase(), l;
                    if (!(f in b))if ("checked" == f && (l = this.getAttribute(f))) a.setAttribute(f, l); else if (!CKEDITOR.env.ie || this.hasAttribute(f)) l = this.getAttribute(f), null === l && (l = e.nodeValue), a.setAttribute(f, l)
                }
                "" !== this.$.style.cssText &&
        ...
        function a(a, b) {
            ...
            c = g.endContainer;
            var e = g.startOffset, f = g.endOffset, h, p = this.guard, m = this.type,
            ...
            if (a && !this._.guardRTL) {
                var D = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
                    I = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
                this._.guardRTL = function (a, b) {
                    return (!b || !D.equals(a)) && (!I || !a.equals(I)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(g.root))
                }
            }
            var F = a ? this._.guardRTL : this._.guardLTR;
            h = p ? function (a, b) {
                return !1 === F(a, b) ? !1 : p(a, b)
            } : F;
            this.current ? c = this.current[n](!1,
                m, h) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < f ? c.getChild(f - 1) : !1 === h(c, !0) ? null : c.getPreviousSourceNode(!0, m, h)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(e)) || (c = !1 === h(d, !0) ? null : d.getNextSourceNode(!0, m, h)))), c && !1 === h(c) && (c = null));
            for (; c && !this._.end;) {
                this.current = c;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), d = CKEDITOR.dom.walker.temp(), h = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var g = 0, c = b.getChildCount(); g < c; ++g)if (!m(b.getChild(g)))return !!a;
                return !a
            }
        };
        ...
        function f(a, b, c, d, e) {
            function f(a, b, g, c) {
                ...
                if (c && l)return d;
                p || c ? b.append(a.clone(!0, e), g) : (a.remove(), k && b.append(a));
                return d
            }

            function h() {
                var a, b, g, c = Math.min(L.length,
                    E.length);
                for (a = 0; a < c; a++)if (b = L[a], g = E[a], !b.equals(g))return a;
                return a - 1
            }

            function m() {
                var b = T - 1, c = F && J && !x.equals(B);
                b < H - 1 || b < O - 1 || c ? (c ? a.moveToPosition(B, CKEDITOR.POSITION_BEFORE_START) : O == b + 1 && I ? a.moveToPosition(E[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(E[b + 1], CKEDITOR.POSITION_BEFORE_START), d && (b = L[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT && (c = CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e', a.document), c.insertAfter(b),
                    b.mergeSiblings(!1), a.moveToBookmark({startNode: c}))) : a.collapse(!0)
            }

            a.optimizeBookmark();
            var l = 0 === b, k = 1 == b, p = 2 == b;
            b = p || k;
            var x = a.startContainer, B = a.endContainer, z = a.startOffset, C = a.endOffset, D, I, F, J, G, M;
            if (p && B.type == CKEDITOR.NODE_TEXT && x.equals(B)) x = a.document.createText(x.substring(z, C)), c.append(x); else {
                B.type == CKEDITOR.NODE_TEXT ? p ? M = !0 : B = B.split(C) : 0 < B.getChildCount() ? C >= B.getChildCount() ? (B = B.getChild(C - 1), I = !0) : B = B.getChild(C) : J = I = !0;
                x.type == CKEDITOR.NODE_TEXT ? p ? G = !0 : x.split(z) : 0 < x.getChildCount() ?
                    0 === z ? (x = x.getChild(z), D = !0) : x = x.getChild(z - 1) : F = D = !0;
                for (var L = x.getParents(), E = B.getParents(), T = h(), H = L.length - 1, O = E.length - 1, K = c, U, V, ca, fa = -1, P = T; P <= H; P++) {
                    V = L[P];
                    ca = V.getNext();
                    for (P != H || V.equals(E[P]) && H < O ? b && (U = K.append(V.clone(0, e))) : D ? f(V, K, !1, F) : G && K.append(a.document.createText(V.substring(z))); ca;) {
                        if (ca.equals(E[P])) {
                            fa = P;
                            break
                        }
                ...
                K = c;
                for (P = T; P <= O; P++)if (c = E[P], ca = c.getPrevious(), c.equals(L[P])) b && (K = K.getChild(0)); else {
                    P != O || c.equals(L[P]) && O < H ? b && (U = K.append(c.clone(0, e))) :
                        I ? f(c, K, !1, J) : M && K.append(a.document.createText(c.substring(0, C)));
                    if (P > fa)for (; ca;)ca = f(ca, K, !0);
                    K = U
                }
                p || m()
            }
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var h = this.getCommonAncestor(), m = this.root, l, k, p, x, B, z = !1, C, D;
                        C = this.startContainer;
                        var I = this.startOffset;
                        C.type == CKEDITOR.NODE_TEXT ? (I && (C = !CKEDITOR.tools.trim(C.substring(0, I)).length &&
                            C, z = !!C), C && ((x = C.getPrevious()) || (p = C.getParent()))) : (I && (x = C.getChild(I - 1) || C.getLast()), x || (p = C));
                        for (p = c(p); p || x;) {
                            if (p && !x) {
                                !B && p.equals(h) && (B = !0);
                                if (e ? p.isBlockBoundary() : !m.contains(p))break;
                                z && "inline" == p.getComputedStyle("display") || (z = !1, B ? l = p : this.setStartBefore(p));
                                x = p.getPrevious()
                            }
                            for (; x;)if (C = !1, x.type == CKEDITOR.NODE_COMMENT) x = x.getPrevious(); else {
                                if (x.type == CKEDITOR.NODE_TEXT) D = x.getText(), d.test(D) && (x = null), C = /[\s\ufeff]$/.test(D); else if ((x.$.offsetWidth > (CKEDITOR.env.webkit ? 1 :
                                        0) || b && x.is("br")) && !x.data("cke-bookmark"))if (z && CKEDITOR.dtd.$removeEmpty[x.getName()]) {
                                    D = x.getText();
                                    if (d.test(D)) x = null; else for (var I = x.$.getElementsByTagName("*"), F = 0, J; J = I[F++];)if (!CKEDITOR.dtd.$removeEmpty[J.nodeName.toLowerCase()]) {
                                        x = null;
                                        break
                                    }
                                    x && (C = !!D.length)
                                } else x = null;
                                C && (z ? B ? l = p : p && this.setStartBefore(p) : z = !0);
                                if (x) {
                                    C = x.getPrevious();
                                    if (!p && !C) {
                                        p = x;
                        ...
                        C.type == CKEDITOR.NODE_TEXT ?
                            CKEDITOR.tools.trim(C.substring(I)).length ? z = !0 : (z = !C.getLength(), I == C.getLength() ? (x = C.getNext()) || (p = C.getParent()) : f(C, I) && (p = C.getParent())) : (x = C.getChild(I)) || (p = C);
                        for (; p || x;) {
                            if (p && !x) {
                                !B && p.equals(h) && (B = !0);
                                if (e ? p.isBlockBoundary() : !m.contains(p))break;
                                z && "inline" == p.getComputedStyle("display") || (z = !1, B ? k = p : p && this.setEndAfter(p));
                                x = p.getNext()
                            }
                            for (; x;) {
                                C = !1;
                                if (x.type == CKEDITOR.NODE_TEXT) D = x.getText(), f(x, 0) || (x = null), C = /^[\s\ufeff]/.test(D); else if (x.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < x.$.offsetWidth ||
                                        b && x.is("br")) && !x.data("cke-bookmark"))if (z && CKEDITOR.dtd.$removeEmpty[x.getName()]) {
                                        D = x.getText();
                                        if (d.test(D)) x = null; else for (I = x.$.getElementsByTagName("*"), F = 0; J = I[F++];)if (!CKEDITOR.dtd.$removeEmpty[J.nodeName.toLowerCase()]) {
                                            x = null;
                                            break
                                        }
                                        x && (C = !!D.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        m = this.root;
                        p.setStartAt(m, CKEDITOR.POSITION_AFTER_START);
                        p.setEnd(this.startContainer, this.startOffset);
                        p = new CKEDITOR.dom.walker(p);
                        var G, M,
                            L = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null),
                            E = null, T = function (a) {
                        ...
                        p = p.lastBackward();
                        G = G || m;
                        this.setStartAt(G, !G.is("br") && (!p && this.checkStartOfBlock() || p && G.contains(p)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            p = this.clone();
                            p = new CKEDITOR.dom.walker(p);
                            var H = CKEDITOR.dom.walker.whitespaces(), O = CKEDITOR.dom.walker.bookmark();
                            p.evaluator = function (a) {
                                return !H(a) && !O(a)
                            };
                            if ((p = p.previous()) && p.type == CKEDITOR.NODE_ELEMENT && p.is("br"))break
                        }
                        p = this.clone();
                        p.collapse();
                        p.setEndAt(m,
                        ...
                        p = new CKEDITOR.dom.walker(p);
                        p.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : T;
                        G = E = M = null;
                        p = p.lastForward();
                        G = G || m;
                        this.setEndAt(G, !p && this.checkEndOfBlock() || p && G.contains(p) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
                ...
                if (!this.collapsed) {
                    ...
                    var f = this.clone(), h =
                        this.startContainer, m = this.endContainer, l = this.startOffset, k = this.endOffset, p = c = 1;
                    h && h.type == CKEDITOR.NODE_TEXT && (l ? l >= h.getLength() ? f.setStartAfter(h) : (f.setStartBefore(h), c = 0) : f.setStartBefore(h));
                    m && m.type == CKEDITOR.NODE_TEXT && (k ? k >= m.getLength() ? f.setEndAfter(m) : (f.setEndAfter(m), p = 0) : f.setEndBefore(m));
                    var f = new CKEDITOR.dom.walker(f), x = CKEDITOR.dom.walker.bookmark(),
                    ...
                    p && (f.reset(), (f = f[a == CKEDITOR.SHRINK_ELEMENT ?
                        "lastBackward" : "previous"]()) && this.setEndAt(f, b ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_END));
                    return !(!c && !p)
                }
                ...
                this.deleteContents();
                e && e.equals(f) && (d ? (h = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END), f = null) : c ? (h = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e,
                    CKEDITOR.POSITION_BEFORE_START), e = null) : (f = this.splitElement(e, b || !1), e.is("ul", "ol") || e.appendBogus()));
                ...
                var b = this.startContainer, c =
                    this.endContainer, d = b.getAscendant("table", !0), e = c.getAscendant("table", !0);
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], f, h, m, l;
                if (c && c.find)for (h = c.find(a), f = 0; f < h.count(); f++)if (c = h.getItem(f), b || !c.isReadOnly()) m = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
                    d.startNode.equals(c), l = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || d.endNode.equals(c), m && l && e.push(c);
                return e
            }
        };
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    f = w.startPath();
                    var u = w.endPath(), r = !w.collapsed && c(w, f.block), t = !w.collapsed && c(w, u.block, 1);
                    w.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    r && w.setStartAt(f.block, CKEDITOR.POSITION_BEFORE_END);
                    t && w.setEndAt(u.block, CKEDITOR.POSITION_AFTER_START);
                    ...
                    w.collapsed || (f = new CKEDITOR.dom.walker(w.clone()),
                        ...
                        u.root), this._.lastNode = (u.block || u.blockLimit).getNextSourceNode(!0))), this._.lastNode && w.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = w.document.createText(""), this._.lastNode.insertAfter(f)), w = null);
                    this._.started = 1;
                    f = w
                }
                u = this._.nextNode;
                ...
                for (this._.nextNode = null; u;) {
                    var r = 0, t = u.hasAscendant("pre"), A = u.type != CKEDITOR.NODE_ELEMENT, p = 0;
                    if (A) u.type == CKEDITOR.NODE_TEXT && e.test(u.getText()) && (A = 0); else {
                        var x = u.getName();
                        if (CKEDITOR.dtd.$block[x] && "false" == u.getAttribute("contenteditable")) {
                            g =
                                u;
                            b(this, a, g);
                            break
                        } else if (u.isBlockBoundary(this.forceBrBreak && !t && {br: 1})) {
                            if ("br" == x) A = 1; else if (!f && !u.getChildCount() && "hr" != x) {
                                g = u;
                                k = u.equals(w);
                                break
                            }
                            f && (f.setEndAt(u, CKEDITOR.POSITION_BEFORE_START), "br" != x && (this._.nextNode = u));
                            r = 1
                        } else {
                            if (u.getFirst()) {
                    ...
                    if (f && !r)for (; !u.getNext(d) && !k;) {
                        ...
                        if (x.isBlockBoundary(this.forceBrBreak && !t && {br: 1})) {
                            ...
                            A = 0;
                            k || x.equals(w);
                            f.setEndAt(x, CKEDITOR.POSITION_BEFORE_END);
                            break
                        }
                        u = x;
                        A = 1;
                    ...
                    u = this._getNextSourceNode(u, p, w);
                    if ((k = !u) || r && f)break
                }
                if (!g) {
                    ...
                    r = {div: 1, th: 1, td: 1};
                    g = g.block;
                    !g && u && !this.enforceRealBlocks && r[u.getName()] &&
                    f.checkStartOfBlock() && f.checkEndOfBlock() && !u.equals(f.root) ? g = u : !g || this.enforceRealBlocks && g.is(h) ? (g = this.range.document.createElement(a), f.extractContents().appendTo(g), g.trim(), f.insertNode(g), v = y = !0) : "li" != g.getName() ? f.checkStartOfBlock() && f.checkEndOfBlock() || (g = g.clone(!1), f.extractContents().appendTo(g), g.trim(), y = f.splitBlock(), v = !y.wasStartOfBlock, y = !y.wasEndOfBlock, f.insertNode(g)) : k || (this._.nextNode = g.equals(w) ? null : this._getNextSourceNode(f.getBoundaryNodes().endNode, 1, w))
                }
                v && (v =
                    g.getPrevious()) && v.type == CKEDITOR.NODE_ELEMENT && ("br" == v.getName() ? v.remove() : v.getLast() && "br" == v.getLast().$.nodeName.toLowerCase() && v.getLast().remove());
                y && (v = g.getLast()) && v.type == CKEDITOR.NODE_ELEMENT && "br" == v.getName() && (!CKEDITOR.env.needsBrFiller || v.getPrevious(l) || v.getNext(l)) && v.remove();
        ...
        function a(a, b, c, d, e) {
            ...
            for (g in b) {
                f = b[g];
                f = "boolean" == typeof f ? {} : "function" == typeof f ? {match: f} : F(f);
                ...
                for (m in M) {
                    h[m] = k(h[m],
                            p) || null;
                    var l = h, u = L[m], x = k(h[L[m]], p), E = h[m], n = [], D = !0, H = void 0;
                    x ? D = !1 : x = {};
                    for (H in E)"!" == H.charAt(0) && (H = H.slice(1), n.push(H), x[H] = !0, D = !1);
                    for (; H = n.pop();)E[H] = E["!" + H], delete E["!" + H];
                    l[u] = (D ? !1 : x) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (m in L) {
                    ...
                    x = [];
                    E = void 0;
                    for (E in u)-1 < E.indexOf("*") ? x.push(new RegExp("^" +
                        E.replace(/\*/g, ".*") + "$")) : x.push(E);
                    u = x;
                    u.length && (h[p] = u, l = !1)
                }
                h.nothingRequired = l;
                h.noProperties = !(h.attributes || h.classes || h.styles);
                if (!0 === g.elements || null === g.elements) e[f ? "unshift" : "push"](g); else for (B in h = g.elements, delete g.elements, h)if (b[B]) b[B][f ? "unshift" : "push"](g); else b[B] = [g]
            }
        }
        ...
        function f(a, c, e, g) {
            if (!a.match || a.match(c))if (g || d(a, c))if (a.propertiesOnly || (e.valid = !0), e.allAttributes || (e.allAttributes = b(a.attributes, c.attributes, e.validAttributes)), e.allStyles || (e.allStyles = b(a.styles,
                ...
                if (a)if (!0 === a) a = !0; else {
                    for (var f = 0, h = c.length, p; f < h; ++f)p = c[f], g[p] || (g[p] = a(p));
                    a = !1
                } else a = !1;
                e.allClasses = a
            }
        ...
        function g(a) {
            var b, c, d, e, g = {}, f = 1;
            for (a = J(a); b = a.match(E);)(c = b[2]) ? (d = n(c, "styles"), e = n(c, "attrs"), c = n(c, "classes")) : d = e = c = null, g["$" + f++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: e
        ...
        function v(a, b, d, e) {
            var g = 0, h;
            e.toHtml && (b.name = b.name.replace(H, "$1"));
            if (e.doCallbacks && a.elementCallbacks) {
                a:{
                    h = a.elementCallbacks;
                    for (var p = 0, m = h.length, l; p < m; ++p)if (l = h[p](b)) {
                        h = l;
                        break a
                    }
                    h = void 0
            ...
            if (e.doTransform && (h = a._.transformations[b.name])) {
                q(b);
                for (p = 0; p < h.length; ++p)x(a, b, h[p]);
                w(b)
            }
            if (e.doFilter) {
                a:{
                    p =
                        b.name;
                    m = a._;
                    a = m.allowedRules.elements[p];
                    h = m.allowedRules.generic;
                    p = m.disallowedRules.elements[p];
                    ...
                    if (a || h) {
                        q(b);
                        if (p)for (r = 0, E = p.length; r < E; ++r)if (!1 === c(p[r], b, k)) {
                            a = null;
                            break a
                        }
                        if (m)for (r = 0, E = m.length; r < E; ++r)c(m[r], b, k);
                        if (a)for (r = 0, E = a.length; r < E; ++r)f(a[r], b, k, l);
                        if (h)for (r =
                                       0, E = h.length; r < E; ++r)f(h[r], b, k, l);
                        a = k
                    } else a = null
                }
                ...
                var L = a.validStyles;
                h = a.validClasses;
                var p = b.attributes, n = b.styles, m = b.classes;
                l = b.classBackup;
                var D = b.styleBackup, B, t, z = [], k = [], F = /^data-cke-/;
                r = !1;
                delete p.style;
                delete p["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes)for (B in p)E[B] || (F.test(B) ? B == (t = B.replace(/^data-cke-saved-/, "")) || E[t] || (delete p[B], r = !0) : (delete p[B], r = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (B in n)a.allStyles ||
                    L[B] ? z.push(B + ":" + n[B]) : r = !0;
                    z.length && (p.style = z.sort().join("; "))
                } else D && (p.style = D);
                if (!a.allClasses || a.hadInvalidClass) {
                    for (B = 0; B < m.length; ++B)(a.allClasses || h[m[B]]) && k.push(m[B]);
                    k.length && (p["class"] = k.sort().join(" "));
                    l && k.length < l.split(/\s+/).length && (r = !0)
                } else l && (p["class"] = l);
                r && (g = 1);
        ...
        function A(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && ("br" == a.name || I.$block[a.name])
        }

        function p(a, b, c) {
            var d = a.name;
            if (I.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(t()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (I.$block[d] || "tr" == d)if ("br" == b) a.previous && !A(a.previous) && (b = t(), b.insertBefore(a)), a.next && !A(a.next) && (b = t(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = I[b];
                    for (var g = 0, f = d.length, h; g < f; ++g)if (h = d[g], h.type == CKEDITOR.NODE_ELEMENT &&
                        !e[h.name]) {
                        e = !1;
                        break b
                    }
                ...
                if (e) a.name = b, a.attributes = {}, c.push({check: "parent-down", el: a}); else {
                    e = a.parent;
                    for (var g = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, p, m, f = d.length; 0 < f;)h = d[--f], g && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && I.$inline[h.name]) ? (p || (p = new CKEDITOR.htmlParser.element(b), p.insertAfter(a), c.push({
                        check: "parent-down",
                        el: p
                    })), p.add(h, 0)) : (p = null, m = I[e.name] || I.span, h.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h.type != CKEDITOR.NODE_ELEMENT ||
                    m[h.name] || c.push({check: "el-up", el: h}));
                    a.remove()
                }
        ...
        function B(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, g, f, h, p;
            if (a.name != c.element)return !1;
            for (g in d)if ("class" == g)for (c = d[g].split(/\s+/), h = a.classes.join("|"); p = c.pop();) {
                if (-1 == h.indexOf(p))return !1
        ...
        var I = CKEDITOR.dtd, F = CKEDITOR.tools.copy, J = CKEDITOR.tools.trim, G = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, g = [], f = this.editor && this.editor.config.protectedSource, h, m = !1,
                    l = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"])return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-"))if (h = v(e, a, g, l), h & 1) m = !0; else if (h & 2)return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var p, k, u;
                            if (f)for (k = 0; k < f.length; ++k)if ((u = d.match(f[k])) && u[0].length == d.length) {
                                c = !0;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            1 == d.children.length && (p = d.children[0]).type == CKEDITOR.NODE_ELEMENT && v(e, p, c, l);
                            c = !c.length
                        }
                        c || g.push(a)
                    }
                ...
                for (var x; c = g.pop();)c.type == CKEDITOR.NODE_ELEMENT ? p(c, d, a) : c.remove();
                for (; k = a.pop();)if (c = k.el, c.parent)switch (x = I[c.parent.name] || I.span, k.check) {
                    case "it":
                        I.$removeEmpty[c.name] && !c.children.length ? p(c, d, a) : u(c) || p(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || p(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || x[c.name] || p(c.parent, d, a)
                }
                return m
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var g = void 0, f = void 0, h = void 0, p = void 0, m = void 0, l = void 0;
                        c = [];
                        for (f = 0; f < b.length; ++f)h = b[f], "string" == typeof h ? (h = h.split(/\s*:\s*/), p = h[0], m = null, l = h[1]) : (p = h.check, m = h.left, l = h.right), g || (g = h, g = g.element ? g.element : p ? p.match(/^([a-z0-9]+)/i)[0] :
                            g.left.getDefinition().element), m instanceof CKEDITOR.style && (m = C(m)), c.push({
                            check: p == g ? null : p,
                            left: m,
                ...
                var h = CKEDITOR.tools.clone(e), p = [], l;
                if (!1 !== b && (l = this._.transformations[e.name])) {
                    for (d =
                             0; d < l.length; ++d)x(this, e, l[d]);
                    w(e)
                }
                v(this, h, p, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                b = 0 < p.length ? !1 : CKEDITOR.tools.objectCompare(e.attributes, h.attributes, !0) ? !0 : !1;
        ...
        var M = {styles: 1, attributes: 1, classes: 1},
            ...
            T = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, H = /^cke:(object|embed|param)$/,
            O = /^(object|embed|param)$/, K;
        K = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, g, f, h, p;
                    a.name = c.element;
                    for (g in e)if ("class" == g)for (c =
                                                          a.classes.join("|"), h = e[g].split(/\s+/); p = h.pop();)-1 == c.indexOf(p) && a.classes.push(p); else a.attributes[g] = e[g];
        ...
        var a, f = function (b) {
            b = b.data;
            var e = b.getKeystroke(), f = this.keystrokes[e], k = this._.editor;
            a = !1 === k.fire("key", {keyCode: e, domEvent: b});
            a || (f && (a = !1 !== k.execCommand(f, {from: "keystrokeHandler"})), a || (a = !!this.blockedKeystrokes[e]));
        ...
        CKEDITOR.lang = {
            languages: {
                ...
                f = f || navigator.userLanguage || navigator.language ||
                    a;
        ...
        return {
            load: function (b, c, e, l) {
                ...
                k && (b = [b]);
                e || (e = CKEDITOR);
                var d = b.length, h = [], m = [], g = function (a) {
                    c && (k ? c.call(e, a) : c.call(e, h, m))
                };
                if (0 === d) g(!0); else {
                    var n = function (a, b) {
                        (b ? h : m).push(a);
                        0 >= --d && (l && CKEDITOR.document.getDocumentElement().removeStyle("cursor"),
                            g(b))
                    }, q = function (b, c) {
                        a[b] = 1;
                        var d = f[b];
                        ...
                        if (a[b]) n(b, !0); else {
                            ...
                            if (!(1 < d.length)) {
                                ...
                                c && (CKEDITOR.env.ie && (8 >= CKEDITOR.env.version || CKEDITOR.env.ie9Compat) ? e.$.onreadystatechange = function () {
                                    if ("loaded" == e.$.readyState || "complete" == e.$.readyState) e.$.onreadystatechange = null, q(b, !0)
                                } : (e.$.onload = function () {
                                    setTimeout(function () {
                                        q(b,
                                            !0)
            ...
            return function (b, c, e) {
                var l = {}, k = function (b) {
                    a.call(this, b, function (a) {
                        ...
                        var b = [], d;
                        for (d in a) {
                            var n = a[d], q = n && n.requires;
                            if (!f[d]) {
                                if (n.icons)for (var v = n.icons.split(","), y = v.length; y--;)CKEDITOR.skin.addIcon(v[y], n.path + "icons/" + (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") + v[y] + ".png");
                                f[d] = 1
                            }
                            if (q)for (q.split && (q = q.split(",")), n = 0; n < q.length; n++)l[q[n]] || b.push(q[n])
                        }
                        if (b.length) k.call(this, b); else {
                            for (d in l)n = l[d], n.onLoad && !n.onLoad._called && (!1 ===
                            n.onLoad() && delete l[d], n.onLoad._called = 1);
                            c && c.call(e || window, l)
                        }
                    }, this)
                };
        ...
        function n(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var h in c) {
                    var p = c[h], m = p.lang, l = null, k = p.requires, x;
                    CKEDITOR.tools.isArray(k) && (k = k.join(","));
                    if (k && (x = k.match(f)))for (; k = x.pop();)CKEDITOR.error("editor-plugin-required",
                        {plugin: k.replace(",", ""), requiredBy: h});
                    m && !a.lang[h] && (m.split && (m = m.split(",")), 0 <= CKEDITOR.tools.indexOf(m, a.langCode) ? l = a.langCode : (l = a.langCode.replace(/-.*/, ""), l = l != a.langCode && 0 <= CKEDITOR.tools.indexOf(m, l) ? l : 0 <= CKEDITOR.tools.indexOf(m, "en") ? "en" : m[0]), p.langEntries && p.langEntries[l] ? (a.lang[h] = p.langEntries[l], l = null) : g.push(CKEDITOR.getUrl(p.path + "lang/" + l + ".js")));
                    e.push(l);
                    d.push(p)
                }
                CKEDITOR.scriptLoader.load(g, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], g = 0; g < c.length; g++)for (var f =
                        0; f < d.length; f++) {
                        var h = d[f];
        ...
        function v(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, g, f, h, m = 0; m < a.length; m++) {
                var l = a[m], k = l.startContainer.getAscendant("tr", !0);
                c(l) ? (g ||
                (g = k.getAscendant("table").clone(), g.append(k.getAscendant({
                    thead: 1,
                    tbody: 1,
                    tfoot: 1
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                var c = this.editable(), d = this.getSelection().getRanges(), e = new CKEDITOR.dom.documentFragment, g;
            ...
            CKEDITOR.htmlParser.prototype = {
                onTagOpen: function () {
                    ...
                    for (var c, e, l = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                        e = c.index;
                        if (e > l)if (l = b.substring(l, e), k) k.push(l); else this.onText(l);
        ...
        CKEDITOR.htmlParser.node.prototype = {
            remove: function () {
                ...
                var f = this.parent.children,
                    b = CKEDITOR.tools.indexOf(f, this), c = a.previous = this.previous, e = a.next = this.next;
                c && (c.next = a);
                e && (e.previous = a);
                f[b] = a;
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (l, k, d) {
            function h(a) {
                var b;
                if (0 < u.length)for (var c = 0; c < u.length; c++) {
                    var d = u[c], e = d.name, g = CKEDITOR.dtd[e], f = t.name && CKEDITOR.dtd[t.name];
                    f && !f[e] || a && g && !g[a] && CKEDITOR.dtd[a] ? e == t.name && (n(t, t.parent, 1), c--) : (b || (m(), b = 1), d = d.clone(), d.parent = t, t = d, u.splice(c, 1), c--)
                }
            }

            function m() {
                for (; r.length;)n(r.shift(), t)
            }
            ...
            function n(b, c, e) {
                c = c || t || w;
                var f = t;
                void 0 === b.previous && (q(c, b) && (t = c, y.onTagOpen(d, {}), b.returnPoint = c = t), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (p = !1), "textarea" == b.name && (A = !1));
                b.returnPoint ? (t = b.returnPoint, delete b.returnPoint) : t = e ? c : f
            }
            ...
            var y = new CKEDITOR.htmlParser,
                ...
                u = [], r = [], t = w, A = "textarea" == w.name, p = "pre" == w.name;
            y.onTagOpen =
                function (d, e, g, l) {
                    ...
                    if (a(e)) u.push(e); else {
                        ...
                        if ("br" == d) r.push(e); else {
                            for (; !(l = (g = t.name) ? CKEDITOR.dtd[g] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || t.isUnknown || l[d]);)if (t.isOptionalClose) y.onTagClose(g); else if (d in b && g in b) g = t.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"),
                                t), !e.returnPoint && (e.returnPoint = t), t = g; else if (d in CKEDITOR.dtd.$listItem && !v(d, g)) y.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1); else if (g in f && !v(d, g)) !e.returnPoint && (e.returnPoint = t), t = t.parent; else if (g in CKEDITOR.dtd.$inline && u.unshift(t), t.parent) n(t, t.parent, 1); else {
                                e.isOrphan = 1;
                                break
                            }
                            h(d);
            ...
            y.onTagClose = function (a) {
                for (var b = u.length - 1; 0 <= b; b--)if (a == u[b].name) {
                    u.splice(b, 1);
                    return
                }
                for (var c = [], e = [], g = t; g != w && g.name != a;)g._.isBlockLike || e.unshift(g), c.push(g),
            ...
            y.onText = function (a) {
                if (!(t._.hasInlineStarted && !r.length || p || A) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length))return;
                var b = t.name, g = b ? CKEDITOR.dtd[b] || (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!A && !g["#"] && b in f) y.onTagOpen(e[b] || ""), y.onText(a); else {
                    m();
                    h();
                    p || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                    a =
                        new CKEDITOR.htmlParser.text(a);
                    if (q(t, a)) this.onTagOpen(d, {}, 0, 1);
                    t.add(a)
                }
            };
        ...
        CKEDITOR.htmlParser.fragment.prototype = {
            type: CKEDITOR.NODE_DOCUMENT_FRAGMENT, add: function (a, b) {
                ...
                if (!1 !== e) {
                    c = this.children;
                    for (var f = 0; f < c.length; f++)e = c[f], e.type == CKEDITOR.NODE_ELEMENT ? e.forEach(a,
                        b) : b && e.type != b || a(e)
                }
            }, getFilterContext: function (a) {
                return a || {}
        ...
        a.prototype =
            {
                ...
                var e = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    f = Array.prototype.slice.call(arguments, 1), k = this.rules,
                    d = k.length, h, m, g, n;
                for (n = 0; n < d; n++)if (e && (h = c.type, m = c.name), g = k[n], !(a.nonEditable && !g.options.applyToAll || a.nestedEditable && g.options.excludeNestedEditable)) {
        ...
        function a(a,
            ...
            function f(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var f = [], p = b(e), m, k;
                        if (p)for (h(p, 1) && f.push(p); p;)l(p) && (m = c(p)) && h(m) && ((k = c(m)) && !l(k) ? f.push(m) : (g(E).insertAfter(m), m.remove())), p = p.previous;
                        for (p = 0; p < f.length; p++)f[p].remove();
                        if (f = !a || !1 !== ("function" == typeof d ? d(e) : d)) E || CKEDITOR.env.needsBrFiller || e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ?
                            E || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (f = b(e), f = !f || "form" == e.name && "input" == f.name) : f = !1 : f = !1;
                        f && e.add(g(a))
                    }
                }
            }
            ...
            function h(a, b) {
                ...
                var c;
                return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(u)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller &&
                E && (!b || a.parent.name in L) || !E && ((c = a.previous) && "br" == c.name || !c || l(c))) ? !0 : !1
            }

            var m = {elements: {}}, E = "html" == d, L = CKEDITOR.tools.extend({}, p), x;
            for (x in L)"#" in t[x] || delete L[x];
            for (x in L)m.elements[x] = f(E, a.config.fillEmptyBlocks);
            m.root = f(E, !1);
                    ...
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"]; else {
                            ...
                            !d && l(b.parent) ? k(b.parent,
                                g(a)) : l(d) && f && !l(f) && g(a).insertBefore(d)
                        }
                    }
                }
            }(E);
        ...
        function l(a) {
            return a && (a.type == CKEDITOR.NODE_ELEMENT && a.name in
                p || a.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
        }
        ...
        function w(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) {
                return "\x3c" + c + d + "\x3e" + y(v(e), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            d.addRules(z);
            d.addRules(C, {applyToAll: !0});
            d.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, d, c = w(c, b), c = g(c, G), c = m(c), c = g(c, J), c = c.replace(L, "$1cke:$2"),
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var e = this.editor, g, f, h, p;
                b && "object" == typeof b ? (g = b.context, c = b.fixForBody, d = b.dontFilter, f = b.filter, h = b.enterMode, p = b.protectedWhitespaces) : g = b;
                g || null === g || (g = e.editable().getName());
                return e.fire("toHtml", {
                    dataValue: a, context: g, fixForBody: c, dontFilter: d,
                    filter: f || e.filter, enterMode: h || e.enterMode, protectedWhitespaces: p
                }).dataValue
        ...
        var u = /(?:&nbsp;|\xa0)$/, r = "{cke_protected}", t = CKEDITOR.dtd,
            A = "caption colgroup col thead tfoot tbody".split(" "), p = CKEDITOR.tools.extend({}, t.$blockLimit,
            t.$block), x = {elements: {input: d, textarea: d}}, B = {
        ...
        var D = /<(a|area|img|input|source)\b([^>]*)>/gi,
            I = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, F = /^(href|src|name)$/i,
            J = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            G = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, M = /<cke:encoded>([^<]*)<\/cke:encoded>/gi,
            L = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,
            E = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, T = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    }(),
        ...
        var f = {};
        ((a instanceof
        CKEDITOR.htmlParser.element ? a.attributes.style : a) || "").replace(/&quot;/g, '"').replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, e) {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var h, m;
                for (h in k) {
                    for (d = k[h]; ;)if (m = a.onAttributeName(b, h))if (m != h) delete k[h], h = m; else break; else {
                        delete k[h];
                        break
                    }
                ...
                b && this.filter(b);
                var l = this.name, k = [], d = this.attributes, h, m;
                a.openTag(l, d);
        ...
        CKEDITOR.inlineAll = function () {
            var a, f, b;
            for (b in CKEDITOR.dtd.$editable)for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, l = c.count(); e < l; e++)a = c.getItem(e), "true" == a.getAttribute("contenteditable") && (f = {
                element: a,
                config: {}
        ...
        function b(a) {
            var b = a.name, f = a.element, k = a.elementMode, d = a.fire("uiSpace", {
                    space: "top",
                    html: ""
            ...
            k == CKEDITOR.ELEMENT_MODE_REPLACE ?
                (f.hide(), b.insertAfter(f)) : f.append(b);
            a.container = b;
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            var f = this, k = this._.modes;
            if (a != f.mode && k && k[a]) {
                f.fire("beforeSetMode", a);
                if (f.mode) {
                    var d = f.checkDirty(), k = f._.previousModeData, h, m = 0;
                    f.fire("beforeModeUnload");
                    f.editable(0);
                    f._.previousMode = f.mode;
                    f._.previousModeData = h = f.getData(1);
                    "source" == f.mode && k == h && (f.fire("lockSnapshot", {forceUpdate: !0}), m = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, f, k) {
            ...
            k.setSize("width", a, !0);
            m && (m.style.width = "1%");
            var g = (k.$.offsetHeight || 0) - (h.$.clientHeight ||
                0), d = Math.max(b - (f ? 0 : g), 0);
            b = f ? b + g : b;
            h.setStyle("height", d + "px");
            m && (m.style.width = "100%");
            this.fire("resize", {outerHeight: b, contentsHeight: d, outerWidth: a || k.getSize("width")})
        };
        ...
        function a(a) {
            var b = a.editor, d = a.data.path, e = d.blockLimit, g = a.data.selection,
                h = g.getRanges()[0], m;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)if (g = f(g, d)) g.appendBogus(), m = CKEDITOR.env.ie;
            ...
            }, !e.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) && (b = h.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller ||
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
                        ...
                        thead: 1,
                        tfoot: 1
                    }) ? u(b) : b.startContainer.is(CKEDITOR.dtd.$list) && r(b));
                    var f, h;
                ...
                fixInitialSelection: function () {
                    ...
                    } else c.autoParagraph(this.editor, a), q(a.startContainer) && a.startContainer.appendBogus();
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (h) {
                            var f = e.getHead(), k = f.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in n) {
                                    var e, f = b.getRanges()[0], h = f.startPath(), m, k, r, c = 8 == c;
                                    CKEDITOR.env.ie &&
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (c in n && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                if (d.collapsed)a:{
                                    var e = b.block;
                                    if (e && d[c ? "checkStartOfBlock" :
                                            "checkEndOfBlock"]() && d.moveToClosestEditablePosition(e, !c) && d.collapsed) {
        ...
        w = function () {
            ...
            function b(c, d) {
                var e, f, g, h, m = [], k = d.range.startContainer;
                e = d.range.startPath();
                for (var k = l[k.getName()], n = 0, r = c.getChildren(), u = r.count(), D = -1, w = -1, t = 0, q = e.contains(l.$list); n < u; ++n)e = r.getItem(n), a(e) ? (g = e.getName(), q && g in CKEDITOR.dtd.$list ? m = m.concat(b(e, d)) : (h = !!k[g],
                "br" != g || !e.data("cke-eol") || n && n != u - 1 || (t = (f = n ? m[n - 1].node : r.getItem(n + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && l.$block[f.getName()]), -1 != D || h || (D = n), h || (w = n), m.push({
                    isElement: 1,
                    isLineBreak: t,
                    ...
                    name: g,
                    allowed: h
                }), f = t = 0)) : m.push({isElement: 0, node: e, allowed: 1});
                -1 < D && (m[D].firstNotAllowed = 1);
                -1 < w && (m[w].lastNotAllowed = 1);
                return m
            }

            function e(b, c) {
                var d = [], f = b.getChildren(), g = f.count(), h, m = 0, k = l[c], n = !b.is(l.$inline) || b.is("br");
                for (n && d.push(" "); m < g; m++)h =
                    f.getItem(m), a(h) && !h.is(k) ? d = d.concat(e(h, c)) : d.push(h);
                n && d.push(" ");
                return d
            }
            ...
            function h(b, c, d, e) {
                ...
                (g = (new CKEDITOR.dom.walker(f)).next()) && a(g) && n[g.getName()] && (m = g.getPrevious()) && a(m) && !m.getParent().equals(b.startContainer) && d.contains(m) && e.contains(g) && g.isIdentical(m) &&
                (g.moveChildren(m), g.remove(), h(b, c, d, e))
            }
            ...
            var l = CKEDITOR.dtd, n = {
                ...
                dl: 1,
                blockquote: 1
            }, r = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, u = CKEDITOR.tools.extend({},
                l.$inline);
            delete u.br;
            return function (n, E, w, t) {
                var q = n.editor, y = !1;
                "unfiltered_html" == E && (E = "html", y = !0);
                if (!t.checkReadOnly()) {
                    var A = (new CKEDITOR.dom.elementPath(t.startContainer, t.root)).blockLimit || t.root;
                    n = {
                        type: E,
                        dontFilter: y,
                        editable: n,
                    ...
                    t = n.mergeCandidates;
                    var v, J;
                    "text" == n.type && E.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (v = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", E.document), E.insertNode(v),
                        E.setStartAfter(v));
                    y = new CKEDITOR.dom.elementPath(E.startContainer);
                    n.endPath = A = new CKEDITOR.dom.elementPath(E.endContainer);
                    if (!E.collapsed) {
                        var q = A.block || A.blockLimit, fa = E.getCommonAncestor();
                        q && !q.equals(fa) && !q.contains(fa) && E.checkEndOfBlock() && n.zombies.push(q);
                        E.deleteContents()
                    }
                    for (; (J = g(E)) && a(J) && J.isBlockBoundary() && y.contains(J);)E.moveToPosition(J, CKEDITOR.POSITION_BEFORE_END);
                    h(E, n.blockLimit, y, A);
                    v && (E.setEndBefore(v), E.collapse(), v.remove());
                    v = E.startPath();
                    if (q = v.contains(f, !1,
                            1)) E.splitElement(q), n.inlineStylesRoot = q, n.inlineStylesPeak = v.lastElement;
                    v = E.createBookmark();
                    (q = v.startNode.getPrevious(c)) && a(q) && f(q) && t.push(q);
                    (q = v.startNode.getNext(c)) && a(q) && f(q) && t.push(q);
                    for (q = v.startNode; (q = q.getParent()) && f(q);)t.push(q);
                    E.moveToBookmark(v);
                    if (v = w) {
                        v = n.range;
                        if ("text" == n.type && n.inlineStylesRoot) {
                            J = n.inlineStylesPeak;
                            E = J.getDocument().createText("{cke-peak}");
                            for (t = n.inlineStylesRoot.getParent(); !J.equals(t);)E = E.appendTo(J.clone()), J = J.getParent();
                            w = E.getOuterHtml().split("{cke-peak}").join(w)
                        }
                        J =
                            n.blockLimit.getName();
                        if (/^\s+|\s+$/.test(w) && "span" in CKEDITOR.dtd[J]) {
                            var P = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
                            w = P + w + P
                        }
                        w = n.editor.dataProcessor.toHtml(w, {
                            context: null,
                            fixForBody: !1,
                        ...
                        J = v.document.createElement("body");
                        J.setHtml(w);
                        P && (J.getFirst().remove(), J.getLast().remove());
                        if ((P = v.startPath().block) && (1 != P.getChildCount() || !P.getBogus()))a:{
                            var Q;
                            if (1 ==
                                J.getChildCount() && a(Q = J.getFirst()) && Q.is(r) && !Q.hasAttribute("contenteditable")) {
                                P = Q.getElementsByTag("*");
                                v = 0;
                                for (t = P.count(); v < t; v++)if (E = P.getItem(v), !E.is(u))break a;
                    ...
                    if (v) {
                        ...
                        var W, Z;
                        E = Q.startContainer;
                        var y = n.endPath.elements[0], aa, A = y.getPosition(E),
                            fa = !!y.getCommonAncestor(E) && A != CKEDITOR.POSITION_IDENTICAL && !(A & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        E = b(n.dataWrapper, n);
                        for (m(E, Q); t < E.length; t++) {
                            A = E[t];
                            if (N = A.isLineBreak) {
                                N = Q;
                                W = J;
                            ...
                            if (N) w = 0 < t; else {
                                N = Q.startPath();
                                !A.isBlock && k(n.editor, N.block, N.blockLimit) && (Y = d(n.editor)) && (Y = v.createElement(Y), Y.appendBogus(), Q.insertNode(Y),
                                CKEDITOR.env.needsBrFiller && (S = Y.getBogus()) && S.remove(), Q.moveToPosition(Y, CKEDITOR.POSITION_BEFORE_END));
                                if ((N = Q.startPath().block) && !N.equals(R)) {
                                    if (S = N.getBogus()) S.remove(), P.push(N);
                                    R = N
                                }
                                A.firstNotAllowed && (q = 1);
                                if (q && A.isElement) {
                                    N = Q.startContainer;
                                    ...
                                    if (N) W && (Z = Q.splitElement(W), n.zombies.push(Z), n.zombies.push(W)); else {
                                        W = J.getName();
                                        aa = !t;
                                        N = t == E.length - 1;
                                        W = e(A.node, W);
                                        for (var X = [], ba = W.length, da = 0, ia = void 0,
                                                 ja = 0, ea = -1; da < ba; da++)ia = W[da], " " == ia ? (ja || aa && !da || (X.push(new CKEDITOR.dom.text(" ")), ea = X.length), ja = 1) : (X.push(ia), ja = 0);
                                        N && ea == X.length && X.pop();
                                        aa = X
                                    }
                                }
                                ...
                                A.lastNotAllowed && t < E.length - 1 && ((Z = fa ? y : Z) && Q.setEndAt(Z, CKEDITOR.POSITION_AFTER_START), q = 0);
                                Q.collapse()
                            }
                        }
                        1 != E.length ? S = !1 : (S = E[0], S = S.isElement && "false" == S.node.getAttribute("contenteditable"));
                        S && (w = !0, N = E[0].node, Q.setStartAt(N, CKEDITOR.POSITION_BEFORE_START), Q.setEndAt(N,
                    ...
                    if (Z)for (; R = Z.pop();)CKEDITOR.env.needsBrFiller ? R.appendBogus() : R.append(S.document.createText(" "));
                    for (; R = n.mergeCandidates.pop();)R.mergeSiblings();
                    S.moveToBookmark(aa);
                    if (!n.dontMoveCaret) {
                        for (R = g(S); R && a(R) && !R.is(l.$empty);) {
                            if (R.isBlockBoundary()) S.moveToPosition(R,
                                CKEDITOR.POSITION_BEFORE_END); else {
                                if (f(R) && R.getHtml().match(/(\s|&nbsp;)$/g)) {
                                    ga = null;
                                    break
                                }
                                ga = S.clone();
        ...
        t = {
            eol: {
                ...
                rebuild: function (a, b) {
                    ...
                    d(c);)e = c.clone(0, 1), a.fragment.appendTo(e), a.fragment = e, c = c.getParent()
                }
            }, cell: {
                shrink: function (a) {
                    a = a.range;
                ...
                list: {
                    detectMerge: function (a, b) {
                        ...
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) {
                                var h = f.contains(CKEDITOR.dtd.$list), m = g.contains(CKEDITOR.dtd.$list);
                    ...
                    function a(c) {
                        ...
                        g.guard = function (a, g) {
                            ...
                            if (g && h && a.equals(h)) f = c.clone(), f.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(f); else if (!g && m && a.equals(m)) f = c.clone(), f.setStartAt(m, CKEDITOR.POSITION_AFTER_START), e.push(f);
                            else {
                                if (l = !g) l = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!m || b(a, m));
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var g = c(f, e.bookmark), h = g.clone(), m, k, l = g.getCommonAncestor();
                            ...
                            l = l.contains("table");
                            k = k.contains("table");
                            if (l || k) l && k && b(l, k) ? (e.tableSurroundingRange = h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), h = g.clone(), h.setEndAt(l, CKEDITOR.POSITION_AFTER_END), m = g.clone(), m.setStartAt(k, CKEDITOR.POSITION_BEFORE_START), m = a(h).concat(a(m))) : l ? k || (e.tableSurroundingRange = h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), g.setEndAt(l,
                                    CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = h, h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), g.setStartAt(k, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = m ? m : a(g)
                        }, deleteRanges: function (a) {
                            for (var b; b = a.tableContentsRanges.pop();)b.extractContents(), q(b.startContainer) && b.startContainer.appendBogus();
                    ...
                    var c = b.startPath(), e;
                    k(a, c.block, c.blockLimit) && (e = d(a)) && (e = b.document.createElement(e), e.appendBogus(),
                        b.insertNode(e), b.moveToPosition(e, CKEDITOR.POSITION_AFTER_START))
                }
            }
        }()
    }(),function () {
        function a(a, b) {
            ...
            if (c)return !1;
            for (d = 0; d < a.length; d++)if (c = a[d]._getTableElement(),
                    !c)return !1;
            return !0
        }
        ...
        function c(a) {
            var c =
                this.root.editor, d = c.getSelection(1);
            this.reset();
            A = !0;
            ...
            if (b) {
                ...
                if (!(d = !c) && (d = !c.isHidden())) {
                    ...
                    var e = c.getRanges(), f = d.getRanges(),
                        ...
                        l = 1 === e.length && e[0].collapsed, f = a(e, !!CKEDITOR.env.webkit) && a(f);
                    g = g && h ? g.equals(h) || h.contains(g) : !1;
                    g && (l || f) ? (m && !k && d.selectRanges(e),
                        d = !0) : d = !1;
                    d = !d
                }
                d && (b.reset(), b = 0)
        ...
        function l() {
            x = !0;
            p || (k.call(this), p = CKEDITOR.tools.setTimeout(k,
                200, this))
        }

        function k() {
            p = null;
            x && (CKEDITOR.tools.setTimeout(e, 0, this), x = !1)
        }
        ...
        function h(a) {
            ...
            var c = a.startContainer, e = a.getPreviousNode(d, null, c), f = a.getNextNode(d, null, c);
            return b(e) || b(f, 1) || !(e || f || c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() &&
            c.getBogus()) ? !0 : !1
        }

        function m(a) {
            g(a, !1);
            var b = a.getDocument().createText(r);
        ...
        function q(a, b) {
            var c = CKEDITOR.dom.element.createFromHtml('\x3cdiv data-cke-hidden-sel\x3d"1" data-cke-temp\x3d"1" style\x3d"' + (CKEDITOR.env.ie && 14 > CKEDITOR.env.version ? "display:none" :
                    "position:fixed;top:0;left:-1000px") + '"\x3e' + (b || "\x26nbsp;") + "\x3c/div\x3e", a.document);
            a.fire("lockSnapshot");
            a.editable().append(c);
        ...
        function y(a) {
            for (var b = 0; b < a.length; b++) {
                ...
                if (!c.collapsed) {
                    ...
                    d.is("body") || !d.isReadOnly());)e && "false" == d.getAttribute("contentEditable") && c.setStartAfter(d), d = d.getParent();
                    d = c.startContainer;
                    e = c.endContainer;
        ...
        var w = "function" != typeof window.getSelection, u = 1, r = CKEDITOR.tools.repeat("​", 7),
            t = new RegExp(r + "( )?", "g"), A, p, x, B = CKEDITOR.dom.walker.invisible(1), z = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var f = c.document, h = CKEDITOR.document, m = c.editable(), k = f.getBody(),
                    p = f.getDocumentElement(), n = m.isInline(), r, u;
                CKEDITOR.env.gecko && m.attachListener(m, "focus", function (a) {
                    a.removeListener();
                    0 !== r && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == m.$ && (a = c.createRange(), a.moveToElementEditStart(m), a.select())
                }, null, null, -2);
                m.attachListener(m, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    r && CKEDITOR.env.webkit && (r =
                        c._.previousActive && c._.previousActive.equals(f.getActive())) && null != c._.previousScrollTop && c._.previousScrollTop != m.$.scrollTop && (m.$.scrollTop = c._.previousScrollTop);
                    c.unlockSelection(r);
                    r = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || n) w ? m.attachListener(m, "beforedeactivate", a, null, null, -1) : m.attachListener(c, "selectionCheck", a, null, null, -1), m.attachListener(m, CKEDITOR.env.webkit ? "DOMFocusOut" : "blur", function () {
                    c.lockSelection(u);
                    r = 1
                }, null, null, -1), m.attachListener(m,
                    "mousedown", function () {
                        r = 0
                    });
                if (CKEDITOR.env.ie && !n) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                            ...
                            p.on("mousedown", function (a) {
                                function b(a) {
                                    ...
                                    if (q) {
                                        ...
                                        q.setEndPoint(0 > x.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        q.select()
                                    }
                                }
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) p.on("mousedown", function (a) {
                            a.data.getTarget().is("html") && (h.on("mouseup", b), p.on("mouseup", b))
                        })
                    }
                }
                ...
                m.attachListener(m, "keydown", v(c), null, null, -1)
            });
            ...
            c.on("loadSnapshot", function () {
                ...
                b && b.hasAttribute("data-cke-hidden-sel") && (b.remove(), CKEDITOR.env.gecko && (a = c.editable().getFirst(a)) &&
                a.is("br") && a.getAttribute("_moz_editor_bogus_node") && a.remove())
            }, null, null, 100);
            c.on("key", function (a) {
                if ("wysiwyg" == c.mode) {
        ...
        if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function (a) {
            ...
            b.on("selectionChange", function () {
                ...
                c && (c.getCustomData("ready") ? (g(a), a.editor.fire("selectionCheck")) :
        ...
        CKEDITOR.editor.prototype.getSelection = function (a) {
            return !this._.savedSelection && !this._.fakeSelection || a ? (a = this.editable()) && "wysiwyg" == this.mode ? new CKEDITOR.dom.selection(a) :
                null : this._.savedSelection || this._.fakeSelection
        };
        ...
        CKEDITOR.dom.selection = function (a) {
            ...
            this.rev = b ? b.rev : u++;
            this.document = a instanceof
            CKEDITOR.dom.document ? a : a.getDocument();
            ...
            if (!d || d.type != CKEDITOR.NODE_ELEMENT && d.type !=
                CKEDITOR.NODE_TEXT || !this.root.equals(d) && !this.root.contains(d)) this._.cache.type = CKEDITOR.SELECTION_NONE, this._.cache.startElement = null, this._.cache.selectedElement = null, this._.cache.selectedText = "", this._.cache.ranges = new CKEDITOR.dom.rangeList;
            return this
        };
        var C = {
            img: 1,
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.selection, {
            _removeFillingCharSequenceString: n, _createFillingCharSequenceNode: m,
            ...
            getNative: function () {
                ...
                var a = w ? function () {
                    ...
                    var b = function (b,
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), m = 0, k = e.length - 1, l = -1, p, n; m <= k;)if (l = Math.floor((m + k) / 2), f = e[l], h.moveToElementText(f), p = h.compareEndPoints("StartToStart", b), 0 < p) k = l - 1; else if (0 > p) m = l + 1; else return {
                            container: d,
                            offset: a(f)
                        };
                        if (-1 == l || l == e.length - 1 && 0 > p) {
                            h.moveToElementText(d);
                            h.setEndPoint("StartToStart", b);
                            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                            e = d.childNodes;
                            if (!h)return f = e[e.length -
                            1], f.nodeType != CKEDITOR.NODE_TEXT ? {container: d, offset: e.length} : {
                                container: f,
                        ...
                        h.collapse(0 < p ? !0 : !1);
                        h.setEndPoint(0 < p ? "StartToStart" : "EndToStart", b);
                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!h)return {container: d, offset: a(f) + (0 < p ? 0 : 1)};
                        for (; 0 < h;)try {
                            g = f[0 < p ? "previousSibling" : "nextSibling"], g.nodeType == CKEDITOR.NODE_TEXT && (h -= g.nodeValue.length, n =
                                g), f = g
                        } catch (r) {
                            return {container: d, offset: a(f)}
                        }
                        return {container: n, offset: 0 < p ? -h : n.nodeValue.length + h}
                    };
                    return function () {
                ...
                return function (b) {
                    ...
                    return b ? y(new CKEDITOR.dom.rangeList(d.slice())) : d
                }
                ...
                var b = this.getNative(), b = w ? "Control" == b.type ? "" : b.createRange().text : b.toString();
                ...
                if (this.isLocked) {
                    ...
                    this.isLocked = 0;
                    this.reset();
                    b && (b = d || e[0] && e[0].getCommonAncestor()) && b.getAscendant("body",
                        1) && (a(e) ? c.call(this, e) : f ? this.fake(d) : d ? this.selectElement(d) : this.selectRanges(e))
                }
            }, reset: function () {
                this._.cache = {};
                this.isFake = 0;
                ...
                if (b.length)if (this.isLocked) {
                    ...
                    a:{
                        var n, r;
                        if (1 == b.length &&
                            !(r = b[0]).collapsed && (p = r.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (r = r.clone(), r.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (n = r.getEnclosedNode()) && n.type == CKEDITOR.NODE_ELEMENT && (p = n), "false" == p.getAttribute("contenteditable")))break a;
                        p = void 0
                    }
                    if (p) this.fake(p); else if (d && d.plugins.tableselection && CKEDITOR.plugins.tableselection.isSupportedEnvironment && a(b) && !A) c.call(this, b); else {
                        if (w) {
                            n = CKEDITOR.dom.walker.whitespaces(!0);
                            p = /\ufeff|\u00a0/;
                            r = {table: 1, tbody: 1, tr: 1};
                            1 < b.length && (d = b[b.length -
                            1], b[0].setEnd(d.endContainer, d.endOffset));
                            d = b[0];
                            b = d.collapsed;
                            var u, q, t;
                            if ((e = d.getEnclosedNode()) && e.type == CKEDITOR.NODE_ELEMENT && e.getName() in C && (!e.is("a") || !e.getText()))try {
                                t = e.$.createControlRange();
                                t.addElement(e.$);
                                t.select();
                                return
                            } catch (x) {
                            }
                            if (d.startContainer.type == CKEDITOR.NODE_ELEMENT && d.startContainer.getName() in r || d.endContainer.type == CKEDITOR.NODE_ELEMENT && d.endContainer.getName() in r) d.shrink(CKEDITOR.NODE_ELEMENT, !0), b = d.collapsed;
                            t = d.createBookmark();
                            r = t.startNode;
                            b || (l = t.endNode);
                            t = d.document.$.body.createTextRange();
                            t.moveToElementText(r.$);
                            t.moveStart("character", 1);
                            l ? (p = d.document.$.body.createTextRange(), p.moveToElementText(l.$), t.setEndPoint("EndToEnd", p), t.moveEnd("character", -1)) : (u = r.getNext(n), q = r.hasAscendant("pre"), u = !(u && u.getText && u.getText().match(p)) && (q || !r.hasPrevious() || r.getPrevious().is && r.getPrevious().is("br")), q = d.document.createElement("span"), q.setHtml("\x26#65279;"), q.insertBefore(r), u && d.document.createText("﻿").insertBefore(r));
                            d.setStartBefore(r);
                            r.remove();
                            b ? (u ? (t.moveStart("character", -1), t.select(), d.document.$.selection.clear()) : t.select(), d.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START), q.remove()) : (d.setEndBefore(l), l.remove(), t.select())
                        } else {
                            l = this.getNative();
                            if (!l)return;
                            this.removeAllRanges();
                            for (t = 0; t < b.length; t++) {
                                if (t < b.length - 1 && (u = b[t], q = b[t + 1], p = u.clone(), p.setStart(u.endContainer, u.endOffset), p.setEnd(q.startContainer, q.startOffset), !p.collapsed && (p.shrink(CKEDITOR.NODE_ELEMENT, !0), d = p.getCommonAncestor(), p = p.getEnclosedNode(),
                                    d.isReadOnly() || p && p.isReadOnly()))) {
                                    q.setStart(u.startContainer, u.startOffset);
                                    b.splice(t--, 1);
                                    continue
                                }
                                d = b[t];
                                q = this.document.$.createRange();
                                d.collapsed && CKEDITOR.env.webkit && h(d) && (p = m(this.root), d.insertNode(p), (u = p.getNext()) && !p.getPrevious() && u.type == CKEDITOR.NODE_ELEMENT && "br" == u.getName() ? (g(this.root), d.moveToPosition(u, CKEDITOR.POSITION_BEFORE_START)) : d.moveToPosition(p, CKEDITOR.POSITION_AFTER_END));
                                q.setStart(d.startContainer.$, d.startOffset);
                                try {
                                    q.setEnd(d.endContainer.$, d.endOffset)
                                } catch (y) {
                                    if (0 <=
                                        y.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), q.setEnd(d.endContainer.$, d.endOffset); else throw y;
                                }
                                l.addRange(q)
                            }
                        }
                ...
                this.type !=
                CKEDITOR.SELECTION_NONE && this.getRanges()[0].scrollIntoView()
        ...
        function b(c) {
            ...
            if (c.collapsed) d = r(this, d), c.insertNode(d), c.moveToPosition(d, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, m, k = h.ignoreReadonly, l = k || h.includeReadonly;
                null == l && (l = c.root.getCustomData("cke_includeReadonly"));
                var p = CKEDITOR.dtd[g];
                p || (m = !0, p = CKEDITOR.dtd.span);
                c.enlarge(CKEDITOR.ENLARGE_INLINE, 1);
                c.trim();
                var n = c.createBookmark(), u = n.startNode, t =
                    n.endNode, q = u, w;
                if (!k) {
                    var x = c.getCommonAncestor(), k = a(u, x), x = a(t, x);
                    k && (q = k.getNextSourceNode(!0));
                    x && (t = x)
                }
                for (q.getPosition(t) == CKEDITOR.POSITION_FOLLOWING && (q = 0); q;) {
                    k = !1;
                    if (q.equals(t)) q = null, k = !0; else {
                        var A = q.type == CKEDITOR.NODE_ELEMENT ? q.getName() : null,
                            x = A && "false" == q.getAttribute("contentEditable"),
                            v = A && q.getAttribute("data-nostyle");
                        if (A && q.data("cke-bookmark")) {
                            q = q.getNextSourceNode(!0);
                            continue
                        }
                        if (x && l && CKEDITOR.dtd.$block[A])for (var B = q, z = e(B), C = void 0, D = z.length, da = 0, B = D && new CKEDITOR.dom.range(B.getDocument()); da <
                        D; ++da) {
                            var C = z[da], G = CKEDITOR.filter.instances[C.data("cke-filter")];
                            if (G ? G.check(this) : 1) B.selectNodeContents(C), b.call(this, B)
                        }
                        z = A ? !p[A] || v ? 0 : x && !l ? 0 : f(q, t, h, M) : 1;
                        if (z)if (C = q.getParent(), z = h, D = g, da = m, !C || !(C.getDtd() || CKEDITOR.dtd.span)[D] && !da || z.parentRule && !z.parentRule(C)) k = !0; else {
                            if (w || A && CKEDITOR.dtd.$removeEmpty[A] && (q.getPosition(t) | M) != M || (w = c.clone(), w.setStartBefore(q)), A = q.type, A == CKEDITOR.NODE_TEXT || x || A == CKEDITOR.NODE_ELEMENT && !q.getChildCount()) {
                                for (var A = q, I; (k = !A.getNext(J)) &&
                                (I = A.getParent(), p[I.getName()]) && f(I, u, h, L);)A = I;
                                w.setEndAfter(A)
                            }
                        } else k = !0;
                        q = q.getNextSourceNode(v || x)
                    }
                    if (k && w && !w.collapsed) {
                        for (var k = r(this, d), x = k.hasAttributes(), v = w.getCommonAncestor(), A = {}, z = {}, C = {}, D = {}, ea, F, ha; k && v;) {
                            if (v.getName() == g) {
                                for (ea in h.attributes)!D[ea] && (ha = v.getAttribute(F)) && (k.getAttribute(ea) == ha ? z[ea] = 1 : D[ea] = 1);
                                for (F in h.styles)!C[F] && (ha = v.getStyle(F)) && (k.getStyle(F) == ha ? A[F] = 1 : C[F] = 1)
                            }
                            v = v.getParent()
                        }
                        ...
                        k ? (w.extractContents().appendTo(k), w.insertNode(k), y.call(this, k), k.mergeSiblings(), CKEDITOR.env.ie || k.$.normalize()) : (k = new CKEDITOR.dom.element("span"), w.extractContents().appendTo(k), w.insertNode(k), y.call(this, k), k.remove(!0));
                        w = null
                    }
                }
                c.moveToBookmark(n);
        ...
        function c(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(l.getParent()), e = null, f = null, g = 0; g <
                a.elements.length; g++) {
                    var h = a.elements[g];
            ...
            if (a.collapsed) {
                for (var f = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, m; h < f.elements.length &&
                (m = f.elements[h]) && m != f.block && m != f.blockLimit; h++)if (this.checkElementRemovable(m)) {
                    var k;
                    !e && a.collapsed && (a.checkBoundaryOfElement(m, CKEDITOR.END) || (k = a.checkBoundaryOfElement(m, CKEDITOR.START))) ? (g = m, g.match = k ? "start" : "end") : (m.mergeSiblings(), m.is(this.element) ? v.call(this, m) : w(m, p(this)[m.getName()]))
                }
                if (g) {
                    e = d;
                    for (h = 0; ; h++) {
                        m = f.elements[h];
                        if (m.equals(g))break; else if (m.match)continue; else m = m.clone();
                        m.append(e);
                        e = m
                    }
                ...
                var l = c.endNode,
                    n = this;
                b();
                for (f = d; !f.equals(l);)g = f.getNextSourceNode(), f.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(f) && (f.getName() == this.element ? v.call(this, f) : w(f, p(this)[f.getName()]), g.type == CKEDITOR.NODE_ELEMENT && g.contains(d) && (b(), g = d.getNext())), f = g
            }
            a.moveToBookmark(c);
        ...
        function d(a) {
            ...
            for (var d, e = a.document, f; d = c.getNextParagraph();)!d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (f = r(this, e, d), m(d, f));
            a.moveToBookmark(b)
        }
        ...
        function h(a) {
            ...
            for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ?
                "p" : "div")) && d.copyAttributes(e), m(d, e)) : v.call(this, d));
            a.moveToBookmark(b)
        }
        ...
        function m(a, b) {
            ...
            if (d && !e) {
                ...
                b = e
            } else f ? b = q(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, m;
                (m = c.getPrevious(G)) && m.type == CKEDITOR.NODE_ELEMENT && m.is("pre") && (d = n(m.getHtml(), /\n$/, "") + "\n\n" + n(c.getHtml(), /^\n/, ""), CKEDITOR.env.ie ? c.$.outerHTML = "\x3cpre\x3e" + d + "\x3c/pre\x3e" : c.setHtml(d), m.remove())
            } else c && u(b)
        }
        ...
        function v(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = p(this)[a.getName()],
                f = CKEDITOR.tools.isEmpty(d) &&
                    CKEDITOR.tools.isEmpty(c), g;
            for (g in d)if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == x(g, d[g])) b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g), a.removeAttribute(g));
            for (var h in c)this._.definition.fullMatch && a.getStyle(h) != x(h, c[h], !0) || (f = f || !!a.getStyle(h), a.removeStyle(h));
            w(a, e, C[a.getName()]);
            f && (this._.definition.alwaysRemoveElement ? u(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? u(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ?
                "p" : "div"))
        }

        function y(a) {
            for (var b = p(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;)d = c.getItem(e), d.isReadOnly() || v.call(this, d, !0);
            for (var f in b)if (f != this.element)for (c = a.getElementsByTag(f), e = c.count() - 1; 0 <= e; e--)d = c.getItem(e), d.isReadOnly() || w(d, b[f])
        }
        ...
        function z(a, b, c) {
            ...
            var f, g;
            if (a.isFake && a.isInTable())for (f = [], g = 0; g < e.length; g++)f.push(e[g].clone());
        ...
        var C = {
                ...
                audio: 1,
                video: 1
            }, I = /\s*(?:;\s*|$)/, F = /#\((.+?)\)/g, J = CKEDITOR.dom.walker.bookmark(0, 1),
                ...
                if ("string" == typeof this.element ? d == this.element : d in this.element) {
                    ...
                    if (c._length) {
                        for (var h in c)if ("_length" !=
                            h)if (d = a.getAttribute(h) || "", "style" == h ? B(c[h], d) : c[h] == d) {
                            if (!b)return !0
                        } else if (b)return !1;
                        if (b)return !0
                    } else return !0
        ...
        b in CKEDITOR.dtd.$empty || (f[b] = 1);
        CKEDITOR.dom.elementPath = function (b, e) {
            var l = null, k = null, d = [], h = b, m;
        ...
        compare: function (a) {
            ...
            a instanceof
            CKEDITOR.dom.element ? c = function (b) {
                return b.equals(a)
            ...
            for (f = 0; f < l; f++)if (c(e[f]))return e[f];
            return null
        }, isContextFor: function (a) {
            var f;
            return a in CKEDITOR.dtd.$block ? (f = this.contains(CKEDITOR.dtd.$intermediate) || this.root.equals(this.block) &&
                this.block || this.blockLimit, !!f.getDtd()[a]) : !0
        }, direction: function () {
        ...
        type: CKEDITOR.NODE_TEXT, getLength: function () {
            ...
            var f =
                    this.$.parentNode, b = f.childNodes.length, c = this.getLength(), e = this.getDocument(),
        ...
        function a(a, c, e) {
            var f = a.serializable, k = c[e ? "endContainer" : "startContainer"], d = e ? "endOffset" : "startOffset",
                h = f ? c.document.getById(a.startNode) :
                    a.startNode;
                ...
                return {
                    getNextRange: function (k) {
                        ...
                        if (d && 1 < a.length) {
                            ...
                            for (d.moveToBookmark(e.shift()); m--;)h =
                                a[++f], h.moveToBookmark(e.shift()), d.setEnd(h.endContainer, h.endOffset)
                        }
                        return d
                    }
                }
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            getUiColor: function () {
                ...
                return (this.setUiColor = function (a) {
                    this.uiColor = a;
                    var c = CKEDITOR.skin.chameleon, f = "", m = "";
                    ...
                    labeledElement: function (b, c, d, e) {
                        if (!(4 > arguments.length)) {
                            ...
                            f.labelId = CKEDITOR.tools.getNextId() +
                                "_label";
                            this._.children = [];
                            var k = {role: c.role || "presentation"};
                        ...
                        if (!(3 > arguments.length)) {
                            ...
                            var f = this._.inputId = CKEDITOR.tools.getNextId() + "_textInput",
                                k = {"class": "cke_dialog_ui_input_" + c.type, id: f, type: c.type};
                            ...
                            b.on("load", function () {
                                l.getInputElement().on("keydown",
                                    function (a) {
                                        13 == a.data.getKeystroke() && (y = !0)
                                    });
                                l.getInputElement().on("keyup", function (a) {
                                    13 == a.data.getKeystroke() && y && (b.getButton("ok") && setTimeout(function () {
                            ...
                            CKEDITOR.ui.dialog.labeledElement.call(this, b, c, e, function () {
                                ...
                                this._.required &&
                                (k["aria-required"] = this._.required);
                        ...
                        if (!(3 > arguments.length)) {
                            a.call(this, c);
                            var f = this, k = this._.inputId = CKEDITOR.tools.getNextId() + "_textarea", l = {};
                            c.validate && (this.validate = c.validate);
                            l.rows = c.rows || 5;
                            l.cols = c.cols || 20;
                            ...
                            CKEDITOR.ui.dialog.labeledElement.call(this,
                                b, c, d, function () {
                                    for (var a = [], d = [], g = (c.id ? c.id : CKEDITOR.tools.getNextId()) + "_radio", l = 0; l < c.items.length; l++) {
                                        var r = c.items[l], t = void 0 !== r[2] ? r[2] : r[0],
                                            A = void 0 !== r[1] ? r[1] : r[0],
                                            p = CKEDITOR.tools.getNextId() + "_radio_input", x = p + "_label",
                                            p = CKEDITOR.tools.extend({}, c, {id: p, title: null, type: null}, !0),
                                            t = CKEDITOR.tools.extend({}, p, {title: t}, !0), B = {
                                                type: "radio",
                                        ...
                                        e.push(new CKEDITOR.ui.dialog.uiElement(b, p, z, "input", null, B));
                                        z.push(" ");
                                        new CKEDITOR.ui.dialog.uiElement(b, t, z, "label", null, {
                                            id: x,
                                            "for": B.id
                                        }, r[0]);
                                        a.push(z.join(""))
                        ...
                        if (!(3 > arguments.length)) {
                            ...
                            CKEDITOR.ui.dialog.labeledElement.call(this, b, c, d, function () {
                                ...
                                k(a);
                                for (var l = 0, r; l < c.items.length && (r = c.items[l]); l++)f.push('\x3coption value\x3d"', CKEDITOR.tools.htmlEncode(void 0 !== r[1] ? r[1] : r[0]).replace(/"/g, "\x26quot;"), '" /\x3e ', CKEDITOR.tools.htmlEncode(r[0]));
                                "undefined" != typeof a.inputStyle && (a.style = a.inputStyle);
                        ...
                        if (!(3 > arguments.length)) {
                            a.call(this, c);
                            c.validate && (this.validate = c.validate);
                            var f = CKEDITOR.tools.extend({}, c), k = f.onClick;
                ...
                CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, c, {
                    getInputElement: function () {
                        ...
                        var b = this._, c = CKEDITOR.document.getById(b.frameId).getFrameDocument(), d = b.definition,
                            e = b.buttons, f = this.formLoadedNumber, k = this.formUnloadNumber,
                            l = b.dialog._.editor.lang.dir, u = b.dialog._.editor.langCode;
        ...
        function m(a) {
            function b(c) {
                var k = a.getSize(), m = CKEDITOR.document.getWindow().getViewPaneSize(), l = c.data.$.screenX,
                    p = c.data.$.screenY, n = l - d.x, r = p - d.y;
                d = {x: l, y: p};
                e.x += n;
                e.y += r;
        ...
        function g(a) {
            function b(c) {
                var p = "rtl" == f.lang.dir, n = l.width, r = l.height,
                    u = n + (c.data.$.screenX - m.x) * (p ? -1 : 1) * (a._.moved ? 1 : 2),
                    t = r + (c.data.$.screenY - m.y) * (a._.moved ? 1 : 2), x = a._.element.getFirst(),
                    x = p && x.getComputedStyle("right"), w = a.getPosition();
                w.y + t > k.height && (t = k.height - w.y);
                (p ? x : w.x) + u > k.width && (u = k.width - (p ? x : w.x));
            ...
            if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
                var f = a.getParentEditor(),
                    g, h, k, m, l, p, n = CKEDITOR.tools.addFunction(function (d) {
                        l = a.getSize();
                        var e = a.parts.contents;
                        e.$.getElementsByTagName("iframe").length && (p = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_dialog_resize_cover" style\x3d"height: 100%; position: absolute; width: 100%;"\x3e\x3c/div\x3e'), e.append(p));
        ...
        function v(a) {
            z && (a.focusManager.remove(z), a = CKEDITOR.document.getWindow(), z.hide(), a.removeListener("resize", x), CKEDITOR.env.ie6Compat && a.$.setTimeout(function () {
        ...
        CKEDITOR.dialog = function (b, d) {
            ...
            function n(c) {
                if (z == CKEDITOR.dialog._.currentTop) {
                    ...
                    y = B = 0;
                    if (9 == d || d == CKEDITOR.SHIFT + 9) k(d == CKEDITOR.SHIFT + 9 ? -1 : 1), y = 1; else if (d == CKEDITOR.ALT + 121 && !z._.tabBarMode && 1 < z.getPageCount()) z._.tabBarMode = !0, z._.tabs[z._.currentTabId][0].focus(), z._.currentFocusIndex = -1, y = 1; else if (-1 != CKEDITOR.tools.indexOf(g,
            ...
            function r(a) {
                y ? a.data.preventDefault(1) : B && a.data.stopPropagation()
            }

            var t = CKEDITOR.dialog._.dialogDefinitions[d], x = CKEDITOR.tools.clone(u),
                w = b.config.dialog_buttonsOrder || "OS", q = b.lang.dir, A = {}, y, B;
            ("OS" == w && CKEDITOR.env.mac || "rtl" == w && "ltr" == q || "ltr" == w && "rtl" == q) && x.buttons.reverse();
            t = CKEDITOR.tools.extend(t(b), x);
            ...
            x = {position: CKEDITOR.env.ie6Compat ? "absolute" : "fixed", top: 0, visibility: "hidden"};
            x["rtl" == q ? "right" : "left"] = 0;
            this.parts.dialog.setStyles(x);
            CKEDITOR.event.call(this);
            this.definition = t = CKEDITOR.fire("dialogDefinition",
                {name: d, definition: t}, b).definition;
            if (!("removeDialogTabs" in b._) && b.config.removeDialogTabs) {
                x = b.config.removeDialogTabs.split(";");
                for (q = 0; q < x.length; q++)if (w = x[q].split(":"), 2 == w.length) {
                    var v = w[0];
                    A[v] || (A[v] = []);
                    A[v].push(w[1])
                }
            ...
            if (b._.removeDialogTabs && (A = b._.removeDialogTabs[d]))for (q = 0; q < A.length; q++)t.removeContents(A[q]);
            ...
            var z = this, C = function (a) {
                var b = z._.contents, c = !1, d;
            ...
            this.on("show", function () {
                D.on("keydown", n, this);
                if (CKEDITOR.env.gecko) D.on("keypress", r, this)
            });
            this.on("hide",
                function () {
                    D.removeListener("keydown", n);
                    CKEDITOR.env.gecko && D.removeListener("keypress", r);
                    C(function (a) {
                        e.apply(a)
                    })
                });
            ...
            this.on("show", function () {
                ...
                b.config.dialog_startupFocusTab && a ? (z._.tabBarMode = !0, z._.tabs[z._.currentTabId][0].focus(), z._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, t.onFocus ?
            ...
            for (q = 0; q < t.contents.length; q++)(A = t.contents[q]) && this.addPage(A);
            ...
            for (q = 0; q < A.length; q++)this._.buttons[A[q].id] = A[q]
        };
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                null === CKEDITOR.dialog._.currentTop ? (CKEDITOR.dialog._.currentTop = this, this._.parentDialog = null, q(this._.editor)) : (this._.parentDialog = CKEDITOR.dialog._.currentTop, this._.parentDialog.getElement().getFirst().$.style.zIndex -= Math.floor(this._.editor.config.baseFloatZIndex / 2), CKEDITOR.dialog._.currentTop = this);
                a.on("keydown", D);
                a.on("keyup", I);
                this._.hasFocus = !1;
            ...
            commitContent: function () {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    a.accessKey && (F(this, this, "CTRL+" + a.accessKey, M, G), this._.accessKeyMap["CTRL+" + a.accessKey] = a.id)
                }
        ...
        var x, B = {}, z, C = {}, D = function (a) {
            ...
            (b = C[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (d ? "SHIFT+" : "") + e]) && b.length && (b = b[b.length - 1], b.keyup && (b.keyup.call(b.uiElement, b.dialog, b.key),
                a.data.preventDefault()))
                ...
                uiElement: function (a, b, c, d, e, f, g) {
                    if (!(4 > arguments.length)) {
                        var h = (d.call ? d(b) : d) || "div",
                            k = ["\x3c", h, " "], m = (e && e.call ? e(b) : e) || {},
                            l = (f && f.call ? f(b) : f) || {}, p = (g && g.call ? g.call(this, a, b) : g) || "",
                        ...
                        for (var u = l["class"] && l["class"].split ? l["class"].split(" ") : [], n = 0; n < u.length; n++)u[n] && (r[u[n]] = 1);
                        u = [];
                        for (n in r)u.push(n);
                        l["class"] = u.join(" ");
                        ...
                        0 < r.length && (l.style = (l.style ? l.style + "; " : "") + r.join("; "));
                        for (n in l)k.push(n + '\x3d"' + CKEDITOR.tools.htmlEncode(l[n]) + '" ');
                        k.push("\x3e", p, "\x3c/", h, "\x3e");
                        c.push(k.join(""));
                    ...
                    if (!(4 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, a, e || {type: "hbox"}, d, "table", {}, m, function () {
                            ...
                            for (k = 0; k < c.length; k++) {
                                ...
                                h && d.push("height:" + y(h));
                                e && void 0 !== e.padding && d.push("padding:" + y(e.padding));
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, a, e || {type: "vbox"}, d, "div", null, {role: "presentation"}, function () {
                            ...
                            for (var d = 0; d < c.length; d++) {
                                ...
                                h ? k.push("height:" + y(h[d])) : e && e.expand && k.push("height:" + Math.floor(100 / c.length) + "%");
                                e && void 0 !== e.padding && k.push("padding:" + y(e.padding));
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            openDialog: function (a, b) {
                ...
                if ("function" == typeof d) c = this._.storedDialogs || (this._.storedDialogs = {}), c = c[a] || (c[a] = new CKEDITOR.dialog(this, a)), b && b.call(c,
                    c), c.show(); else {
                    if ("failed" == d)throw v(this), Error('[CKEDITOR.dialog.openDialog] Dialog "' + a + '" failed when loading definition.');
        ...
        init: function (a) {
            var f = 0, b = function (b, d, e, m) {
                if (m) {
                    ...
                    a.addCommand(e, new CKEDITOR.styleCommand(m, {contentForms: g}));
            ...
            }, e = a.config, l = a.lang.basicstyles;
        ...
        var a = {
            exec: function (a) {
                var b = a.getCommand("blockquote").state,
                    c = a.getSelection(), e = c && c.getRanges()[0];
                if (e) {
                    var l = c.createBookmarks();
                    if (CKEDITOR.env.ie) {
                        var k = l[0].startNode, d = l[0].endNode, h;
                    ...
                    if (b == CKEDITOR.TRISTATE_OFF) {
                        ...
                        for (d = null; 0 < k.length;) {
                            for (b = k.shift(); !b.getParent().equals(h);)b =
                                b.getParent();
                            b.equals(d) || e.push(b);
                            d = b
                        }
                        ...
                        for (d = k.length - 1; 0 <= d; d--) {
                            ...
                            a:{
                                h = e;
                                for (var m = 0, g = h.getChildCount(), n = void 0; m < g && (n = h.getChild(m)); m++)if (n.type == CKEDITOR.NODE_ELEMENT && n.isBlockBoundary()) {
                                    h = !1;
                                    break a
                                }
                                h = !0
                        ...
                        if (a.config.enterMode == CKEDITOR.ENTER_BR)for (e = !0; b.length;)if (m = b.shift(), "div" == m.getName()) {
                            ...
                            for (e = m.getNext() &&
                                !(m.getNext().type == CKEDITOR.NODE_ELEMENT && m.getNext().isBlockBoundary()); m.getFirst();)m.getFirst().remove().appendTo(d);
        ...
        CKEDITOR.ui.button.prototype = {
            render: function (a, e) {
                function l() {
                    var b = a.mode;
                    b && (b = this.modes[b] ? void 0 !== r[b] ? r[b] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, b = a.readOnly && !this.readOnly ? CKEDITOR.TRISTATE_DISABLED :
                        b, this.setState(b), this.refresh && this.refresh())
                }

                var k = CKEDITOR.env, d = this._.id = CKEDITOR.tools.getNextId(), h = "", m = this.command, g, n, q;
                this._.editor = a;
                var v = {
                ...
                v.clickFn = g = CKEDITOR.tools.addFunction(function () {
                ...
                CKEDITOR.TRISTATE_ON ? "on" : m.state == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off");
                if (this.directional) a.on("contentDirChanged", function (b) {
                    ...
                    e.setAttribute("style", CKEDITOR.skin.getIconStyle(t, "rtl" == b, this.icon, this.iconOffset))
                }, this);
                m ? (n = a.getCommandKeystroke(m)) && (q = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard, n)) : h += "off";
                var t = n = this.name ||
                    this.command;
                ...
                h = {
                    ...
                    focusFn: w,
                    clickFn: g,
                    style: CKEDITOR.skin.getIconStyle(t, "rtl" == a.lang.dir, this.icon, this.iconOffset),
                ...
                return b ? (b.setState(a, "cke_button"), a == CKEDITOR.TRISTATE_DISABLED ? b.setAttribute("aria-disabled", !0) : b.removeAttribute("aria-disabled"), this.hasArrow ? (a = a == CKEDITOR.TRISTATE_ON ? this._.editor.lang.button.selectedLabel.replace(/%1/g, this.label) : this.label, CKEDITOR.document.getById(this._.id + "_label").setText(a)) :
                    a == CKEDITOR.TRISTATE_ON ? b.setAttribute("aria-pressed", !0) : b.removeAttribute("aria-pressed"), !0) : !1
            }, getState: function () {
                return this._.state
        ...
        function a(a) {
            function b() {
                for (var g = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) ||
                    f(a), m = 0; m < h.length; m++) {
                    var l = h[m];
                    if ("/" != l) {
                        "string" == typeof l && (l = h[m] = {name: l});
                        var w, u = l.groups;
                        if (u)for (var r = 0; r < u.length; r++)w = u[r], (w = g[w]) && d(l, w);
                        (w = g[l.name]) && d(l, w)
                    }
                }
                return h
            ...
            var m = a.config.removeButtons, m = m && m.split(","), g = a.config.toolbar;
        ...
        CKEDITOR.plugins.add("toolbar", {
            requires: "button", init: function (e) {
                var f,
                    k = function (a, b) {
                        var c, g = "rtl" == e.lang.dir, n = e.config.toolbarGroupCycling, q = g ? 37 : 39,
                        ...
                        switch (b) {
                            ...
                            case q:
                                ...
                                return !1;
                            case 40:
                                return a.button && a.button.hasArrow ? a.execute() : k(a, 40 == b ? q : g), !1;
                            case g:
                            case 38:
                                c = a;
                ...
                e.on("uiSpace", function (c) {
                    if (c.data.space == e.config.toolbarLocation) {
                        ...
                        var f = CKEDITOR.tools.getNextId(),
                            ...
                            f = !1 !== e.config.toolbarStartupExpanded, g, n;
                        ...
                        for (var q = e.toolbox.toolbars, v = a(e), y = v.length, w = 0; w < y; w++) {
                            var u, r = 0, t, A = v[w], p = "/" !== A && ("/" === v[w + 1] || w ==
                                y - 1), x;
                            if (A)if (g && (l.push("\x3c/span\x3e"), n = g = 0), "/" === A) l.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e'); else {
                                x = A.items || A;
                                for (var B = 0; B < x.length; B++) {
                                    ...
                                    if (z) {
                                        var D = function (a) {
                                            a = a.render(e, l);
                                            I = r.items.push(a) - 1;
                                            0 < I && (a.previous = r.items[I - 1], a.previous.next = a);
                                            a.toolbar = r;
                                            a.onkey = k;
                                            a.onfocus = function () {
                                        ...
                                        if (z.type == CKEDITOR.UI_SEPARATOR) n = g && z; else {
                                            C = !1 !== z.canGroup;
                                            if (!r) {
                                                u = CKEDITOR.tools.getNextId();
                                                r = {id: u, items: []};
                                                t = A.name &&
                                                    (e.lang.toolbar.toolbarGroups[A.name] || A.name);
                                                l.push('\x3cspan id\x3d"', u, '" class\x3d"cke_toolbar' + (p ? ' cke_toolbar_last"' : '"'), t ? ' aria-labelledby\x3d"' + u + '_label"' : "", ' role\x3d"toolbar"\x3e');
                                                t && l.push('\x3cspan id\x3d"', u, '_label" class\x3d"cke_voice_label"\x3e', t, "\x3c/span\x3e");
                                                l.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');
                                                var I = q.push(r) - 1;
                                                0 < I && (r.previous = q[I - 1], r.previous.next = r)
                                            }
                                            C ? g || (l.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), g = 1) : g && (l.push("\x3c/span\x3e"),
                                                    g = 0);
                                            n && (D(n), n = 0);
                                            D(z)
                                        }
                                ...
                                r && l.push('\x3cspan class\x3d"cke_toolbar_end"\x3e\x3c/span\x3e\x3c/span\x3e')
                            }
                        }
                            ...
                            e.addCommand("toolbarCollapse", {
                                readOnly: 1, exec: function (a) {
                                    var b = a.ui.space("toolbar_collapser"),
                                        c = b.getPrevious(), d = a.ui.space("contents"), e = c.getParent(),
        ...
        CKEDITOR.ui.prototype.addToolbarGroup = function (a, b, c) {
            var d = f(this.editor), h = 0 === b, m = {name: a};
            if (c) {
        ...
        requires: "toolbar", init: function (a) {
            function f(a) {
                var c = new CKEDITOR.dom.element("div");
                c.setStyles({position: "fixed", "margin-left": "-9999px"});
                c.setAttributes({"aria-live": "assertive", "aria-atomic": "true"});
                c.setText(a);
            ...
            a.showNotification = function (b, c, e) {
                var f, k;
                "progress" == c ? f = e : k = e;
                b = new CKEDITOR.plugins.notification(a, {message: b, type: c, progress: f, duration: k});
                b.show();
                return b
            };
            a.on("key", function (b) {
        ...
        show: function () {
            ...
            var f = !0;
            !1 === this.editor.fire("notificationUpdate", {notification: this, options: a}) && (f = !1);
            var b = this.element, c = b.findOne(".cke_notification_message"),
                e = b.findOne(".cke_notification_progress"), l = a.type;
            b.removeAttribute("role");
            a.progress && "progress" != this.type && (l = "progress");
            l && (b.removeClass(this._getClass()), b.removeAttribute("aria-label"), this.type = l, b.addClass(this._getClass()), b.setAttribute("aria-label", this.type), "progress" != this.type || e ? "progress" !=
                this.type && e && e.remove() : (e = this._createProgressElement(), e.insertBefore(c)));
            ...
            var a = this, f, b, c = this.editor.lang.common.close;
            f = new CKEDITOR.dom.element("div");
            f.addClass("cke_notification");
            f.addClass(this._getClass());
            f.setAttributes({id: this.id, role: "alert", "aria-label": this.type});
            ...
            f.append(b);
            b = CKEDITOR.dom.element.createFromHtml('\x3ca class\x3d"cke_notification_close" href\x3d"javascript:void(0)" title\x3d"' +
        ...
        add: function (a) {
            ...
            var a = this.editor, f = a.config, b = new CKEDITOR.dom.element("div");
            b.addClass("cke_notifications_area");
            b.setAttribute("id", "cke_notifications_area_" + a.name);
            b.setStyle("z-index", f.baseFloatZIndex -
                2);
            return b
        }, _attachListeners: function () {
            var a = CKEDITOR.document.getWindow(), f = this.editor;
            ...
            function a() {
                f.setStyle("left", y(w + c.width - h - m))
            }

            var f = this.element, b = this.editor, c = b.ui.contentsElement.getClientRect(),
                e = b.ui.contentsElement.getDocumentPosition(), b = b.ui.space("top"), l = b.getClientRect(),
                k = f.getClientRect(), d, h = this._notificationWidth, m = this._notificationMargin;
            d = CKEDITOR.document.getWindow();
            var g = d.getScrollPosition(), n = d.getViewPaneSize(), q = CKEDITOR.document.getBody(),
                v = q.getDocumentPosition(), y = CKEDITOR.tools.cssLength;
            ...
            b.isVisible() && l.bottom > c.top && l.bottom < c.bottom - k.height ? f.setStyles({
                ...
                position: "absolute",
                top: y(e.y)
            }) : e.y + c.height - k.height > g.y ? f.setStyles({position: "fixed", top: 0}) : f.setStyles({
                position: "absolute",
                top: y(e.y + c.height - k.height)
            });
            var w = "fixed" == f.getStyle("position") ? c.left : "static" != q.getComputedStyle("position") ? e.x - v.x : e.x;
            c.width < h + m ? e.x + h + m > g.x + n.width ? a() : f.setStyle("left", y(w)) : e.x + h + m > g.x + n.width ? f.setStyle("left", y(w)) : e.x + c.width / 2 + h / 2 + m > g.x + n.width ? f.setStyle("left", y(w - e.x + g.x + n.width - h - m)) : 0 > c.left + c.width - h - m ? a() : 0 > c.left + c.width / 2 - h / 2 ? f.setStyle("left", y(w - e.x + g.x)) : f.setStyle("left", y(w + c.width / 2 - h / 2 - m / 2))
        }
        ...
        function f(b) {
            function c() {
                ...
                a.on(C.mainPasteEvent, function (a) {
                    "beforepaste" == C.mainPasteEvent && D || x(a)
                });
                "beforepaste" == C.mainPasteEvent && (a.on("paste", function (a) {
                    I || (f(), a.data.preventDefault(), x(a), k("paste"))
            ...
            function e() {
                return {
                    ...
                    86, exec: function (b, c) {
                        ...
                        var e = this, f = "undefined" !== typeof c.notification ? c.notification : !0, g = c.type,
                            h = CKEDITOR.tools.keystrokeToString(b.lang.common.keyboard, b.getCommandKeystroke(this)),
                            k =
                                "string" === typeof f ? f : b.lang.clipboard.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' + h.aria + '"\x3e' + h.display + "\x3c/kbd\x3e"),
                            h = "string" === typeof c ? c : c.dataValue;
                        g ? b._.nextPasteType = g : delete b._.nextPasteType;
                        "string" === typeof h ? d({dataValue: h}) : b.getClipboardData(d)
                    }
                }
            }
            ...
            function m(a, c) {
                ...
                if (!d.getById("cke_pastebin")) {
                    ...
                    var r = 0, d = d.getWindow();
                    CKEDITOR.env.webkit ? (e.append(p), p.addClass("cke_editable"), e.is("body") || (r = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent), r = r.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(p);
                    p.setStyles({
                        position: "absolute",
                    ...
                    (r = p.getParent().isReadOnly()) ? (p.setOpacity(0), p.setAttribute("contenteditable", !0)) : p.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-10000px");
                    b.on("selectionChange", f, null, null, 0);
                    if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) h =
                        e.once("blur", f, null, null, -100);
                    r && p.focus();
                    r = new CKEDITOR.dom.range(p);
            ...
            function A() {
                if ("paste" == C.mainPasteEvent)return b.fire("beforePaste", {type: "auto", method: "paste"}), !1;
                b.focus();
                f();
            ...
            function x(c) {
                var d = {type: "auto", method: "paste", dataTransfer: C.initPasteDataTransfer(c)};
            ...
            var C = CKEDITOR.plugins.clipboard, D = 0, I = 0, F = 0;
            (function () {
                b.on("key", p);
                b.on("contentDom", c);
            ...
            (function () {
                function a(c, d, e, f, h) {
                    ...
                    b.addCommand(d, e);
                    b.ui.addButton && b.ui.addButton(c, {label: k, command: d, toolbar: "clipboard," + f});
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "notification", init: function (a) {
                var d, k = e();
                ...
                if (CKEDITOR.env.gecko) {
                    var m = ["image/png", "image/jpeg", "image/gif"], y;
                    a.on("paste",
                        function (b) {
                ...
                a.on("paste", function (a) {
                        ...
                        if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                            ...
                            for (f.setHtml(b); 1 == f.getChildCount() &&
                            (d = f.getFirst()) && d.type == CKEDITOR.NODE_ELEMENT && (d.hasClass("cke_editable") || d.hasClass("cke_contents"));)f = e = d;
                ...
                a.on("paste", function (d) {
                    d = d.data;
                    var e = a._.nextPasteType || d.type, f = d.dataValue, h,
                        m = a.config.clipboard_defaultContentType || "html", p = d.dataTransfer.getTransferType(a);
                    h = "html" == e || "html" == d.preSniffing ? "html" : b(f);
                    delete a._.nextPasteType;
                    "htmlifiedtext" == h && (f = c(a.config, f));
                    "text" == e && "html" == h ? f = l(a, f, k.get("plain-text")) : p == CKEDITOR.DATA_TRANSFER_EXTERNAL && a.pasteFilter && !d.dontFilter && (f = l(a, f, a.pasteFilter));
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function (a,
                ...
                "number" == typeof d && "number" == typeof c && f.type == CKEDITOR.NODE_ELEMENT && (e(a.startContainer, f, c) || e(a.endContainer,
                    f, d))
            },
            ...
            internalDrop: function (b, c, d, e) {
                ...
                CKEDITOR.env.ie && 10 > CKEDITOR.env.version && this.fixSplitNodesAfterDrop(b, c, f.dragStartContainerChildCount,
                ...
                if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, e)) c = b.document.$.caretRangeFromPoint(d, e), h.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), h.collapse(!0); else if (c.rangeParent) h.setStart(CKEDITOR.dom.node(c.rangeParent), c.rangeOffset), h.collapse(!0); else {
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (k) {
                                var x = "cke-temp-" + (new Date).getTime();
                                c.pasteHTML('\x3cspan id\x3d"' + x + '"\x3e​\x3c/span\x3e');
                                var B = b.document.getById(x);
                                h.moveToPosition(B, CKEDITOR.POSITION_BEFORE_START);
                                B.remove()
                            } else {
                                var z = b.document.$.elementFromPoint(d, e), C = new CKEDITOR.dom.element(z), D;
                                if (C.equals(b.editable()) ||
                                    "html" == C.getName())return f && f.startContainer && !f.startContainer.equals(b.editable()) ? f : null;
                                D = C.getClientRect();
                                d < D.left ? h.setStartAt(C, CKEDITOR.POSITION_AFTER_START) : h.setStartAt(C, CKEDITOR.POSITION_BEFORE_END);
                                h.collapse(!0)
                            }
                        } catch (I) {
                            return null
        ...
        CKEDITOR.ui.panel.prototype = {
            render: function (c, e) {
                ...
                if (this.isFramed) {
                    ...
                    l.frame = f.output({id: this.id + "_frame", src: k})
                }
                k = a.output(l);
                e && e.push(k);
                return k
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (b, c, e, f) {
                ...
                var d = c.getDocument();
                f = a(b, d, c, e, f || 0);
                var h = f.element, m = h.getFirst(), g = this;
                ...
                showBlock: function (a, c, e, f, k, d) {
                    ...
                    var n = this.element, g = this._.iframe,
                        ...
                        y = c.getDocumentPosition(q), q = v ? v.getDocumentPosition(q) :
                            {x: 0, y: 0}, w = "rtl" == this._.dir, u = y.x + (f || 0) - q.x, r = y.y + (k || 0) - q.y;
                    !w || 1 != e && 4 != e ? w || 2 != e && 3 != e || (u += c.$.offsetWidth - 1) : u += c.$.offsetWidth;
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            var b = h.element.getWindow(), a = n.$.getBoundingClientRect(), b = b.getViewPaneSize(),
                                ...
                                f = w ? a.right : b.width - a.left, g = w ? b.width - a.right : a.left;
                            w ? f < c && (u = g > c ? u + c : b.width > c ? u - a.left : u - a.right + b.width) : f < c && (u = g > c ? u - c : b.width > c ? u - a.right + b.width : u - a.left);
                            c = a.top;
                            b.height -
                            a.top < e && (r = c > e ? r - e : b.height > e ? r - a.bottom + b.height : r - a.top);
                            ...
                            n.setStyles({top: r + "px", left: u + "px"});
                            n.setOpacity(1);
                            d && d()
                        }, this);
            ...
            $: function (a, b) {
                ...
                onShow: function () {
                    ...
                    for (var f = 0; f < e.length; f++) {
                        var g = e[f](b, a, c);
                        if (g)for (var n in g) {
                            var q = this.editor.getMenuItem(n);
                            !q || q.command && !this.editor.getCommand(q.command).state || (q.state = g[n], this.add(q))
                        }
                    }
                }, onClick: function (a) {
                    this.hide();
                ...
                add: function (a) {
                    ...
                    var f = this.items, g = this.editor, n = this._.panel, q = this._.element;
                    if (!n) {
                        ...
                        q = n.addBlock(this.id, this._.panelDefinition.block);
                        q.autoSize = !0;
                        var v = q.keys;
                        v[40] = "next";
                        v[9] = "next";
                        ...
                        v["rtl" == g.lang.dir ? 37 : 39] = CKEDITOR.env.ie ? "mouseup" : "click";
                        v[32] = CKEDITOR.env.ie ? "mouseup" :
                            "click";
                    ...
                    a(f);
                    for (var v = g.elementPath(), v = ['\x3cdiv class\x3d"cke_menu' + (v && v.direction() != g.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], y = f.length, w = y && f[0].group, u = 0; u < y; u++) {
                        var r = f[u];
                        w != r.group && (v.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'),
                            w = r.group);
                        r.render(this, u, v)
                    }
                    v.push("\x3c/div\x3e");
        ...
        CKEDITOR.menuItem = CKEDITOR.tools.createClass({
            $: function (a, b, c) {
                ...
                render: function (a, f, d) {
                    var h = a.id + String(f), m = "undefined" == typeof this.state ? CKEDITOR.TRISTATE_OFF : this.state,
                        g = "", n = this.editor, q, v,
                        y = m == CKEDITOR.TRISTATE_ON ? "on" : m == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off";
                    this.role in {
                        menuitemcheckbox: 1,
                        menuitemradio: 1
                    } && (g = ' aria-checked\x3d"' + (m == CKEDITOR.TRISTATE_ON ? "true" : "false") + '"');
                    var w = this.getItems, u = "\x26#" + ("rtl" == this.editor.lang.dir ? "9668" : "9658") + ";",
                        r = this.name;
                    this.icon && !/\./.test(this.icon) &&
                    (r = this.icon);
                    this.command && (q = n.getCommand(this.command), (q = n.getCommandKeystroke(q)) && (v = CKEDITOR.tools.keystrokeToString(n.lang.common.keyboard, q)));
                    a = {
                        id: h,
                        name: this.name,
                        iconName: r,
                        ...
                        title: this.label + (v ? " (" + v.display + ")" : ""),
                        ariaShortcut: v ? n.lang.common.keyboardShortcut + " " + v.aria : "",
                        ...
                        shortcutHtml: v ? e.output({shortcut: v.display}) : "",
                        arrowHtml: w ? c.output({label: u}) : "",
                            ...
                            a.on("contextmenu", function (a) {
                                ...
                                if (!f || !c) {
                                    ...
                                    var k = a.getTarget().getDocument(),
                                        ...
                                        c = !k.equals(CKEDITOR.document), k = k.getWindow().getScrollPosition(),
        ...
        function a(a, b) {
            function k(b) {
                ...
                CKEDITOR.env.ie && a.fire("selectionChange",
                    {selection: c, path: new CKEDITOR.dom.elementPath(b)});
                a.focus()
            }
            ...
            var h = a.ui.spaceId("path"), m, g = a._.elementsPath, n = g.idBase;
            ...
            g.onClick = k;
            var q = CKEDITOR.tools.addFunction(k), v = CKEDITOR.tools.addFunction(function (b, c) {
                var d = g.idBase, f;
                ...
                switch (c.getKeystroke()) {
                    ...
                    case f ? 37 : 39:
                    case CKEDITOR.SHIFT + 9:
                        return (f = CKEDITOR.document.getById(d + (b - 1))) || (f = CKEDITOR.document.getById(d + (g.list.length -
                            1))), f.focus(), !1;
                    case 27:
                        return a.focus(), !1;
                    case 13:
            ...
            a.on("selectionChange", function () {
                for (var b = [], d = g.list = [], f = [], k = g.filters, l = !0, A = a.elementPath().elements, p, x = A.length; x--;) {
                    var B = A[x], z = 0;
                    p = B.data("cke-display-name") ? B.data("cke-display-name") : B.data("cke-real-element-type") ? B.data("cke-real-element-type") : B.getName();
                    ...
                    z || (d.unshift(B), f.unshift(p))
                }
                d = d.length;
                for (k = 0; k < d; k++)p = f[k], l = a.lang.elementspath.eleTitle.replace(/%1/, p), p = c.output({
                    id: n + k,
                    label: l,
                    text: p,
        ...
        CKEDITOR.plugins.add("indent", {
            init: function (b) {
                ...
                b.on("dirChanged", function (a) {
                    ...
                    e.setStartBefore(d);
                    e.setEndAfter(d);
                    for (var f = new CKEDITOR.dom.walker(e), m; m = f.next();)if (m.type == CKEDITOR.NODE_ELEMENT)if (!m.equals(d) && m.getDirection()) e.setStartAfter(m),
                        f = new CKEDITOR.dom.walker(e); else {
                        var g = b.config.indentClasses;
                        if (g)for (var n = "ltr" == a.data.dir ? ["_rtl", ""] : ["", "_rtl"], q = 0; q < g.length; q++)m.hasClass(g[q] + n[0]) && (m.removeClass(g[q] + n[0]), m.addClass(g[q] + n[1]));
                ...
                a.on("pluginsLoaded", function () {
                    for (var a in b)(function (a, b) {
                        ...
                        for (e in b.jobs)c.on("exec", function (c) {
                            c.data.done || (a.fire("lockSnapshot"), b.execJob(a, e) && (c.data.done = !0), a.fire("unlockSnapshot"),
        ...
        CKEDITOR.plugins.indent.specificDefinition.prototype = {
            execJob: function (a, b) {
                ...
                a.activeFilter.checkFeature(this) ?
                    b.state = b.refresh.call(this, a, l) : b.state = f;
                return b.state
        ...
        function a(a) {
            function c(f) {
                for (var h = l.startContainer, t = l.endContainer; h && !h.getParent().equals(f);)h = h.getParent();
                for (; t && !t.getParent().equals(f);)t = t.getParent();
                if (!h || !t)return !1;
                for (var A = h, h = [], p = !1; !p;)A.equals(t) && (p = !0), h.push(A), A = A.getNext();
                if (1 > h.length)return !1;
                A = f.getParents(!0);
                for (t = 0; t < A.length; t++)if (A[t].getName && k[A[t].getName()]) {
                    f = A[t];
                    break
                }
                for (var A =
                    e.isIndent ? 1 : -1, t = h[0], h = h[h.length - 1], p = CKEDITOR.plugins.list.listToArray(f, g), x = p[h.getCustomData("listarray_index")].indent, t = t.getCustomData("listarray_index"); t <= h.getCustomData("listarray_index"); t++)if (p[t].indent += A, 0 < A) {
                    var w = p[t].parent;
                    p[t].parent = new CKEDITOR.dom.element(w.getName(), w.getDocument())
                }
                for (t = h.getCustomData("listarray_index") + 1; t < p.length && p[t].indent > x; t++)p[t].indent += A;
                h = CKEDITOR.plugins.list.arrayToList(p, g, null, a.config.enterMode, f.getDirection());
                if (!e.isIndent) {
                    var z;
                    if ((z = f.getParent()) && z.is("li"))for (var A = h.listNode.getChildren(), y = [], D, t = A.count() - 1; 0 <= t; t--)(D = A.getItem(t)) && D.is && D.is("li") && y.push(D)
                }
                h && h.listNode.replace(f);
                if (y && y.length)for (t = 0; t < y.length; t++) {
                    for (D = f = y[t]; (D = D.getNext()) && D.is && D.getName() in k;)CKEDITOR.env.needsNbspFiller && !f.getFirst(b) && f.append(l.document.createText(" ")), f.append(D);
                    f.insertAfter(z)
                }
            ...
            for (var e = this, g = this.database, k = this.context, l, v = a.getSelection(), v = (v && v.getRanges()).createIterator(); l =
                ...
                if (!y) {
                    ...
                    w && w.type == CKEDITOR.NODE_ELEMENT && w.getName() in k && (l.setStartAt(w, CKEDITOR.POSITION_AFTER_START), l.setEndAt(w, CKEDITOR.POSITION_BEFORE_END), y = w)
                }
                y && l.startContainer.type == CKEDITOR.NODE_ELEMENT && l.startContainer.getName() in k && (w = new CKEDITOR.dom.walker(l),
                    w.evaluator = f, l.startContainer = w.next());
                y && l.endContainer.type == CKEDITOR.NODE_ELEMENT && l.endContainer.getName() in k && (w = new CKEDITOR.dom.walker(l), w.evaluator = f, l.endContainer = w.previous());
                if (y)return c(y)
            }
            return 0
        }
        ...
        CKEDITOR.plugins.add("indentlist", {
            requires: "indent", init: function (b) {
                ...
                CKEDITOR.tools.extend(c.prototype, e.specificDefinition.prototype, {context: {ol: 1, ul: 1}})
            }
        });
        ...
        function b(a, b, c, d) {
            for (var e,
                     f; e = a[d ? "getLast" : "getFirst"](v);)(f = e.getDirection(1)) !== b.getDirection(1) && e.setAttribute("dir", f), e.remove(), c ? e[d ? "insertBefore" : "insertAfter"](c) : b.append(e, d)
        }
        ...
        function l(a, d, e) {
            ...
            d.trim(!1, !0);
            var h = d.createBookmark(), l = new CKEDITOR.dom.elementPath(d.startContainer), m = l.block,
                l = l.lastElement.getAscendant("li", 1) || m, x = new CKEDITOR.dom.elementPath(e.startContainer),
                B = x.contains(CKEDITOR.dtd.$listItem), x = x.contains(CKEDITOR.dtd.$list);
            m ? (m = m.getBogus()) && m.remove() : x && (m = x.getPrevious(g)) && n(m) && m.remove();
            (m = f.getLast()) && m.type == CKEDITOR.NODE_ELEMENT && m.is("br") && m.remove();
            (m = d.startContainer.getChild(d.startOffset)) ?
                f.insertBefore(m) : d.startContainer.append(f);
            ...
            (e =
                e.next()) && e.type == CKEDITOR.NODE_ELEMENT && e.getName() in CKEDITOR.dtd.$list && c(e);
            d.moveToBookmark(h);
            d.select();
            a.fire("saveSnapshot")
        }
        ...
        var d = {ol: 1, ul: 1}, h = CKEDITOR.dom.walker.whitespaces(), m = CKEDITOR.dom.walker.bookmark(),
            g = function (a) {
                return !(h(a) || m(a))
        ...
        CKEDITOR.plugins.list = {
            listToArray: function (a, b, c, e, f) {
                ...
                e || (e = 0);
                c || (c = []);
                for (var g = 0, h = a.getChildCount(); g <
                h; g++) {
                    var k = a.getChild(g);
                    ...
                    if ("li" == k.$.nodeName.toLowerCase()) {
                        ...
                        c.push(l);
                        for (var m = 0, n = k.getChildCount(), q; m < n; m++)q = k.getChild(m),
                            q.type == CKEDITOR.NODE_ELEMENT && d[q.getName()] ? CKEDITOR.plugins.list.listToArray(q, b, c, e + 1, l.grandparent) : l.contents.push(q)
                    }
                }
                return c
                ...
                for (var h, k = a[c].parent.getDocument(), l = new CKEDITOR.dom.documentFragment(k), n = null, q = c, C = Math.max(a[c].indent, 0), D = null, v, F, J = e == CKEDITOR.ENTER_P ? "p" : "div"; ;) {
                    var G = a[q];
                    h = G.grandparent;
                    v = G.element.getDirection(1);
                    if (G.indent == C) {
                        n && a[q].parent.getName() == n.getName() || (n = a[q].parent.clone(!1,
                            1), f && n.setAttribute("dir", f), l.append(n));
                        D = n.append(G.element.clone(0, 1));
                        v != n.getDirection(1) && D.setAttribute("dir", v);
                        for (h = 0; h < G.contents.length; h++)D.append(G.contents[h].clone(1, 1));
                        q++
                    } else if (G.indent == Math.max(C, 0) + 1) G = a[q - 1].element.getDirection(1), q = CKEDITOR.plugins.list.arrayToList(a, null, q, e, G != v ? v : null), !D.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && D.append(k.createText(" ")), D.append(q.listNode), q = q.nextIndex; else if (-1 == G.indent && !c && h) {
                        d[h.getName()] ? (D =
                            G.element.clone(!1, !0), v != h.getDirection(1) && D.setAttribute("dir", v)) : D = new CKEDITOR.dom.documentFragment(k);
                        var n = h.getDirection(1) != v, M = G.element, L = M.getAttribute("class"),
                            E = M.getAttribute("style"),
                            T = D.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && (e != CKEDITOR.ENTER_BR || n || E || L), H,
                            O = G.contents.length, K;
                        for (h = 0; h < O; h++)if (H = G.contents[h], m(H) && 1 < O) T ? K = H.clone(1, 1) : D.append(H.clone(1, 1)); else if (H.type == CKEDITOR.NODE_ELEMENT && H.isBlockBoundary()) {
                            n && !H.getDirection() && H.setAttribute("dir", v);
                            F = H;
                            ...
                            F = null;
                            K && (D.append(K), K = null);
                            D.append(H.clone(1, 1))
                        } else T ? (F || (F = k.createElement(J), D.append(F), n && F.setAttribute("dir", v)), E && F.setAttribute("style", E), L && F.setAttribute("class", L), K && (F.append(K), K = null), F.append(H.clone(1, 1))) : D.append(H.clone(1, 1));
                        K && ((F || D).append(K), K = null);
                        D.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && q != a.length - 1 && (CKEDITOR.env.needsBrFiller && (v = D.getLast()) && v.type == CKEDITOR.NODE_ELEMENT &&
                        v.is("br") && v.remove(), (v = D.getLast(g)) && v.type == CKEDITOR.NODE_ELEMENT && v.is(CKEDITOR.dtd.$block) || D.append(k.createElement("br")));
                        v = D.$.nodeName.toLowerCase();
                        "div" != v && "p" != v || D.appendBogus();
                        l.append(D);
                        n = null;
                        q++
                    } else return null;
                    F = null;
                    if (a.length <= q || Math.max(a[q].indent, 0) < C)break
                }
                if (b)for (a = l.getFirst(); a;) {
                    if (a.type == CKEDITOR.NODE_ELEMENT && (CKEDITOR.dom.element.clearMarkers(b, a), a.getName() in CKEDITOR.dtd.$listItem && (c = a, k = f = e = void 0, e = c.getDirection()))) {
                        for (f = c.getParent(); f && !(k = f.getDirection());)f =
                            f.getParent();
                        e == k && c.removeAttribute("dir")
                    }
                    a = a.getNextSourceNode()
                }
                return {listNode: l, nextIndex: q}
            }
        };
        var q = /^h[1-6]$/, v = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);
        f.prototype = {
            exec: function (b) {
                this.refresh(b, b.elementPath());
                var e = b.config, f = b.getSelection(), h = f && f.getRanges();
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                    var k = b.editable();
                    if (k.getFirst(g)) {
                        var l = 1 == h.length && h[0];
                        (e = l && l.getEnclosedNode()) && e.is && this.type == e.getName() && this.setState(CKEDITOR.TRISTATE_ON)
                    } else e.enterMode == CKEDITOR.ENTER_BR ?
                        k.appendBogus() : h[0].fixBlock(1, e.enterMode == CKEDITOR.ENTER_P ? "p" : "div"), f.selectRanges(h)
                }
                for (var e = f.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0; (l = h.getNextRange()) && ++n;) {
                    var B = l.getBoundaryNodes(), z = B.startNode, C = B.endNode;
                    z.type == CKEDITOR.NODE_ELEMENT && "td" == z.getName() && l.setStartAt(B.startNode, CKEDITOR.POSITION_AFTER_START);
                    C.type == CKEDITOR.NODE_ELEMENT && "td" == C.getName() && l.setEndAt(B.endNode, CKEDITOR.POSITION_BEFORE_END);
                    l = l.createIterator();
                    for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; B =
                        l.getNextParagraph();)if (!B.getCustomData("list_block")) {
                        CKEDITOR.dom.element.setMarker(m, B, "list_block", 1);
                        for (var v = b.elementPath(B), z = v.elements, C = 0, v = v.blockLimit, I, F = z.length - 1; 0 <= F && (I = z[F]); F--)if (d[I.getName()] && v.contains(I)) {
                            v.removeCustomData("list_group_object_" + n);
                            (z = I.getCustomData("list_group_object")) ? z.contents.push(B) : (z = {
                                root: I,
                                contents: [B]
                            }, k.push(z), CKEDITOR.dom.element.setMarker(m, I, "list_group_object", z));
                            C = 1;
                            break
                        }
                        C || (C = v, C.getCustomData("list_group_object_" + n) ? C.getCustomData("list_group_object_" +
                            n).contents.push(B) : (z = {
                            root: C,
                            contents: [B]
                        }, CKEDITOR.dom.element.setMarker(m, C, "list_group_object_" + n, z), k.push(z)))
                    }
                }
                for (I = []; 0 < k.length;)if (z = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)if (d[z.root.getName()]) {
                    h = b;
                    n = z;
                    z = m;
                    l = I;
                    C = CKEDITOR.plugins.list.listToArray(n.root, z);
                    v = [];
                    for (B = 0; B < n.contents.length; B++)F = n.contents[B], (F = F.getAscendant("li", !0)) && !F.getCustomData("list_item_processed") && (v.push(F), CKEDITOR.dom.element.setMarker(z, F, "list_item_processed", !0));
                    for (var F = n.root.getDocument(),
                             J = void 0, G = void 0, B = 0; B < v.length; B++) {
                        var M = v[B].getCustomData("listarray_index"), J = C[M].parent;
                        J.is(this.type) || (G = F.createElement(this.type), J.copyAttributes(G, {
                            start: 1,
                            type: 1
                        }), G.removeStyle("list-style-type"), C[M].parent = G)
                    }
                    z = CKEDITOR.plugins.list.arrayToList(C, z, null, h.config.enterMode);
                    C = void 0;
                    v = z.listNode.getChildCount();
                    for (B = 0; B < v && (C = z.listNode.getChild(B)); B++)C.getName() == this.type && l.push(C);
                    ...
                    n = [];
                    1 == v.length && v[0].equals(l.root) && (z = h.createElement("div"), v[0].moveChildren && v[0].moveChildren(z), v[0].append(z), v[0] = z);
                    l = l.contents[0].getParent();
                    for (F = 0; F < v.length; F++)l = l.getCommonAncestor(v[F].getParent());
                    J = C.config.useComputedState;
                    C = z = void 0;
                    J = void 0 === J || J;
                    for (F = 0; F < v.length; F++)for (G = v[F]; M = G.getParent();) {
                        if (M.equals(l)) {
                            n.push(G);
                            !C && G.getDirection() && (C = 1);
                            G = G.getDirection(J);
                            null !== z && (z = z && z != G ? null : G);
                            break
                        }
                        G = M
                    }
                    if (!(1 > n.length)) {
                        v = n[n.length - 1].getNext();
                        F = h.createElement(this.type);
                        B.push(F);
                        for (J = B = void 0; n.length;)B = n.shift(), J = h.createElement("li"), G = B, G.is("pre") || q.test(G.getName()) || "false" == G.getAttribute("contenteditable") ? B.appendTo(J) : (B.copyAttributes(J), z && B.getDirection() && (J.removeStyle("direction"), J.removeAttribute("dir")), B.moveChildren(J), B.remove()), J.appendTo(F);
                        z && C && F.setAttribute("dir", z);
                        v ? F.insertBefore(v) : F.appendTo(l)
                    }
        ...
        CKEDITOR.plugins.add("list", {
            requires: "indentlist", init: function (a) {
                a.blockless || (a.addCommand("numberedlist", new f("numberedlist", "ol")), a.addCommand("bulletedlist", new f("bulletedlist", "ul")), a.ui.addButton && (a.ui.addButton("NumberedList", {
                    ...
                    command: "numberedlist", directional: !0, toolbar: "list,10"
                    ...
                    if ("wysiwyg" == a.mode && c in {8: 1, 46: 1}) {
                        ...
                        if (h && h.collapsed) {
                            var p = 8 == c, x = a.editable(), q = new CKEDITOR.dom.walker(h.clone());
                            q.evaluator = function (a) {
                                return g(a) && !n(a)
                            };
                            q.guard = function (a, b) {
                                return !(b && a.type == CKEDITOR.NODE_ELEMENT &&
                                a.is("table"))
                            };
                            c = h.clone();
                            if (p) {
                                var z;
                                (z = m.contains(d)) && h.checkBoundaryOfElement(z, CKEDITOR.START) && (z = z.getParent()) && z.is("li") && (z = k(z)) ? (f = z, z = z.getPrevious(g), c.moveToPosition(z && n(z) ? z : f, CKEDITOR.POSITION_BEFORE_START)) : (q.range.setStartAt(x, CKEDITOR.POSITION_AFTER_START), q.range.setEnd(h.startContainer, h.startOffset), (z = q.previous()) && z.type == CKEDITOR.NODE_ELEMENT && (z.getName() in d || z.is("li")) && (z.is("li") || (q.range.selectNodeContents(z), q.reset(), q.evaluator = e, z = q.previous()), f = z, c.moveToElementEditEnd(f),
                                    c.moveToPosition(c.endPath().block, CKEDITOR.POSITION_BEFORE_END)));
                                if (f) l(a, c, h), b.cancel(); else {
                                    var v = m.contains(d);
                                    v && h.checkBoundaryOfElement(v, CKEDITOR.START) && (f = v.getFirst(g), h.checkBoundaryOfElement(f, CKEDITOR.START) && (z = v.getPrevious(g), k(f) ? z && (h.moveToElementEditEnd(z), h.select()) : a.execCommand("outdent"), b.cancel()))
                                }
                            } else if (f = m.contains("li")) {
                                if (q.range.setEndAt(x, CKEDITOR.POSITION_BEFORE_END), p = (x = f.getLast(g)) && e(x) ? x : f, m = 0, (z = q.next()) && z.type == CKEDITOR.NODE_ELEMENT && z.getName() in
                                    d && z.equals(x) ? (m = 1, z = q.next()) : h.checkBoundaryOfElement(p, CKEDITOR.END) && (m = 2), m && z) {
                                    h = h.clone();
                                    h.moveToElementEditStart(z);
                                    if (1 == m && (c.optimize(), !c.startContainer.equals(f))) {
                                        for (f = c.startContainer; f.is(CKEDITOR.dtd.$inline);)v = f, f = f.getParent();
                                ...
                                CKEDITOR.POSITION_BEFORE_END), (z = q.next()) && z.type == CKEDITOR.NODE_ELEMENT && z.is(d) && (z = z.getFirst(g), m.block && h.checkStartOfBlock() && h.checkEndOfBlock() ? (m.block.remove(), h.moveToElementEditStart(z), h.select()) : k(z) ? (h.moveToElementEditStart(z), h.select()) : (h = h.clone(), h.moveToElementEditStart(z), l(a, c, h)), b.cancel());
                            setTimeout(function () {
                                a.selectionChange(1)
                            })
                        }
        ...
        CKEDITOR.plugins.enterkey = {
            enterBlock: function (a, d, l, q) {
                if (l = l || f(a)) {
                    l = b(l);
                    var v = l.document, y = l.checkStartOfBlock(), w = l.checkEndOfBlock(),
                        u = a.elementPath(l.startContainer),
                        r = u.block, t = d == CKEDITOR.ENTER_DIV ? "div" : "p", A;
                    if (y && w) {
                        if (r && (r.is("li") || r.getParent().is("li"))) {
                            ...
                            A = l.getParent();
                            q = !r.hasPrevious();
                            var p = !r.hasNext(), t = a.getSelection(), x = t.createBookmarks(), y = r.getDirection(1),
                                w = r.getAttribute("class"), B = r.getAttribute("style"), z = A.getDirection(1) != y;
                            a = a.enterMode != CKEDITOR.ENTER_BR || z || B || w;
                            if (A.is("li")) q || p ? (q && p && l.remove(), r[p ? "insertAfter" : "insertBefore"](A)) : r.breakParent(A); else {
                                if (a)if (u.block.is("li") ? (A =
                        ...
                        if (r && r.getParent().is("blockquote")) {
                            ...
                            l.moveToElementEditStart(r);
                            l.select();
                            return
                        }
                    } else if (r && r.is("pre") && !w) {
                        k(a, d, l, q);
                        return
                    }
                    if (y = l.splitBlock(t)) {
                        ...
                        u = y.wasStartOfBlock;
                        a = y.wasEndOfBlock;
                        r ? (x = r.getParent(), x.is("li") && (r.breakParent(x), r.move(r.getNext(), 1))) : d && (x = d.getParent()) && x.is("li") && (d.breakParent(x), x = d.getNext(), l.moveToElementEditStart(x),
                                d.move(d.getPrevious()));
                        if (u || a) {
                            if (d) {
                                if (d.is("li") || !h.test(d.getName()) && !d.is("pre")) A = d.clone()
                            } else r && (A = r.clone());
                            A ? q && !A.is("li") && A.renameNode(t) : x && x.is("li") ? A = x : (A = v.createElement(t), d && (p = d.getDirection()) && A.setAttribute("dir", p));
                            if (v = y.elementPath)for (q = 0, t = v.elements.length; q < t; q++) {
                                x = v.elements[q];
                                if (x.equals(v.block) || x.equals(v.blockLimit))break;
                                CKEDITOR.dtd.$removeEmpty[x.getName()] && (x = x.clone(), A.moveChildren(x), A.append(x))
                            }
                            A.appendBogus();
                            ...
                            l.moveToElementEditStart(u && !a ? r : A)
                        } else r.is("li") && (A = l.clone(), A.selectNodeContents(r), A = new CKEDITOR.dom.walker(A), A.evaluator = function (a) {
                            return !(e(a) || c(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName() in CKEDITOR.dtd.$inline && !(a.getName() in CKEDITOR.dtd.$empty))
                        }, (x = A.next()) && x.type == CKEDITOR.NODE_ELEMENT && x.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? v.createElement("br") :
                            v.createText(" ")).insertBefore(x)), r && l.moveToElementEditStart(r);
                        l.select();
                        l.scrollIntoView()
                    }
                }
                ...
                if (c = c || f(a)) {
                    var k = c.document, l = c.checkEndOfBlock(),
                        w = new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()), u = w.block,
                        r = u && w.block.getName();
                    e || "li" != r ? (!e && l && h.test(r) ? (l = u.getDirection()) ? (k = k.createElement("div"), k.setAttribute("dir", l), k.insertAfter(u), c.setStart(k, 0)) : (k.createElement("br").insertAfter(u), CKEDITOR.env.gecko && k.createText("").insertAfter(u),
        ...
        var l = CKEDITOR.plugins.enterkey, k = l.enterBr, d = l.enterBlock, h = /^h[1-6]$/
    }(),function () {
        function a(a, b) {
            var c = {}, e = [], l = {nbsp: " ", shy: "­", gt: "\x3e", lt: "\x3c", amp: "\x26", apos: "'", quot: '"'};
            ...
            if (!b && a) {
                a = a.split(",");
                var k = document.createElement("div"), d;
        ...
        CKEDITOR.plugins.add("entities", {
            afterInit: function (f) {
                ...
                if (f = (f = f.dataProcessor) && f.htmlFilter) {
                    ...
                    e.entities_additional && l.push(e.entities_additional));
                    var k = a(l.join(",")), d = k.regex ? "[" + k.regex + "]" : "a^";
                    delete k.regex;
                    e.entities && e.entities_processNumerical && (d = "[^ -~]|" + d);
                    var d = new RegExp(d, "g"), h = a("nbsp,gt,lt,amp,shy", !0), m = new RegExp(h.regex, "g");
                    f.addRules({
                        text: function (a) {
        ...
        popup: function (a, f, b, c) {
            ...
            640 > f && (f = 640);
            420 > b && (b = 420);
            var e = parseInt((window.screen.height - b) / 2, 10), l = parseInt((window.screen.width -
                f) / 2, 10);
        ...
        function l(a, d, g, k) {
            if (k && k.length)for (var q, v = k.length; v--;)if (q = k[v], "hbox" != q.type && "vbox" != q.type && "fieldset" != q.type || l(a, d, g, q.children), q.filebrowser)if ("string" == typeof q.filebrowser && (q.filebrowser = {
                    action: "fileButton" == q.type ? "QuickUpload" : "Browse",
                    target: q.filebrowser
                }), "Browse" == q.filebrowser.action) {
                var y = q.filebrowser.url;
                void 0 === y && (y = a.config["filebrowser" + f(d) + "BrowseUrl"], void 0 === y && (y = a.config.filebrowserBrowseUrl));
                y && (q.onClick = b, q.filebrowser.url = y, q.hidden = !1)
            } else if ("QuickUpload" == q.filebrowser.action && q["for"] && (y = q.filebrowser.url, void 0 === y && (y = a.config["filebrowser" + f(d) + "UploadUrl"], void 0 === y && (y = a.config.filebrowserUploadUrl)), y)) {
                var w = q.onClick;
                ...
                q.filebrowser.url = y;
                q.hidden = !1;
                e(a, g.getContents(q["for"][0]).get(q["for"][1]), q.filebrowser)
            }
        }
        ...
        CKEDITOR.on("dialogDefinition", function (a) {
            if (a.editor.plugins.filebrowser)for (var b = a.data.definition, c, d = 0; d < b.contents.length; ++d)if (c = b.contents[d]) l(a.editor, a.data.name, b, c.elements), c.hidden && c.filebrowser && (c.hidden = !k(b, c.id, c.filebrowser))
        })
    }(),function () {
        function a(a) {
            var e = a.config, l = a.fire("uiSpace", {space: "top", html: ""}).html, k = function () {
                function d(a, c, e) {
                    h.setStyle(c, b(e));
                ...
                function g(a) {
                    ...
                    switch (a) {
                        ...
                        case "pin":
                            ...
                            break;
                        case "bottom":
                            d("absolute", "top", b.y + (u.height || u.bottom - u.top) + x)
                    }
                    l = a
                }

                var l, m, w, u, r, t, A, p = e.floatSpaceDockedOffsetX || 0, x = e.floatSpaceDockedOffsetY || 0,
                    B = e.floatSpacePinnedOffsetX || 0, z = e.floatSpacePinnedOffsetY || 0;
                return function (d) {
                    if (m = a.editable()) {
            ...
            if (l) {
                var d = new CKEDITOR.template('\x3cdiv id\x3d"cke_{name}" class\x3d"cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' + CKEDITOR.env.cssClass + '" dir\x3d"{langDir}" title\x3d"' + (CKEDITOR.env.gecko ? " " : "") + '" lang\x3d"{langCode}" role\x3d"application" style\x3d"{style}"' + (a.title ? ' aria-labelledby\x3d"cke_{name}_arialbl"' : " ") + "\x3e" + (a.title ? '\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e' :
                    ...
                    h = CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml(d.output({
                        ...
                        voiceLabel: a.title
                    }))), m = CKEDITOR.tools.eventsBuffer(500, k), g = CKEDITOR.tools.eventsBuffer(100, k);
                h.unselectable();
                h.on("mousedown",
                    function (a) {
                        a = a.data;
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            $: function (a) {
                CKEDITOR.tools.extend(this,
                    a, {canGroup: !1, title: a.label, modes: {wysiwyg: 1}, editorFocus: 1});
                a = this.panel || {};
                delete this.panel;
                this.id = CKEDITOR.tools.getNextNumber();
                ...
                renderHtml: function (a) {
                    ...
                    var l = CKEDITOR.env, k = "cke_" + this.id, d = CKEDITOR.tools.addFunction(function (c) {
                        ...
                        id: k, combo: this, focus: function () {
                            ...
                            var d = h._;
                            if (d.state != CKEDITOR.TRISTATE_DISABLED)if (h.createPanel(a),
                                    d.on) d.panel.hide(); else {
                                h.commit();
                                var e = h.getValue();
                    ...
                    if (!this._.panel) {
                        var c = this._.panelDefinition, e = this._.panelDefinition.block,
                            f = c.parent || CKEDITOR.document.getBody(), k = "cke_combopanel__" + this.name,
                            d = new CKEDITOR.ui.floatPanel(a, f, c), c = d.addListBlock(this.id,
                            e), h = this;
                        d.onShow = function () {
        ...
        requires: "richcombo", init: function (a) {
            if (!a.blockless) {
                for (var f =
                    a.config, b = a.lang.format, c = f.format_tags.split(";"), e = {}, l = 0, k = [], d = 0; d < c.length; d++) {
                    var h = c[d], m = new CKEDITOR.style(f["format_" + h]);
        ...
        base: CKEDITOR.htmlParser.basicWriter, $: function () {
            ...
            for (f in CKEDITOR.tools.extend({}, a.$nonBodyContent, a.$block, a.$listItem, a.$tableContent))this.setRules(f, {
                ...
                breakAfterClose: 1,
                needsSpace: f in a.$block && !(f in {li: 1, dt: 1, dd: 1})
            });
        ...
        var f = CKEDITOR.htmlParser.cssStyle, b = CKEDITOR.tools.cssLength, c = /^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i,
            e = {
                elements: {
                    $: function (b) {
                        var c = b.attributes;
                        if ((c = (c = (c = c && c["data-cke-realelement"]) && new CKEDITOR.htmlParser.fragment.fromHtml(decodeURIComponent(c))) &&
                                c.children[0]) && b.attributes["data-cke-resizable"]) {
                            var d = (new f(b)).rules;
                            b = c.attributes;
        ...
        CKEDITOR.editor.prototype.createFakeElement = function (a, c, d, e) {
            var m = this.lang.fakeobjects, m = m[d] ||
                m.unknown;
            c = {
                "class": c,
        ...
        CKEDITOR.editor.prototype.createFakeParserElement =
            function (a, c, d, e) {
                var m = this.lang.fakeobjects, m = m[d] || m.unknown, g;
                ...
                CKEDITOR.env.hc || (c.src = CKEDITOR.tools.transparentImageData);
                d && (c["data-cke-real-element-type"] = d);
                e && (c["data-cke-resizable"] = e, e = a.attributes, a = new f, d = e.width, e = e.height, void 0 !== d && (a.rules.width = b(d)), void 0 !== e && (a.rules.height =
                    b(e)), a.populate(c));
        ...
        CKEDITOR.plugins.add("link", {
            requires: "dialog,fakeobjects", onLoad: function () {
                ...
                a.on("doubleclick", function (b) {
                    ...
                    c && !c.isReadOnly() && (c.is("a") ? (b.data.dialog = !c.getAttribute("name") || c.getAttribute("href") &&
                    c.getChildCount() ? "link" : "anchor", b.data.link = c) : CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, c) && (b.data.dialog = "anchor"))
                }, null, null, 0);
                a.on("doubleclick", function (b) {
        ...
        var e = /^javascript:/, l = /^mailto:([^?]+)(?:\?(.+))?$/,
            k = /subject=([^;?:@&=$,\/]*)/i, d = /body=([^;?:@&=$,\/]*)/i, h = /^#(.*)$/,
            m = /^((?:http|https|ftp|news):\/\/)?(.*)$/, g = /^(_(?:self|top|parent|blank))$/,
            n = /^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/,
            q = /^javascript:([^(]+)\(([^)]+)\)$/,
            v = /\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/,
            y = /(?:^|,)([^=]+)=(\d+|yes|no)/gi, w = {
                id: "advId",
                dir: "advLangDir",
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (a, b) {
                var c = a.getSelection(), d = c.getSelectedElement(), e = c.getRanges(), f = [], g;
                if (!b && d && d.is("a"))return d;
                for (d = 0; d < e.length; d++)if (g = c.getRanges()[d], g.shrink(CKEDITOR.SHRINK_TEXT, !1, {skipBogus: !0}), (g = a.elementPath(g.getCommonAncestor()).contains("a", 1)) && b) f.push(g); else if (g)return g;
                return b ? f : null
                ...
                var c = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "",
                    f = a.plugins.link.compiledProtectionFunction, p = a.config.emailProtection, x, B = {};
                c.match(e) && ("encode" == p ? c = c.replace(n, function (a, b, c) {
                    c = c || "";
                    return "mailto:" + String.fromCharCode.apply(String, b.split(",")) + c.replace(/\\'/g, "'")
                }) : p && c.replace(q, function (a, b, c) {
                        if (b == f.name) {
                            B.type = "email";
                            a = B.email =
                                {};
                ...
                if (!B.type)if (p = c.match(h)) B.type = "anchor", B.anchor = {}, B.anchor.name = B.anchor.id = p[1]; else if (p = c.match(l)) {
                    x = c.match(k);
                    c = c.match(d);
                    B.type = "email";
                    var z = B.email = {};
                    z.address = p[1];
                    x && (z.subject = decodeURIComponent(x[1]));
                    c && (z.body = decodeURIComponent(c[1]))
                } else c && (x = c.match(m)) &&
                (B.type = "url", B.url = {}, B.url.protocol = x[1], B.url.url = x[2]);
                if (b) {
                    if (c = b.getAttribute("target")) B.target = {
                        type: c.match(g) ? c : "frame",
                        name: c
                    }; else if (c = (c = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && c.match(v))for (B.target = {
                        type: "popup",
                        name: c[1]
                    }; p = y.exec(c[2]);)"yes" != p[2] && "1" != p[2] || p[1] in {
                        height: 1,
                        width: 1,
                        top: 1,
                        left: 1
                    } ? isFinite(p[2]) && (B.target[p[1]] = p[2]) : B.target[p[1]] = !0;
                    null !== b.getAttribute("download") && (B.download = !0);
                    var c = {}, C;
                    for (C in w)(p = b.getAttribute(C)) && (c[w[C]] = p);
                    if (C =
                            b.data("cke-saved-name") || c.advName) c.advName = C;
                ...
                if (d.advanced) {
                    for (var q in w)(e = d.advanced[w[q]]) &&
                    (g[q] = e);
                    g.name && (g["data-cke-saved-name"] = g.name)
                }
                g["data-cke-saved-href"] && (g.href = g["data-cke-saved-href"]);
                q = {target: 1, onclick: 1, "data-cke-pa-onclick": 1, "data-cke-saved-name": 1, download: 1};
                d.advanced && CKEDITOR.tools.extend(q, w);
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function (a) {
                ...
                if (b && (d = b.getSelectedElement()) &&
                    (d.getChildCount() ? d.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, d))) d.remove(1); else if (d = CKEDITOR.plugins.link.getSelectedLink(a)) d.hasAttribute("href") ? (d.removeAttributes({
                    name: 1,
        ...
        function d(a) {
            var b = a.doc,
                c = I('\x3cspan contenteditable\x3d"false" style\x3d"' + S + "position:absolute;border-top:1px dashed " + a.boxColor + '"\x3e\x3c/span\x3e', b),
            ...
            C(c, {
                ...
                lineChildren: [C(I('\x3cspan title\x3d"' + a.editor.lang.magicline.title + '" contenteditable\x3d"false"\x3e\x26#8629;\x3c/span\x3e', b), {
                ...
                place: function () {
                    ...
                    d.is(O) || l(k.top, b.scroll.y - 15, b.scroll.y + 5) ? (k.top = a.inInlineMode ? 0 : b.scroll.y, this.look(O)) : d.is(K) || l(k.top, b.pane.bottom - 5, b.pane.bottom + 15) ? (k.top = a.inInlineMode ?
                        b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1, this.look(K)) : (a.inInlineMode && (k.top -= b.editable.top + b.editable.border.top), this.look(U));
        ...
        function h(a, b, c) {
            var d = new CKEDITOR.dom.range(a.doc),
                e = a.editor, f;
            F.ie && a.enterMode == CKEDITOR.ENTER_BR ? f = a.doc.createText(V) : (f = (f = k(a.element, !0)) && f.data("cke-enter-mode") || a.enterMode, f = new D(M[f], a.doc), f.is("br") || a.doc.createText(V).appendTo(f));
        ...
        function m(a, c) {
            return {
                canUndo: !0, modes: {wysiwyg: 1}, exec: function () {
                    function d(b) {
                        var e = F.ie && 9 > F.version ? " " : V, f = a.hotNode && a.hotNode.getText() == e &&
                            a.element.equals(a.hotNode) && a.lastCmdDirection === !!c;
                        h(a, function (d) {
                    ...
                    return function (f) {
                        ...
                        if (!w(a, f) && f && !f.equals(a.editable) && !f.contains(a.editable)) {
                            (g = k(f)) && "false" == g.getAttribute("contenteditable") &&
                            (f = g);
                            a.element = f;
                            g = e(a, f, !c);
                            var h;
        ...
        function q(a) {
            if (!n(a))return !1;
            var b;
            (b = v(a)) || (n(a) ? (b = {left: 1, right: 1, center: 1}, b = !(!b[a.getComputedStyle("float")] &&
            !b[a.getAttribute("align")])) : b = !1);
            return b
        }
        ...
        function r(a) {
            var b =
                a.editable, c = a.mouse, d = a.view, e = a.triggerOffset;
            x(a);
            ...
            if (!n(b) || q(b) || !y(a, b))return null;
            p(a, b);
            return !h && 0 <= b.size.top && l(c.y, 0, b.size.top + e) ? (a = a.inInlineMode || 0 === d.scroll.y ? O : U, new f([null, b, L, H, a])) : h && b.size.bottom <= d.pane.height &&
            l(c.y, b.size.bottom - e, d.pane.height) ? (a = a.inInlineMode || l(b.size.bottom, d.pane.height - e, d.pane.height) ? K : U, new f([b, null, E, H, a])) : null
        }
        ...
        function t(a) {
            ...
            if (!h)return null;
            p(a, h);
            var g = Math.min(g, 0 | h.size.outerHeight / 2), k = [], m, r;
            if (l(c.y, h.size.top - 1, h.size.top + g)) r = !1; else if (l(c.y, h.size.bottom - g, h.size.bottom + 1)) r = !0; else return null;
            if (q(h) || u(a, h, r) || h.getParent().is(ca))return null;
            var t = e(a, h, !r);
            if (t) {
                if (t && t.type == CKEDITOR.NODE_TEXT)return null;
                if (n(t)) {
                    if (q(t) || !y(a, t) || t.getParent().is(ca))return null;
                    k = [t, h][r ? "reverse" : "concat"]().concat([T, H])
                }
            } else h.equals(a.editable[r ? "getLast" : "getFirst"](a.isRelevant)) ? (x(a), r && l(c.y, h.size.bottom - g, d.pane.height) && l(h.size.bottom, d.pane.height - g, d.pane.height) ? m = K : l(c.y, 0, h.size.top + g) && (m = O)) : m = U, k = [null, h][r ? "reverse" : "concat"]().concat([r ? E : L, H, m, h.equals(a.editable[r ? "getLast" : "getFirst"](a.isRelevant)) ? r ? K : O : U]);
        ...
        function p(a, b, c) {
            ...
            if (!b.size) b.size = {}; else if (b.size.ignoreScroll == c && b.size.date > new Date - N)return null;
            return C(b.size, A(a, b, c), {date: +new Date}, !0)
        }
        ...
        function B(a, b) {
            ...
            if (!(!b && c && c.date > new Date - N)) {
                var d = a.win,
                    c = d.getScrollPosition(), d = d.getViewPaneSize();
                C(a.view, {
                    scroll: {
                        x: c.x,
                        y: c.y,
        ...
        function z(a, b, c, d) {
            for (var e = d, g = d, h = 0, k = !1, l = !1, m = a.view.pane.height, p = a.mouse; p.y + h < m && 0 < p.y - h;) {
                k || (k = b(e, d));
                l || (l = b(g, d));
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function (a) {
                ...
                l.isRelevant = function (a) {
                    return n(a) && !g(l, a) && !q(a)
                };
                a.on("contentDom",
                    function () {
                        var k = a.editable(), n = a.document, q = a.window;
                        C(l, {editable: k, inInlineMode: k.isInline(), doc: n, win: q, hotNode: null}, !0);
                        l.boundary = l.inInlineMode ? l.editable : l.doc.getDocumentElement();
                        k.is(G.$inline) || (l.inInlineMode && !v(k) && k.setStyles({
                            position: "relative",
                            top: null,
                            left: null
                            ...
                            if ("wysiwyg" == a.mode)if (l.inInlineMode) {
                                ...
                                B(l);
                                x(l, !0);
                                var d = l.view.editable, e = l.view.scroll;
                            ...
                            if ("wysiwyg" == a.mode && !a.readOnly && !z) {
                                ...
                                z = setTimeout(function () {
                                    ...
                                    z = l.trigger = null;
                                    B(l);
                                    u && !l.hiddenMode && a.focusManager.hasFocus && !l.line.mouseNear() && (l.element = W(l, !0)) && ((l.trigger = r(l) || t(l) || X(l)) && !w(l, l.trigger.upper || l.trigger.lower) ? l.line.attach().place() : (l.trigger = null, l.line.detach()), u = !1)
                                }, 30)
                            }
                        }), k.attachListener(q, "scroll", function () {
                            "wysiwyg" ==
                            a.mode && (l.line.detach(), F.webkit && (l.hiddenMode = 1, clearTimeout(p), p = setTimeout(function () {
                                l.mouseDown || (l.hiddenMode = 0)
                            }, 50)))
                        }), k.attachListener(J ? n : q, "mousedown", function () {
                            "wysiwyg" == a.mode && (l.line.detach(), l.hiddenMode = 1, l.mouseDown = 1)
                        }), k.attachListener(J ? n : q, "mouseup", function () {
                            l.hiddenMode = 0;
                            l.mouseDown = 0
                        }), a.addCommand("accessPreviousSpace", m(l)), a.addCommand("accessNextSpace", m(l, !0)), a.setKeystroke([[c.magicline_keystrokePrevious, "accessPreviousSpace"], [c.magicline_keystrokeNext, "accessNextSpace"]]),
        ...
        var C = CKEDITOR.tools.extend, D = CKEDITOR.dom.element, I = D.createFromHtml,
            F = CKEDITOR.env, J = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, G = CKEDITOR.dtd, M = {}, L = 128,
            E = 64, T = 32, H = 16, O = 4, K = 2, U = 1, V = " ", ca = G.$listItem, fa = G.$tableContent,
            P = C({}, G.$nonEditable, G.$empty), Q = G.$block, N = 100,
        ...
        var W = function () {
                ...
                return function (b, c, d) {
                    ...
                    return !h || h.type != CKEDITOR.NODE_ELEMENT || !h.$ || F.ie && 9 > F.version && !b.boundary.equals(h) && !b.boundary.contains(h) ? null :
                        h
                }
            }(), Z = CKEDITOR.dom.walker.whitespaces(), aa = CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT),
            X = function () {
                function b(e) {
                    var f = e.element, h, g, k;
                    ...
                    h = k.upper;
                    g = k.lower;
                    if (a(e, h, g))return k.set(T, 8);
                    if (h && f.contains(h))for (; !h.getParent().equals(f);)h = h.getParent(); else h = f.getFirst(function (a) {
                        return d(e, a)
                    });
                    if (g && f.contains(g))for (; !g.getParent().equals(f);)g = g.getParent();
                    else g = f.getLast(function (a) {
                        return d(e, a)
                    });
                    if (!h || !g)return null;
                    p(e, h);
                    p(e, g);
                    if (!l(e.mouse.y, h.size.top, g.size.bottom))return null;
                    for (var f = Number.MAX_VALUE, m, r, x, q; g && !g.equals(h) && (r = h.getNext(e.isRelevant));)m = Math.abs(c(e, h, r) - e.mouse.y), m < f && (f = m, x = h, q = r), h = r, p(e, h);
                    if (!x || !q || !l(e.mouse.y, x.size.top, q.size.bottom))return null;
                    k.upper = x;
                    k.lower = q;
                    return k.set(T, 8)
                }
                ...
                function d(a, b) {
                    return !(b && b.type == CKEDITOR.NODE_TEXT || aa(b) || q(b) || g(a, b) || b.type == CKEDITOR.NODE_ELEMENT && b.$ && b.is("br"))
                }
                ...
                return function (c) {
                    ...
                    if (e = d) {
                        e = d.upper;
                        var f = d.lower;
                        e = !e || !f || q(f) || q(e) || f.equals(e) || e.equals(f) || f.contains(e) || e.contains(f) ? !1 : y(c, e) && y(c, f) && a(c, e, f) ? !0 : !1
                    }
                    return e ? d : null
                }
        ...
        CKEDITOR.plugins.add("maximize", {
            init: function (a) {
                function f() {
                    ...
                    a.resize(b.width, b.height, null,
                        !0)
                }

                if (a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                    var d = a.lang, h = CKEDITOR.document, m = h.getWindow(), g, n, q, v = CKEDITOR.TRISTATE_OFF;
                    a.addCommand("maximize", {
                        ...
                        exec: function () {
                            ...
                            if (this.state == CKEDITOR.TRISTATE_OFF) {
                                ...
                                y.$.offsetLeft;
                                y.setStyles({"z-index": a.config.baseFloatZIndex - 5, left: "0px", top: "0px"});
                                y.addClass("cke_maximized");
                                f();
                                w = y.getDocumentPosition();
                                y.setStyles({left: -1 * w.x + "px", top: -1 * w.y + "px"});
                                CKEDITOR.env.gecko && e(a)
                            } else if (this.state ==
                                CKEDITOR.TRISTATE_ON) {
                                m.removeListener("resize", f);
                                for (var u = [w, y], t = 0; t < u.length; t++)c(u[t], u[t].getCustomData("maximize_saved_styles")), u[t].removeCustomData("maximize_saved_styles");
                                for (u = a.container; u = u.getParent();)c(u, u.getCustomData("maximize_saved_styles")), u.removeCustomData("maximize_saved_styles");
                                CKEDITOR.env.ie ? setTimeout(function () {
                                    m.$.scrollTo(q.x, q.y)
                                }, 0) : m.$.scrollTo(q.x, q.y);
                            ...
                            this.toggleState();
                            if (u = this.uiItems[0]) w = this.state == CKEDITOR.TRISTATE_OFF ? d.maximize.maximize : d.maximize.minimize, u = CKEDITOR.document.getById(u._.id), u.getChild(1).setHtml(w), u.setAttribute("title", w), u.setAttribute("href", 'javascript:void("' + w + '");');
                            "wysiwyg" == a.mode ? g ? (CKEDITOR.env.gecko && e(a), a.getSelection().selectRanges(g), (r = a.getSelection().getStartElement()) &&
                            r.scrollIntoView(!0)) : m.$.scrollTo(n.x, n.y) : (g && (r.selectionStart = g[0], r.selectionEnd = g[1]), r.scrollLeft = n[0], r.scrollTop = n[1]);
                            g = n = null;
                            v = this.state;
                    ...
                    a.on("mode", function () {
                        ...
                        b.setState(b.state == CKEDITOR.TRISTATE_DISABLED ? CKEDITOR.TRISTATE_DISABLED : v)
                    }, null, null, 100)
                }
            }
        })
                ...
                f.on("paste", function (e) {
                    ...
                    if (k && (b || h) && (!1 !== f.fire("pasteFromWord", d) || b)) {
                        ...
                        var m = a(f, c, function () {
                            if (m) f.fire("paste", l); else if (!f.config.pasteFromWordPromptCleanup ||
                                b || confirm(f.lang.pastefromword.confirmCleanup)) d.dataValue = CKEDITOR.cleanWord(d.dataValue, f), f.fire("afterPasteFromWord", d), l.dataValue = d.dataValue;
                            b = 0
                        });
                        m && e.cancel()
                    }
        ...
        var a = {
            canUndo: !1, async: !0, exec: function (a, b) {
                var c = a.lang,
                    ...
                    c = l && "string" ===
                    typeof l ? l : c.pastetext.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' + e.aria + '"\x3e' + e.display + "\x3c/kbd\x3e");
                    ...
                    exec: function (a) {
                        for (var f = a._.removeFormatRegex || (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, e = a.getSelection().getRanges(), l = e.createIterator(), k = function (a) {
                            ...
                            var h = d.createBookmark(),
                                m = h.startNode, g = h.endNode, n = function (b) {
                            ...
                            n(m);
                            if (g)for (n(g), m = m.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); m && !m.equals(g);)if (m.isReadOnly()) {
                                if (m.getPosition(g) & CKEDITOR.POSITION_CONTAINS)break;
                                m = m.getNext(k)
                            } else n = m.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), "img" == m.getName() && m.data("cke-realelement") || !c(a, m) || (f.test(m.getName()) ? m.remove(1) :
                                (m.removeAttributes(b), a.fire("removeFormatCleanup", m))), m = n;
                            d.moveToBookmark(h)
                        }
                        a.forceNextSelectionCheck();
        ...
        init: function (a) {
            function f(b) {
                var e = h.width, f = h.height, k = e + (b.data.$.screenX - d.x) * ("rtl" == l ? -1 : 1);
            ...
            var c = a.config, e = a.ui.spaceId("resizer"), l = a.element ? a.element.getDirection(1) : "ltr";
            ...
            if (!1 !== c.resize_enabled) {
                var k = null, d, h, m = ("both" == c.resize_dir ||
                ...
                a.on("uiSpace", function (b) {
                    if ("bottom" == b.data.space) {
                        ...
                        var d = '\x3cspan id\x3d"' + e + '" class\x3d"cke_resizer' + c + " cke_resizer_" + l + '" title\x3d"' + CKEDITOR.tools.htmlEncode(a.lang.common.resize) + '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + n + ', event)"\x3e' + ("ltr" ==
                            l ? "◢" : "◣") + "\x3c/span\x3e";
        ...
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function (a) {
            ...
            a.contextMenu &&
            a.addMenuItems && (a.contextMenu.addListener(function (b, c) {
                var d = a.scayt, e, m;
            ...
            a.plugins.wsc && (c.WSC = {
                label: a.lang.wsc.toolbar, group: "scaytButton", onClick: function () {
                    ...
                    (d = d.replace(/\s/g, "")) ? (c && b.state.scayt[a.name] && c.setMarkupPaused &&
                    c.setMarkupPaused(!0), a.lockSelection(), a.execCommand("checkspell")) : alert("Nothing to check!")
                }
            });
            a.addMenuItems(c)
        }, bindEvents: function (a) {
            var f = CKEDITOR.plugins.scayt, b = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE, c = function () {
                f.destroy(a)
            }, e = function () {
                ...
                c.attachListener(c, "focus", function (c) {
                    ...
                    c = CKEDITOR.plugins.scayt && CKEDITOR.plugins.scayt.state.scayt[a.name] &&
                        a.scayt;
                    var d, f;
            ...
            a.on("beforeCommandExec", function (b) {
                var c = a.scayt, e = !1, g = !1, k = !0;
                b.data.name in f.options.disablingCommandExec && "wysiwyg" == a.mode ? c && (f.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)) : "bold" !== b.data.name && "italic" !== b.data.name && "underline" !== b.data.name && "strike" !==
                    b.data.name && "subscript" !== b.data.name && "superscript" !== b.data.name && "enter" !== b.data.name && "cut" !== b.data.name && "language" !== b.data.name || !c || ("cut" === b.data.name && (k = !1, g = !0), "language" === b.data.name && (g = e = !0), a.fire("reloadMarkupScayt", {
                        removeOptions: {
                            removeInside: k,
                            forceBookmark: g,
                            language: e
            ...
            a.on("reloadMarkupScayt", function (b) {
                var c = b.data && b.data.removeOptions, e = b.data && b.data.timeout, g = b.data && b.data.language,
                    k = a.scayt;
            ...
            if (void 0 === a.config.scayt_maxSuggestions ||
                "number" != typeof a.config.scayt_maxSuggestions || 0 > a.config.scayt_maxSuggestions) a.config.scayt_maxSuggestions = 5;
            ...
            CKEDITOR.config.scayt_handleUndoRedo = CKEDITOR.plugins.undo ?
                CKEDITOR.config.scayt_handleUndoRedo : !1;
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var f = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
                    ...
                    k = CKEDITOR.tools.search, d = CKEDITOR.tools.indexOf;
                a.config.scayt_disableOptionsStorage = function (a) {
                    for (var b = [], c = 0; c < a.length; c++) {
                        var f = a[c], q = !!k(a, "options");
                        if (!k(e, f) || q && k(l, function (a) {
                                if ("lang" === a)return !1
                            }))return;
                        k(l, f) && l.splice(d(l, f), 1);
                        if ("all" === f || q && k(a, "lang"))return [];
                        "options" === f && (l = ["lang"])
                    }
                    return b = b.concat(l)
                }(f)
            ...
            var f = CKEDITOR.plugins.scayt,
                ...
                b = b && b.dataFilter, l = a.addRemoveFormatFilter, k = function (b) {
            ...
            var c = {}, e = {}, l = b ? "word" : "phrase", k = b ? "startGrammarCheck" : "startSpellCheck", d = a.scayt;
            ...
            var b = a.scayt, c = this.scaytMenuDefinition(a), e = {}, l = a.config.scayt_contextCommands.split("|"),
                k = f.getAttribute(b.getLangAttribute()) ||
                    b.getLang(), d, h;
            d = b.isScaytNode(f);
            h = b.isGraytNode(f);
            ...
            for (var m in c)d && -1 == CKEDITOR.tools.indexOf(l, m.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || (e[m] = "undefined" != typeof c[m].state ? c[m].state : CKEDITOR.TRISTATE_OFF, "function" !== typeof c[m].verification || c[m].verification(a) || delete e[m], a.addCommand(m, {exec: c[m].exec}), a.addMenuItem(m, {
        ...
        if (!0 === CKEDITOR.config.scayt_handleUndoRedo) {
            ...
            a[f] = CKEDITOR.tools.override(a[f], function (a) {
                return function (c) {
                    var e = c.editor.scayt, f = this.contents,
                        k = c.contents, d = null;
        ...
        availableLangs: {
            ...
            a.addCommand("specialchar", {
                exec: function () {
                    var b = a.langCode,
                        b = f.availableLangs[b] ? b : f.availableLangs[b.replace(/-.*/, "")] ? b.replace(/-.*/, "") : "en";
                    CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(f.path + "dialogs/lang/" +
                        b + ".js"), function () {
        ...
        function () {
            CKEDITOR.plugins.add("stylescombo", {
                requires: "richcombo", init: function (a) {
                    var f = a.config, b = a.lang.stylescombo, c = {}, e = [], l = [];
                    a.on("stylesSet", function (b) {
                        if (b = b.data.styles) {
                            for (var d, h, m, g = 0, n = b.length; g < n; g++)(d = b[g], a.blockless && d.element in CKEDITOR.dtd.$block || "string" == typeof d.type && !CKEDITOR.style.customHandlers[d.type] || (h = d.name, d = new CKEDITOR.style(d), a.filter.customConfig && !a.filter.check(d))) || (d._name = h, d._.enterMode = f.enterMode, d._.type = m = d.assignedTo || d.type, d._.weight =
                                g + 1E3 * (m == CKEDITOR.STYLE_OBJECT ? 1 : m == CKEDITOR.STYLE_BLOCK ? 2 : 3), c[h] = d, e.push(d), l.push(d));
                            e.sort(function (a, b) {
                    ...
                    a.ui.addRichCombo("Styles", {
                        ...
                        init: function () {
                            var a, c, f, l, g, n;
                            g = 0;
                            for (n = e.length; g < n; g++)a = e[g], c = a._name, l = a._.type, l != f && (this.startGroup(b["panelTitle" + String(l)]),
                                f = l), this.add(c, a.type == CKEDITOR.STYLE_OBJECT ? c : a.buildPreview(), c);
                            this.commit()
                        },
                        onClick: function (b) {
                            a.focus();
                    ...
                    if (b.editable().hasFocus) {
                        ...
                        if (d = (new CKEDITOR.dom.elementPath(c.getCommonAncestor(), c.root)).contains({
                            ...
                            if (f || a)if (f) f = new CKEDITOR.dom.element(f), c.moveToElementEditStart(f), c.checkStartOfBlock() && c.checkEndOfBlock() || c.selectNodeContents(f); else return !0; else {
                                for (var m = d.getAscendant("table").$, f = d.getParent().$.cells, m = new CKEDITOR.dom.element(m.insertRow(-1),
        ...
        var b = void 0 === f ? this.getTabIndex() : f, c, e, l, k, d, h;
        if (0 >=
                ...
                a.addCommand("tableDelete",
                    f({
                        exec: function (a) {
                            ...
                            if (b) {
                                var f = b.getParent(), k = a.editable();
        ...
        function a(a, b) {
            ...
            function d(a) {
                0 < f.length || a.type != CKEDITOR.NODE_ELEMENT ||
                !v.test(a.getName()) || a.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(g, a, "selected_cell", !0), f.push(a))
            }
                ...
                for (var e = a.getRanges(), f = [], g = {}, h = 0; h < e.length; h++) {
                    ...
                    if (k.collapsed) (k = k.getCommonAncestor().getAscendant({
                        ...
                        for (k.guard = d; l = k.next();)l.type == CKEDITOR.NODE_ELEMENT && l.is(CKEDITOR.dtd.table) || (l = l.getAscendant({
                            td: 1,
                            th: 1
                        }, !0)) && !l.getCustomData("selected_cell") && c(l) && (CKEDITOR.dom.element.setMarker(g,
                            l, "selected_cell", !0), f.push(l))
                    }
                }
        ...
        function f(b, c) {
            for (var d = y(b) ? b : a(b), e = d[0], f = e.getAscendant("table"), e = e.getDocument(), g = d[0].getParent(), h = g.$.rowIndex, d = d[d.length - 1], k = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = new CKEDITOR.dom.element(f.$.rows[k]), h = c ? h : k, g = c ? g : d, d = CKEDITOR.tools.buildTableMap(f), f = d[h], h = c ? d[h - 1] : d[h + 1], d = d[0].length, e = e.createElement("tr"), k = 0; f[k] && k < d; k++) {
                var l;
                1 < f[k].rowSpan && h && f[k] == h[k] ? (l = f[k], l.rowSpan += 1) : (l = (new CKEDITOR.dom.element(f[k])).clone(),
                    l.removeAttribute("rowSpan"), l.appendBogus(), e.append(l), l = l.$);
                k += l.colSpan - 1
            }
        ...
        function b(c) {
            if (c instanceof CKEDITOR.dom.selection) {
                var d = c.getRanges(), e = a(c), f = e[0].getAscendant("table"), g = CKEDITOR.tools.buildTableMap(f),
                    h = e[0].getParent().$.rowIndex, e = e[e.length - 1],
                    k = e.getParent().$.rowIndex + e.$.rowSpan - 1, e = [];
                c.reset();
                for (c = h; c <= k; c++) {
                    for (var l = g[c], m = new CKEDITOR.dom.element(f.$.rows[c]), n = 0; n < l.length; n++) {
                        var q = new CKEDITOR.dom.element(l[n]), v = q.getParent().$.rowIndex;
                        1 == q.$.rowSpan ? q.remove() : (--q.$.rowSpan, v == c && (v = g[c + 1], v[n - 1] ? q.insertAfter(new CKEDITOR.dom.element(v[n - 1])) : (new CKEDITOR.dom.element(f.$.rows[c + 1])).append(q, 1)));
                        n += q.$.colSpan - 1
                    }
                    e.push(m)
                }
        ...
        function l(b, c) {
            for (var d = y(b) ? b : a(b), f = d[0].getAscendant("table"), g = e(d, 1), d = e(d), h = c ? g : d, k = CKEDITOR.tools.buildTableMap(f), f = [], g = [], d = k.length, l = 0; l < d; l++)f.push(k[l][h]), g.push(c ? k[l][h - 1] : k[l][h + 1]);
            for (l = 0; l < d; l++)f[l] && (1 < f[l].colSpan && g[l] == f[l] ? (k = f[l],
                k.colSpan += 1) : (h = new CKEDITOR.dom.element(f[l]), k = h.clone(), k.removeAttribute("colSpan"), k.appendBogus(), k[c ? "insertBefore" : "insertAfter"].call(k, h), k = k.$), l += k.rowSpan - 1)
        }
        ...
        function d(b) {
            if (b instanceof CKEDITOR.dom.selection) {
                var c = b.getRanges(), e = a(b), f = e[0] && e[0].getAscendant("table"), g;
                a:{
                    var k = 0;
                    g = e.length - 1;
                    for (var l = {}, m, n; m = e[k++];)CKEDITOR.dom.element.setMarker(l,
                        m, "delete_cell", !0);
                    for (k = 0; m = e[k++];)if ((n = m.getPrevious()) && !n.getCustomData("delete_cell") || (n = m.getNext()) && !n.getCustomData("delete_cell")) {
        ...
        function g(b, c, d) {
            ...
            var h = CKEDITOR.tools.buildTableMap(f), k = h.length, l = h[0].length, n = b.getParent().$.rowIndex,
                q = m(h, n, b);
            if (c) {
                var v;
                try {
                    ...
                    v = h["up" == c ? n - y : "down" == c ? n + y : n]["left" == c ? q - g : "right" == c ? q + g : q]
                } catch (J) {
                    return !1
                }
                if (!v || b.$ == v)return !1;
            ...
            c = b.getDocument();
            var G = n, y = v = 0, M = !d && new CKEDITOR.dom.documentFragment(c), L = 0;
            for (c = 0; c < e.length; c++) {
                g = e[c];
                var E = g.getParent(), T = g.getFirst(), H = g.$.colSpan, O = g.$.rowSpan, E = E.$.rowIndex,
                    K = m(h, E, g), L = L + H * O, y = Math.max(y, K - q + H);
                v = Math.max(v, E - n + O);
                d || (H = g, (O = H.getBogus()) && O.remove(), H.trim(), g.getChildren().count() && (E == G || !T || T.isBlockBoundary && T.isBlockBoundary({br: 1}) || (G = M.getLast(CKEDITOR.dom.walker.whitespaces(!0)), !G || G.is &&
                G.is("br") || M.append("br")), g.moveChildren(M)), c ? g.remove() : g.setHtml(""));
                G = E
            }
            if (d)return v * y == L;
            M.moveChildren(b);
            b.appendBogus();
            y >= l ? b.removeAttribute("rowSpan") : b.$.rowSpan = v;
        ...
        function n(b, c) {
            ...
            var d = d[0], e = d.getParent(), f = e.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(f),
                h = e.$.rowIndex, k = m(g, h, d), l = d.$.rowSpan, n;
            if (1 < l) {
                n = Math.ceil(l / 2);
                for (var l = Math.floor(l / 2), e = h + n, f = new CKEDITOR.dom.element(f.$.rows[e]), g = m(g, e), q, e = d.clone(), h = 0; h < g.length; h++)if (q = g[h], q.parentNode == f.$ && h > k) {
                    e.insertBefore(new CKEDITOR.dom.element(q));
                    break
                } else q = null;
                q || f.append(e)
            } else for (l = n = 1, f = e.clone(), f.insertAfter(e), f.append(e = d.clone()), q = m(g, h), k = 0; k < q.length; k++)q[k].rowSpan++;
            e.appendBogus();
            d.$.rowSpan = n;
            e.$.rowSpan = l;
        ...
        function q(b, c) {
            ...
            var d = d[0], e = d.getParent(), f = e.getAscendant("table"), f = CKEDITOR.tools.buildTableMap(f),
                g = m(f, e.$.rowIndex, d), h = d.$.colSpan;
            if (1 < h) e = Math.ceil(h / 2), h = Math.floor(h / 2); else {
        ...
        var v = /^(?:td|th)$/, y = CKEDITOR.tools.isArray;
        CKEDITOR.plugins.tabletools = {
            requires: "table,dialog,contextmenu", init: function (c) {
                ...
                var t = c.lang.table, v = CKEDITOR.tools.style.parse;
                m("cellProperties", new CKEDITOR.dialogCommand("cellProperties", e({
                    ...
                    requiredContent: "table", contentTransformations: [[{
                        element: "td", left: function (a) {
                            return a.styles.background && v.background(a.styles.background).color
                        }, right: function (a) {
                            a.styles["background-color"] = v.background(a.styles.background).color
                        }
                    }, {
                ...
                m("columnDelete", e({
                    requiredContent: "table", exec: function (b) {
                        ...
                        b = c.getRanges();
                        var d = a(c), e = d[0], f = d[d.length - 1], d = e.getAscendant("table"),
                            g = CKEDITOR.tools.buildTableMap(d), k, l, m = [];
                        c.reset();
                        for (var n = 0, c = g.length; n < c; n++)for (var q =
                            0, r = g[n].length; q < r; q++)g[n][q] == e.$ && (k = q), g[n][q] == f.$ && (l = q);
                        for (n = k; n <= l; n++)for (q = 0; q < g.length; q++)f = g[q], e = new CKEDITOR.dom.element(d.$.rows[q]), f = new CKEDITOR.dom.element(f[n]), f.$ && (1 == f.$.colSpan ? f.remove() : --f.$.colSpan, q += f.$.rowSpan - 1, e.$.cells.length || m.push(e));
                ...
                c.addMenuItems && c.addMenuItems({
                    tablecell: {
                        label: t.cell.menu, group: "tablecell", order: 1, getItems: function () {
                            ...
                            return {
                                ...
                                tablecell_merge_right: g(b,
                                    "right", !0) ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
                    ...
                    tablecell_insertBefore: {
                        label: t.cell.insertBefore,
                        group: "tablecell",
                        command: "cellInsertBefore",
                        order: 5
                    },
                    tablecell_insertAfter: {
                        label: t.cell.insertAfter,
                        group: "tablecell", command: "cellInsertAfter", order: 10
                    },
                    tablecell_delete: {label: t.cell.deleteCell, group: "tablecell", command: "cellDelete", order: 15},
                    tablecell_merge: {label: t.cell.merge, group: "tablecell", command: "cellMerge", order: 16},
                    tablecell_merge_right: {
                        label: t.cell.mergeRight,
                        group: "tablecell",
                        command: "cellMergeRight",
                        order: 17
                    },
                    tablecell_merge_down: {
                        label: t.cell.mergeDown,
                        group: "tablecell",
                        command: "cellMergeDown",
                        order: 18
                    },
                    tablecell_split_horizontal: {
                        label: t.cell.splitHorizontal, group: "tablecell",
                        command: "cellHorizontalSplit", order: 19
                    },
                    tablecell_split_vertical: {
                        label: t.cell.splitVertical,
                        group: "tablecell",
                    ...
                    tablerow: {
                        label: t.row.menu, group: "tablerow", order: 1, getItems: function () {
                            return {
                    ...
                    tablerow_insertBefore: {
                        label: t.row.insertBefore,
                        group: "tablerow", command: "rowInsertBefore", order: 5
                    },
                    tablerow_insertAfter: {
                        label: t.row.insertAfter,
                        group: "tablerow",
                        command: "rowInsertAfter",
                        order: 10
                    },
                    tablerow_delete: {label: t.row.deleteRow, group: "tablerow", command: "rowDelete", order: 15},
                    tablecolumn: {
                        label: t.column.menu, group: "tablecolumn", order: 1, getItems: function () {
                            return {
            ...
            insertRow: f, insertColumn: l, getSelectedCells: a
        };
        ...
        for (f = f || 0; f <= c; f++) {
            ...
            for (var d = -1, h = b; h <= (-1 === e ? a[f].cells.length - 1 : e); h++) {
                ...
                for (var g = isNaN(m.colSpan) ? 1 : m.colSpan, m = isNaN(m.rowSpan) ? 1 : m.rowSpan, n = 0; n < m && !(f + n > c); n++) {
                    k[l +
                    n] || (k[l + n] = []);
                    for (var q = 0; q < g; q++)k[l + n][d + q] = a[f].cells[h]
                }
                d += g - 1;
                if (-1 !== e && d >= e)break
            }
        ...
        function a(a, b) {
            var c = a.getAscendant("table"), d = b.getAscendant("table"), e = CKEDITOR.tools.buildTableMap(c),
                f = a.getAscendant("tr", !0).$.rowIndex, g = b.getAscendant("tr", !0).$.rowIndex, h = [], k = {}, l, m;
            c.contains(d) && (b = b.getAscendant({td: 1, th: 1}), g = b.getAscendant("tr", !0).$.rowIndex);
            f > g && (c = f, f = g, g = c, c = a, a = b, b = c);
            for (c = 0; c < e[f].length; c++)if (a.$ === e[f][c]) {
                l = c;
                break
            }
            for (c = 0; c < e[g].length; c++)if (b.$ ===
                e[g][c]) {
                m = c;
                break
            }
            l > m && (c = l, l = m, m = c);
            for (c = f; c <= g; c++)for (f = l; f <= m; f++)d = new CKEDITOR.dom.element(e[c][f]), d.$ && !d.getCustomData("selected_cell") && (h.push(d), CKEDITOR.dom.element.setMarker(k, d, "selected_cell", !0));
            CKEDITOR.dom.element.clearAllMarkers(k);
            return h
        }
        ...
        function c(a, b) {
            ...
            a.fire("unlockSnapshot");
            b && (y = {active: !1}, a.getSelection().isInTable() && a.getSelection().reset())
        }
        ...
        function k(b, d, f) {
            ...
            d = d.is("table") ? null : d;
            var h;
            (h = y.active && !y.first) && !(h = d) && (h = b.getSelection().getRanges(), h = 1 < g.length || h[0] && !h[0].collapsed ? !0 : !1);
            if (h) y.first = d || g[0], y.dirty = d ? !1 : 1 !== g.length; else if (y.active && d && y.first.getAscendant("table").equals(d.getAscendant("table"))) {
                g = a(y.first, d);
                if (!y.dirty && 1 === g.length)return c(b, "mouseup" ===
                    f.name);
                y.dirty = !0;
                y.last = d;
                e(b, g)
        ...
        function d(a) {
            var b = (a = a.editor || a.sender.editor) && a.getSelection(), d = b && b.getRanges() || [], e;
        ...
        function h(a) {
            function d(a, b) {
                return a && b ? a.equals(b) || a.contains(b) || b.contains(a) || a.getCommonAncestor(b).is(v) : !1
            }
            ...
            function g(a, b, c, h) {
                return "mousedown" === a.name && (f(a) || !h) || "mouseup" === a.name && !e(a.data.getTarget()) && !d(c, h) ? !0 : !1
            }

            if (a.data.getTarget().getName) {
                var m = a.editor || a.listenerData.editor, n = m.getSelection(1), q = b(m), r = a.data.getTarget(),
                    t = r && r.getAscendant({td: 1, th: 1}, !0), r = r &&
                        r.getAscendant("table", !0), v = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
                g(a, n, q, r) && c(m, !0);
                !y.active && "mousedown" === a.name && f(a) && r && (y = {active: !0}, CKEDITOR.document.on("mouseup", h, null, {editor: m}));
                (t || r) && k(m, t || r, a);
                "mouseup" === a.name && (f(a) && (e(a.data.getTarget()) || d(q, r)) && l(m), y = {active: !1}, CKEDITOR.document.removeListener("mouseup", h))
            }
        }
        ...
        function g(a, b) {
            ...
            var d = a.getSelection(), e = d.createBookmarks(), f = a.document, g = a.createRange(),
                h = f.getDocumentElement().$, k = CKEDITOR.env.ie && 9 > CKEDITOR.env.version,
                l = a.blockless || CKEDITOR.env.ie ? "span" : "div", m, n, q, r;
            f.getById("cke_table_copybin") || (m = f.createElement(l), n = f.createElement(l), n.setAttributes({
                ...
                height: "1px",
                overflow: "hidden"
            }), m.setStyle("ltr" == a.config.contentsLangDirection ?
                "left" : "right", "-5000px"), m.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), n.append(m), a.editable().append(n), r = a.on("selectionChange", c, null, null, 0), k && (q = h.scrollTop), g.selectNodeContents(m), g.select(), k && (h.scrollTop = q), setTimeout(function () {
                n.remove();
                d.selectBookmarks(e);
                r.removeListener();
                a.fire("unlockSnapshot");
        ...
        function q(b) {
            ...
            function f(a) {
                var b = a.getAscendant("table"), c = a.getParent().$.rowIndex, b = CKEDITOR.tools.buildTableMap(b), d;
                for (d = 0; d < b[c].length; d++)if ((new CKEDITOR.dom.element(b[c][d])).equals(a))return d
            }

            var g = b.editor, h = g.dataProcessor,
                k = g.getSelection(), l = new CKEDITOR.dom.element("body"), m = 0, n = 0, q = 0, v = 0, w = {}, y, H, O,
                K, U, V;
            h || (h = new CKEDITOR.htmlDataProcessor(g));
            l.setHtml(h.toHtml(b.data.dataValue), {fixForBody: !1});
            v = l.findOne("table");
            if (k.getRanges().length && (k.isInTable() || (y = c(k))) && (H = u(k), H.length)) {
                b.stop();
                b = H[0].getAscendant("table");
                H = u(k, b);
                O = H[0];
                q = O.getParent();
                K = H[H.length - 1];
                U = K.getParent();
                if (!y)for (h = 0; h < H.length; h++)H[h].setHtml("");
                if (1 < l.getChildCount() || !v) H[0].setHtml(l.getHtml()), g.fire("saveSnapshot"); else {
                    if (y) {
                        H =
                            q.getChildCount();
                        q = U = new CKEDITOR.dom.element("tr");
                        q["insert" + (1 === y ? "Before" : "After")](O.getParent());
                        for (h = 0; h < H; h++)O = new CKEDITOR.dom.element("td"), O.appendTo(q);
                        O = q.getFirst();
                        K = q.getLast();
                        k.selectElement(q);
                        H = u(k)
                    }
                    y = CKEDITOR.tools.buildTableMap(b, q.$.rowIndex, r(O, !0), U.$.rowIndex, f(K));
                    k = CKEDITOR.tools.buildTableMap(v);
                    q = d(k);
                    v = d(y);
                    if (k.length > y.length)for (m = k.length - y.length, h = 0; h < m; h++)t(H);
                    if (q > v)for (n = q - v, h = 0; h < n; h++)A(H);
                    O = H[0];
                    q = O.getParent();
                    K = H[H.length - 1];
                    U = new CKEDITOR.dom.element(b.$.rows[K.getParent().$.rowIndex +
                    m]);
                    K = U.getChild(K.$.cellIndex + n);
                    m = r(H[0], !0);
                    H = f(K);
                    y = CKEDITOR.tools.buildTableMap(b, q.$.rowIndex, m, U.$.rowIndex, H);
                    for (h = 0; h < k.length; h++)for (n = new CKEDITOR.dom.element(b.$.rows[q.$.rowIndex + h]), H = 0; H < k[h].length; H++)if (V = new CKEDITOR.dom.element(k[h][H]), l = y[h] && y[h][H] ? new CKEDITOR.dom.element(y[h][H]) : null, V && !V.getCustomData("processed")) {
                        if (l && l.getParent()) V.replace(l); else if (0 === H || k[h][H - 1]) (l = 0 !== H ? new CKEDITOR.dom.element(k[h][H - 1]) : null) && n.equals(l.getParent()) ? V.insertAfter(l) : 0 <
                        m ? V.insertAfter(new CKEDITOR.dom.element(n.$.cells[m])) : n.append(V, !0);
                        CKEDITOR.dom.element.setMarker(w, V, "processed", !0)
                    } else V.getCustomData("processed") && l && l.remove();
                    CKEDITOR.dom.element.clearAllMarkers(w);
        ...
        var y = {active: !1}, w, u, r, t, A;
        CKEDITOR.plugins.tableselection = {
            getCellsBetween: a, keyboardIntegration: function (a) {
                function b(a) {
                ...
                c.attachListener(c, "keydown", function (a) {
                    function c(b, d) {
                        ...
                        var f = a.createRange(), g = CKEDITOR.dom.range.mergeRanges(d);
                    ...
                    var d = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1},
                        e = CKEDITOR.tools.extend({table: 1}, CKEDITOR.dtd.$tableContent);
                    delete e.td;
                    delete e.th;
                    return function (e) {
                        var f = e.data.getKey(), g, h = 37 === f || 38 == f, k, l, m;
                        if (d[f] && (g = a.getSelection()) && g.isInTable() && g.isFake)if (k = g.getRanges(), l = k[0]._getTableElement(), m = k[k.length - 1]._getTableElement(), e.data.preventDefault(), e.cancel(),
                            8 < f && 46 > f) k[0].moveToElementEditablePosition(h ? l : m, !h), g.selectRanges([k[0]]); else {
                ...
                c.attachListener(c, "keypress", function (c) {
                    var d = a.getSelection(), e = c.data.$.charCode || 13 === c.data.getKey(), f;
                    if (d && d.isInTable() && d.isFake && e && !(c.data.getKeystroke() & CKEDITOR.CTRL)) {
                        c = d.getRanges();
                        e = c[0].getEnclosedNode().getAscendant({td: 1, th: 1}, !0);
        ...
        CKEDITOR.plugins.add("tableselection", {
            requires: "clipboard,tabletools", onLoad: function () {
                ...
                CKEDITOR.plugins.tableselection.isSupportedEnvironment && (a.addContentsCss &&
                a.addContentsCss(this.path + "/styles/tableselection.css"), a.on("contentDom", function () {
                    ...
                    CKEDITOR.plugins.clipboard && !CKEDITOR.plugins.clipboard.isCustomCopyCutSupported && (b.attachListener(b, "cut",
                        n), b.attachListener(b, "copy", n))
                }), a.on("paste", q), v(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function (a, b) {
                    e(a, b.selectedCells)
                }), v(a, ["cellMerge", "cellMergeRight", "cellMergeDown"], function (a, b) {
                    e(a, [b.commandData.cell])
                }), v(a, ["cellDelete"], function (a) {
                    c(a, !0)
                }))
            }
        })
        ...
        CKEDITOR.plugins.add("undo", {
            init: function (c) {
                ...
                var g = c.undoManager = new b(c), k = g.editingHandler = new l(g), q = c.addCommand("undo", {
                    exec: function () {
                ...
                g.onChange = function () {
                    q.setState(g.undoable() ?
                        CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED);
                    v.setState(g.redoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED)
                };
        ...
        function a(a) {
            ...
            var c = this.editor, d = a.document, h = d.body, m = d.getElementById("cke_actscrpt");
                ...
                a.addMode("wysiwyg", function (b) {
                    ...
                    if (n) {
                        var g = CKEDITOR.tools.getNextId(),
                            q = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + g + '" class\x3d"cke_voice_label"\x3e' + n + "\x3c/span\x3e");
                        d.append(q, 1);
            ...
            $: function () {
                ...
                setData: function (a, c) {
                    ...
                    if (c) this.setHtml(a), this.fixInitialSelection(), f.fire("dataReady"); else {
                        ...
                        f._.dataStore = {id: 1};
                        var d = f.config, h = d.fullPage, m = d.docType,
                        ...
                        n && (a = a.replace(/<head[^>]*?>/, "$\x26" + n)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = m + a) : a = d.docType + '\x3chtml dir\x3d"' + d.contentsLangDirection + '" lang\x3d"' + (d.contentsLanguage || f.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + n + g + "\x3c/head\x3e\x3cbody" + (d.bodyId ? ' id\x3d"' + d.bodyId + '"' : "") + (d.bodyClass ? ' class\x3d"' + d.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
