            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            ...
                            style="color:#767E95;font-size: 12px;font-weight:bold;"><i
                            class="fa fa-angle-right"></i>&nbsp;新闻中心</a></span>
                    <span style="max-height:30px;line-height: 30px;" class="active"><a
                            href="<?php echo U('Index/video');?>"
                            style="color:#162A9C;font-size: 12px;font-weight:bold;"><i
                            class="fa fa-angle-right"></i>&nbsp;视频中心</a></span>
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                        ...
                        <div class="col-lg-8">
                            <span style="padding:5px;">
                                <a href="<?php echo U('Index/news');?>"
                                   style="color:#767E95;font-size: 12px;font-weight:bold;">公司新闻</a>
                            </span>
                            <span style="padding:5px;">
                                <a href="<?php echo U('Index/MediaReport');?>"
                                   style="color:#767E95;font-size: 12px;font-weight:bold;">媒体报道</a>
                            </span>
                            <span style="padding:5px;border-bottom: 2px solid #162A9C">
                                <a href="<?php echo U('Index/video');?>" style="color:#162A9C;font-size: 12px;font-weight:bold;">视频中心</a>
                            </span>
                        </div>
                    ...
                    <div class="row" style="margin-top:30px;">
                        <div class="col-xs-12 text-center"
                             style=" margin-left: auto; margin-right: auto;background-color: #F3F3F6">
                            <div class="row"><h4><?php echo ($video['Title']); ?></h4></div>
                            <div id="a1" class="col-xs-12"></div>
                            <script type="text/javascript" src="/Public/ckplayer6.8/ckplayer/ckplayer.js"
                                    charset="utf-8"></script>
                            <script type="text/javascript">
                                var now = "<?php echo $video['Url'];?>";
                                var fengImg = "<?php echo $video['Img'];?>";
                                var flashvars = {
                                    f: now,
                                    i: fengImg,
                                    c: 0,
...
//                                                                var video=['http://movie.ks.js.cn/flv/other/1_0.mp4->video/mp4'];
                                var support = ['all'];
                                var video = [now];
                                CKobject.embed('/Public/ckplayer6.8/ckplayer/ckplayer.swf','a1','ckplayer_a1','100%','50%',false,flashvars,video);
                            </script>
                        </div>
                        ...
                        <div class="row" style="background-color:#F3F3F6;max-height: 165px;">
                            <div class="col-xs-12 hasActive">
                                <section class="install">
                                    <div class="demo" style="margin-top:5px;">
                                        <div class="col-xs-1 text-left">
                                            <a href="javascript:void(0)" id="goToPrevSlide">
                                                <img src="/Public/Img/prev.jpg" width="100%" height="107px"/>
                                            </a>
                                        </div>
                                        <div class="col-xs-10">
                                            <ul id="publicMethods" class="gallery list-unstyled clearfix">
                                                <?php if(is_array($videoArr)): foreach($videoArr as $key=>$vo): ?><li style="padding:0 5px;" class="opaImg">
                                                        <a href="<?php echo U('Index/video',array('ID'=>$vo['ID']));?>">
                                                            <?php if($video['ID'] != $vo['ID']): ?><div class="opacity" style="position: absolute;display: block;opacity: 0.5">
                                                                    <img src="/Public/Img/opacity.png" width="200px" height="107px"/>
                                                                </div><?php endif; ?>
                                                            <img src="<?php echo ($vo["Img"]); ?>" width="200px" height="107px"/>
                                                        </a>
                                        ...
                                        <div class="col-xs-1 text-right">
                                            <a href="javascript:void(0)" id="goToNextSlide">
                                                <img src="/Public/Img/next.jpg" width="100%" height="107px"/>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="call">
