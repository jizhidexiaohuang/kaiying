...
<div class="content-wrapper">
    <section class="content-header">
        <h1>凯盈集团<small>项目展示</small></h1>
        <ol class="breadcrumb">
            <li><a href="./"><i class="fa fa-home"></i> 首页</a></li>
            <li class=""><a href=""><i class="fa fa-gears"></i> 项目展示</a></li><li class=""><a href="?Action=CURD&amp;CURDID=10"><i class="fa fa-desktop"></i> 凯盈集团</a></li>
        </ol>
     ...
     <section class="content">
         <div class="row">
             <div class="col-lg-1 col-md-2 col-xs-4 margin-bottom" style="margin: 0 15px 10px 0;">
                 <a href="<?php echo U('Project/projectedit',array('T'=>'凯盈集团-'));?>" class="btn btn-info"><i class="fa fa-list"></i> 添加项目</a>
             </div>
             ...
             <?php if(is_array($ProjectInfo)): foreach($ProjectInfo as $key=>$vo): ?><div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                     <div class="box box-info">
                         ...
                         <div class="box-footer clearfix">
                             <a class="btn btn-success" href="<?php echo U('Project/projectedit',array('ID'=>$vo['ID'],'T'=>'凯盈集团-'));?>"><i class="fa fa-edit"></i> 修改</a>
                         </div>
                     </div>
