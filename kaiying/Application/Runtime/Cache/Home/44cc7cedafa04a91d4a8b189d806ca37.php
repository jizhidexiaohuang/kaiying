    ...
    <div class="col-lg-10"
        ...
        <div class="row" style="font-family: '微软雅黑';">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-8" style="background-color: white;padding: 20px;">
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <span style="padding:5px;">
                                <a href="<?php echo U('/');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">大海智地</a>
                            </span>
                    ...
                    <div class="row" style="margin-top:30px;">
                        <?php if(is_array($Pinfo)): foreach($Pinfo as $key=>$vo): ?><div class="col-lg-3" style="padding:5px 3px 0 3px;">
                                <a href="#"><img src="<?php echo ($vo["Img"]); ?>" width="100%" height="140px"/></a>
                                <div class="row" style="background-color: #F1EEE7">
                                    <p class="text-center" style="margin-top: 10px;font-size: 14px;font-weight: bold;color: #7D869F;background-color: #F1EEE7"><?php echo ($vo["Title"]); ?></p>
