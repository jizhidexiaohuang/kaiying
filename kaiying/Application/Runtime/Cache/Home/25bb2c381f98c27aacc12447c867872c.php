        ...
        <div class="row" style="font-family: '微软雅黑';">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 text-right" style="max-height: 30px;margin-right: 10px;">
                    ...
                    <a style="max-height:30px;line-height: 30px;" class="active"><a href="<?php echo U('Index/aboutUs');?>"
                                                                                    style="color:#162A9C;font-size: 12px;font-weight:bold;"><i
                            class="fa fa-angle-right"></i>&nbsp;联系我们</a></a>
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <div class="col-lg-8" style="background-color: white;padding: 40px;">
                    ...
                    <a href="<?php echo U('Index/aboutUs');?>" style="color:#162A9C;font-size: 12px;font-weight:bold;">联系我们</a>
                </span>
                            <span style="padding:5px;">
                    <a href="<?php echo U('Index/BusinessCooperation');?>" style="color:#767E95;font-size: 12px;font-weight:bold;">商务合作</a>
                </span>
                        </div>
                    ...
                    <div class="row hidden-xs hidden-sm" style="margin-top: 10px;">
                        ...
                        <div class="col-lg-6 col-md-6 hidden-xs text-right" style="line-height: 30px;">
                        </div>
                    </div>
                    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=DCLoUUO857uq8Nj33MClWLR4SpFabuTC"></script>
                    <div class="row" style="margin-top: 30px;"><!--地址内容-->
                        <div class="row">
                            <a href="javascript:void(0);" class="btn btn-info">东莞公司</a>
                            <a href="<?php echo U('Index/aboutUsSz');?>" class="btn btn-default">深圳公司</a>
                        </div>
                        <div class="row" style="padding-top:20px;">
                            <div class="col-lg-12" style="padding: 20px;font-family: '微软雅黑';">
                                <p style="font-weight: bold;color:#666666;font-size: 18px;">广东大海凯盈房产建设管理有限公司</p>
                                <p style="font-size: 12.5px;color:#999999;">电话：0769-23121218</p>
                                <p style="font-size: 12.5px;color:#999999;">传真：0769-23121311</p>
                                <p style="font-size: 12.5px;color:#999999;">邮箱：kf@gddhky.com</p>
                                <p style="font-size: 12.5px;color:#999999;">地址：广东省东莞市南城区鸿福路102号汇成大厦16楼</p>
                            </div>
                        </div>
                        <div class="row text-center">
                            <div id="allmap" style="width: 100%;height:300px;">
                                <p style="border-radius: 10px;"></p>
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                // 百度地图API功能
                var sContent =
                    "<p style='color:#999999;line-height:12px;font-size:5px;'>地址：东莞市南城区鸿福路102号汇成大厦16楼</p>" +
                    "<p style='color:#999999;font-size:5px;line-height:7px;padding:0;'>电话：0769-23121218</p>" +
                    "<p style='color:#999999;line-height:7px;font-size:5px;padding:0;'>传真：0769-23121311</p>" +
                    "<p style='color:#999999;line-height:7px;font-size:5px;padding:0;'>邮箱：kf@gddhky.com</p>"
                ;
                var map = new BMap.Map("allmap");
                var point = new BMap.Point(113.760799,23.01947);
